PRO memory_threehr_precip_twodpdf
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/dlhbi/dlhbi.jun-sep_3hrmeans.precip.nc'
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END
      1 : BEGIN
         infile=gc2+'/dlhbu/dlhbu.jun-sep_3hrmeans.precip.nc'         
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END
      2 : BEGIN
         infile=gc2+'/dlufc/dlufc.jun-sep_3hrmeans.precip.nc'         
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END
      3 : BEGIN
         infile=gc2+'/dlufd/dlufd.jun-sep_3hrmeans.precip.nc'         
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END      
      4 : BEGIN
         infile=gc2+'/dlufp/dlufp.jun-sep_3hrmeans.precip.nc'         
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END         
      999 : BEGIN
         infile=trmm+'/native_resolution/TRMM_3B42v6A.jun-sep_3hrmeans.1999-2010.precip.nc'
         tsteps=10000
         time_offset=0
         tstep_length=10800
         multiplier=24.
      ...
      END     
      5 : BEGIN
         infile=cmorph+'/CMORPH.jun-sep_3hrmeans_ts.2001-2012.precip.nc'
         tsteps=10000
         time_offset=0
         tstep_length=10800
         multiplier=8.
         ...
         lat_name='lat'
         var_name='precip'
         psfile_title='CMORPH-EQ'
         all_dx(i)=25
         all_dt(i)=3
         all_box_size(i)=1050
         all_colors(i)='darkgray'
         box=[-10,60,20,160]
      END   
   ENDCASE
   ...
   ;psfile='/home/ss901165/idl/mjo_diabatic/timestep/memory_threehr_precip_twodpdf.'+psfile_title+'_prct.ps'
   ...
   AXES,XVALS=indgen(n_heavi+2),YVALS=indgen(n_heavi+2),$
        YLABELS=['<'+STRTRIM(STRING(heaviside(0)),1),STRTRIM(STRING(heaviside),1),'>'+STRTRIM(STRING(heaviside(n_heavi-1)),1)],$
        XLABELS=['<'+STRTRIM(STRING(heaviside(0)),1),STRTRIM(STRING(heaviside),1),'>'+STRTRIM(STRING(heaviside(n_heavi-1)),1)],$
        XTITLE='Precipitation at 3-hr t (mm day!U-1!N)',YTITLE='Precipitation at 3-hr t+1 (mm day!U-1!N)',/NORIGHT,$
        ORIENTATION=35
   GSET,XMIN=0,XMAX=n_heavi+1,YMIN=0.001,YMAX=1,/YLOG
   IF TOTAL(where(oned_pdf_prct lt 0.001)) ge 0 THEN $
      oned_pdf_prct[where(oned_pdf_prct lt 0.001)]=!Values.F_NaN
  ...
  ; PSCLOSE,/NOVIEW
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/memory_threehr_spatialscale.'+psfile_title+'.'+$
          STRTRIM(STRING(domain_size),1)+'x'+STRTRIM(STRING(domain_size),1)+'.corr_coeffs_radvlag.ps'
   ...
   FOR j=0,domain_size/2 DO BEGIN
      ...
      ENDFOR
   ENDFOR
   AXES,XSTEP=1,YSTEP=1,XTITLE='Distance from central point (gridpoints)',YTITLE='Lag (3-hr)'
   PSCLOSE,/NOVIEW
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/memory_threehr_precip_twodpdf.many_distance_tstep.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/memory_threehr_precip_twodpdf.many_time_tstep.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
...
GLEGEND,labels=REVERSE(all_psfile_titles),COL=REVERSE(FSC_COLOR(all_colors)),length=0,SYM=REPLICATE(3,n_models),LEGPOS=9
AXES,XSTEP=180,XMINOR=60,XTITLE='Time (minutes)',$
     YTITLE='Lag correlation of gridpoint 3-hr precipitation',$
     YSTEP=0.1,YMINOR=0.05,NDECS=1
PSCLOSE
