PRO metum_daily_precip_twodpdf_2p5
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/antia/antia.jun-sep_dmeans.precip.2p5x2p5.nc'
         tsteps=119
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=2000
      ...
      END
      999 : BEGIN
         infile=gc2+'/anvtu/anvtu.jun-sep_dmeans.precip.2p5x2p5.nc'
         tsteps=119
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=2000
      END
      1 : BEGIN
         infile=gc2+'/antib/antib.jun-sep_dmeans.precip.2p5x2p5.nc'
         tsteps=119
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=2000
      ...
      END
      2 : BEGIN
         infile=gc2+'/anrid/anrid.jun-sep_dmeans.precip.2p5x2p5.nc'
         tsteps=82
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=2000
      ...
      ;END
      3 : BEGIN
         infile=um6+'/answa_N1024param/wp_dmeans_2p5x2p5.nc'
         tsteps=119
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
      ...
      END   
      4 : BEGIN
         infile=um6+'/answc_N1024explt/wp_dmeans_2p5x2p5.nc'
         tsteps=119
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      5 : BEGIN
         infile=trmm+'/native_resolution/TRMM_3B42v6A.jun-sep_dmeans.1999-2010.precip.2p5x2p5.nc'
         tsteps=120*12
         time_offset=0
         tstep_length=86400
         multiplier=24.
      ...
      ;END
      6 : BEGIN
         infile=cmorph+'/CMORPH.jun-sep_dmeans_ts.2001-2012.precip.2p5x2p5.nc'
         tsteps=11700/8
         time_offset=0
         tstep_length=86400
         multiplier=8.
  ...
  ; PSCLOSE,/NOVIEW
   ...
   mylevs_prct=['1e-5','2e-5','4e-5','7e-5','1e-4','2e-4','4e-4','7e-4','1e-3','2e-3','4e-3','7e-3','1e-2','2e-2','4e-2','7e-2','1e-1']
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_precip_twodpdf_2p5.'+psfile_title+'_prct.ps'
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_spatialscale_2p5.'+psfile_title+'.'+$
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_precip_twodpdf_2p5.many_distance_tstep_egu.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_precip_twodpdf_2p5.many_time_tstep_egu.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
