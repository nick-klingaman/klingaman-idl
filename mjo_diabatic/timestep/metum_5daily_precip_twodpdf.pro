PRO metum_5daily_precip_twodpdf
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/antia/antia.jun-sep_5dmeans.precip.nc'
         tsteps=23
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=1400
      ...
      END
      999 : BEGIN
         infile=gc2+'/anvtu/anvtu.jun-sep_5dmeans.precip.nc'
         tsteps=23
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=1400
      END
      1 : BEGIN
         infile=gc2+'/antib/antib.jun-sep_5dmeans.precip.nc'
         tsteps=23
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=1400
      ...
      END
      2 : BEGIN
         infile=gc2+'/anrid/anrid.jun-sep_5dmeans.precip.nc'
         tsteps=15
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      ...
      ;END
      3 : BEGIN
         infile=um6+'/answa_N1024param/wp_5dmeans.nc'
         tsteps=23
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
      ...
      END   
      4 : BEGIN
         infile=um6+'/answc_N1024explt/wp_5dmeans.nc'
         tsteps=23
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      5 : BEGIN
         infile=trmm+'/native_resolution/TRMM_3B42v6A.jun-sep_5dmeans.1999-2010.precip.nc'
         tsteps=120*12/5
         time_offset=0
         tstep_length=86400
         multiplier=24.
      ...
      ;END
      6 : BEGIN
         infile=cmorph+'/CMORPH.jun-sep_5dmeans_ts.2001-2012.precip.nc'
         tsteps=11700/40
         time_offset=0
         tstep_length=86400
         multiplier=8.
  ...
  ; PSCLOSE,/NOVIEW
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_spatialscale.'+psfile_title+'.'+$
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_precip_twodpdf.many_distance_tstep_egu.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_precip_twodpdf.many_time_tstep_egu.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
...
AXES,XSTEP=5,XMINOR=2.5,XTITLE='Time (day)',$
     YTITLE='Lag correlation of gridpoint pentad-mean precipitation',$
     YSTEP=0.1,YMINOR=0.05,NDECS=1
PSCLOSE
