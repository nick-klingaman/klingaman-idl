PRO mjo_diabatic_timestep_precip_twodpdf_5x5
...
; For radius vs. lag
  ...
  FOR i=0,n_models-1 DO BEGIN
     CASE i OF 
        0 : BEGIN
           infile=mjodiab_2day+'/GEOS5_AGCM.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
        ...
        END
        1 : BEGIN
           infile=mjodiab_2day+'/MRI-AGCM.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=72
           tstep_length=1800
           multiplier=86400.
           lon_name='longitude'
        ...
        END
        2 : BEGIN
           infile=mjodiab_2day+'/ModelE.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=72
           tstep_length=1800
           multiplier=1.
           lon_name='longitude'
        ...
        END      
        3 : BEGIN
           infile=mjodiab_2day+'/SPCAM3.0.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=72
           tstep_length=1800
           multiplier=86400.
           lon_name='longitude'
        ...
        END
        4 : BEGIN
           infile=mjodiab_2day+'/miroc5.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
        ...
        END
        5 : BEGIN
           infile=mjodiab_2day+'/NCAR.CAM5.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=72
           tstep_length=720
        ...
        END
        6 : BEGIN
           infile=mjodiab_2day+'/MetUM.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=180
           tstep_length=720
           multiplier=86400.
           lon_name='longitude'
        ...
        END
        7 : BEGIN
           infile=mjodiab_2day+'/CNRM.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=72
           tstep_length=720
           multiplier=86400.
           lon_name='longitude'
        ...
        END      
        8 : BEGIN
           infile=mjodiab_2day+'/CanCM4.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=36
           tstep_length=720
           multiplier=86400.
           lon_name='longitude'
        ...
        END      
        9 : BEGIN
           infile=mjodiab_2day+'/ecearth3.pr.20091020-20100110.lead_12-48hrs.5x5.nc'
           tsteps_per_start=48
           tstep_length=720
           multiplier=86400.
           lon_name='longitude'
     ...
     psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf_5x5.'+psfile_title+'_prct.ps'
     ...
     FOR p=0,n_thresholds-1 DO $
        avg_frac_wet(p)=N_ELEMENTS(where(precip gt thresholds(p)))/FLOAT(nlon*nlat*tsteps_per_start*nstarts)
                                ...
                                ; psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_spatialscale_5x5.'+psfile_title+'.'+$
                                ...
                                ; AXES,XSTEP=1,YSTEP=1,XTITLE='Distance from central point (5x5 gridboxes)',YTITLE='Lag (same units as input data)'
                                ; PSCLOSE,/NOVIEW
...
;   psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf_5x5.many_distance_tstep.ps'
...
;   PSCLOSE
  ...
  psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf_5x5.many_time_tstep.ps'
  PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
