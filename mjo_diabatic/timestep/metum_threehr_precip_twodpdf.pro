PRO metum_threehr_precip_twodpdf
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/antia/antia.jun-sep_3hrmeans.precip.nc'
         tsteps=959
         time_offset=1
         tstep_length=10800
         multiplier=86400.
	 ...
	 all_box_size(i)=1400
      ...
      END
;      999 : BEGIN
;         infile=gc2+'/anvtu/anvtu.jun-sep_3hrmeans.precip.nc'
;         tsteps=959
;         time_offset=1
;         tstep_length=10800
;         multiplier=86400.
...
;      END
      1 : BEGIN
         infile=gc2+'/antib/antib.jun-sep_3hrmeans.precip.nc'
         tsteps=959
         time_offset=1
         tstep_length=10800
         multiplier=86400.
	 ...
	 all_box_size(i)=1400
      ...
      END
      2 : BEGIN
         infile=gc2+'/anrid/anrid.jun-sep_3hrmeans.precip.nc'
         tsteps=655
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      ...
      ;END
      3 : BEGIN
         infile=um6+'/answa_N1024param/wp_3hrmeans.nc'
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
      ...
      END      
      4 : BEGIN
         infile=um6+'/answc_N1024explt/wp_3hrmeans.nc'
         tsteps=959
         tstep_length=10800
         multiplier=86400.
         lon_name='longitude'
  ...
  ; psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_threehr_precip_twodpdf.'+psfile_title+'_prct.ps'
  ...
  ; PSCLOSE,/NOVIEW
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_threehr_spatialscale.'+psfile_title+'.'+$
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_threehr_precip_twodpdf.many_distance_tstep_egu.ps'
...
; psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_threehr_precip_twodpdf.many_time_tstep.ps'
; PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
