PRO metum_timestep_precip_twodpdf_2p5
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/antia/antia.jun-sep_tsmeans.precip.2p5x2p5.nc'
         tsteps=8639
         tstep_length=1200
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=2000
      ...
      END
      1 : BEGIN
         infile=gc2+'/antib/antib.jun-sep_tsmeans.precip.2p5x2p5.nc'
         tsteps=11000
         tstep_length=600
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=2000
      ...
      END
      2 : BEGIN
         infile=gc2+'/anrid/anrid.jun-sep_tsmeans.precip.2p5x2p5.nc'
         tsteps=12000
         tstep_length=600
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=2000         
      ...
      ;END
      3 : BEGIN
         infile=um6+'/answa_N1024param/wp_2p5x2p5.nc'
         tsteps=32000
         tstep_length=300
         multiplier=86400.
         lon_name='longitude'
      ...
      END   
      4 : BEGIN
         infile=um6+'/answc_N1024explt/wp_2p5x2p5.nc'
         tsteps=32000
         tstep_length=300
         multiplier=86400.
         lon_name='longitude'
   ...
   ;psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_timestep_precip_twodpdf_2p5.'+psfile_title+'_prct.ps'
   ...
   ;psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_timestep_spatialscale_2p5.'+psfile_title+'.'+$
   ...
   FOR x=0,nlon-box_npts_side,box_npts_side DO BEGIN
      ...
      FOR y=0,nlat-box_npts_side,box_npts_side DO BEGIN
         ...
         FOR s=0,box_npts_side/2 DO BEGIN
            ...
            ENDFOR
            IF TOTAL(mean_precip) gt 0 and TOTAL(central_point_ts) gt 0 and $
               TOTAL(where(mean_precip ge 1e10)) eq -1 and TOTAL(where(central_point_ts ge 1e10)) eq -1 THEN $
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_timestep_precip_twodpdf_2p5.many_distance_tstep_egu.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_timestep_precip_twodpdf_2p5.many_time_tstep.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
...
GLEGEND,labels=all_psfile_titles,COL=FSC_COLOR(all_colors),length=0,SYM=all_syms,LEGPOS=11
