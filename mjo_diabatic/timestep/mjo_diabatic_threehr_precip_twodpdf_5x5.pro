PRO mjo_diabatic_threehr_precip_twodpdf_5x5
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=mjodiab_2day+'/GEOS5_AGCM.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=1200
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      1 : BEGIN
         infile=mjodiab_2day+'/MRI-AGCM.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=1800
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      2 : BEGIN
         infile=mjodiab_2day+'/ModelE.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=1800
         multiplier=1.
         lon_name='longitude'
      ...
      END      
      3 : BEGIN
         infile=mjodiab_2day+'/SPCAM3.0.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=1800
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      4 : BEGIN
         infile=mjodiab_2day+'/miroc5.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=720
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      5 : BEGIN
         infile=mjodiab_2day+'/NCAR.CAM5.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=720
      ...
      END
      6 : BEGIN
         infile=mjodiab_2day+'/MetUM.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=720
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      7 : BEGIN
         infile=mjodiab_2day+'/CNRM.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=720
         multiplier=86400.
         lon_name='longitude'
      ...
      END      
      8 : BEGIN
         infile=mjodiab_2day+'/CanCM4.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=720
         multiplier=86400.
         lon_name='longitude'
      ...
      END      
      9 : BEGIN
         infile=mjodiab_2day+'/ecearth3.pr.20091020-20100110.lead_12-48hrs_3hrmeans.5x5.nc'
         tsteps_per_start=12
         tstep_length=720
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      10 : BEGIN
         infile='/home/ss901165/datasets/TRMM_3B42V6/native_resolution/TRMM_3B42v6A.oct2009-feb2010_3hrmeans.precip.5x5.nc'
         tsteps_per_start=1208
         nstarts=1
         tstep_length=720
         multiplier=24.
         time_offset=0
      ...
      END
      11 : BEGIN
         infile='/home/ss901165/datasets/CMORPH/CMORPH_V1.0.mjodiab_period_3hrmeans.precip.5x5.nc'
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_threehr_precip_twodpdf_5x5.'+psfile_title+'_prct.ps'
   ...
   FOR j=0,nlon-domain_size,domain_size DO BEGIN
    ...
    psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_threehr_spatialscale_5x5.'+psfile_title+'.'+$
...
ENDFOR
 ...
 psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_3hr_precip_twodpdf_5x5.many_distance_tstep.ps'
 PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
 GSET,XMIN=0,XMAX=box_size/2.,YMIN=0.1,YMAX=1.01
 FOR i=0,n_models-1 DO BEGIN
 ...
 AXES,XSTEP=100,XMINOR=50,XTITLE='Distance (km)',$
      YTITLE='Correlation of 3-hr precipitation with central point (x=0)',$
