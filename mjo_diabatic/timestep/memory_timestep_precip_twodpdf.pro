PRO memory_timestep_precip_twodpdf
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/dlhbi/dlhbi.jun-sep_tsmeans.precip.nc'
         tsteps=8639
         tstep_length=1200
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END
      1 : BEGIN
         infile=gc2+'/dlhbu/dlhbu.jun-sep_tsmeans.precip.nc'         
         tsteps=8639
         tstep_length=1200
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END
      2 : BEGIN
         infile=gc2+'/dlufc/dlufc.jun-sep_tsmeans.precip.nc'         
         tsteps=8639
         tstep_length=1200
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END
      3 : BEGIN
         infile=gc2+'/dlufd/dlufd.jun-sep_tsmeans.precip.nc'         
         tsteps=8639
         tstep_length=1200
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=1400
      END      
      4 : BEGIN
         infile=gc2+'/dlufp/dlufp.jun-sep_tsmeans.precip.nc'         
         tsteps=11519
         tstep_length=900
         multiplier=86400.
         lon_name='longitude'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/memory_timestep_precip_twodpdf.many_distance_tstep.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/memory_timestep_precip_twodpdf.many_time_tstep.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
