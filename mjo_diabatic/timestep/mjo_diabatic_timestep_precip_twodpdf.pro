PRO mjo_diabatic_timestep_precip_twodpdf
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=mjodiab_2day+'/GEOS5_AGCM.pr.20091020-20100110.lead_12-48hrs.nc'
      ...
      END
      1 : BEGIN
         infile=mjodiab_2day+'/MRI-AGCM.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=72
         tstep_length=1800
         multiplier=86400.
         lon_name='lon'
      ...
      END
      2 : BEGIN
         infile=mjodiab_2day+'/ModelE.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=72
         tstep_length=1800
         multiplier=1.
         lon_name='longitude'
      ...
      END      
      3 : BEGIN
         infile=mjodiab_2day+'/SPCAM3.0.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=72
         tstep_length=1800
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      4 : BEGIN
         infile=mjodiab_2day+'/miroc5.pr.20091020-20100110.lead_12-48hrs.nc'
      ...
      END
      5 : BEGIN
         infile=mjodiab_2day+'/NCAR.CAM5.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=72
         tstep_length=720
      ...
      END
      7 : BEGIN
         infile=mjodiab_2day+'/CNRM.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=72
         tstep_length=1800
         multiplier=86400.
         lon_name='lon'
      ...
      END      
      8 : BEGIN
         infile=mjodiab_2day+'/CanCM4.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=36
         tstep_length=3600
         multiplier=86400.
         lon_name='longitude'
      ...
      END      
      9 : BEGIN
         infile=mjodiab_2day+'/ecearth3.pr.20091020-20100110.lead_12-48hrs.nc'
         tsteps_per_start=48
         tstep_length=2700
         multiplier=86400.
         lon_name='lon'
   ...
   precip = OPEN_AND_EXTRACT(infile,'pr',$
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf.'+psfile_title+'_prct.ps'
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf.colorbar.ps'
   PSOPEN,file=psfile,TFONT=6,FONT=6,CHARSIZE=160,TCHARSIZE=100,XSIZE=16500,YSIZE=16500,SPACE2=2000,YOFFSET=1000
   GSET,XMIN=0,XMAX=n_heavi+1,YMIN=0,YMAX=n_heavi+1
   CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs_prct)+1,white=[2]
   LEVS,MANUAL=mylevs_prct
   COLBAR,COORDS=[2000,3000,26000,3700],TITLE='Probability',/ALT
   PSCLOSE,/NOVIEW
   ...
   FOR x=0,nlon-domain_size,domain_size DO BEGIN
      ...
      FOR y=0,nlat-domain_size,domain_size DO BEGIN
         ...
         region_precip=precip(central_x-domain_size/2:$
         ...
         FOR s=0,domain_size/2 DO BEGIN
            ...
            ENDFOR
            FOR t=0,nlags-1 DO $
               corr_coeffs(s,t)=corr_coeffs(s,t)+CORRELATE(central_point_ts(0:ntime-t-1),mean_precip(t:ntime-1))
         ENDFOR                  
         nregions=nregions+1
      ENDFOR
   ENDFOR
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_spatialscale.'+psfile_title+'.'+$
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_spatialscale.radvlag_colorbar.ps'
   PSOPEN,file=psfile,TFONT=6,FONT=6,CHARSIZE=160,TCHARSIZE=100,XSIZE=16500,YSIZE=16500,SPACE2=2000,YOFFSET=1000
   GSET,XMIN=0,XMAX=n_heavi+1,YMIN=0,YMAX=n_heavi+1
   CS,SCALE=24,NCOLS=N_ELEMENTS(mylevs_radvlag)+1
   LEVS,MANUAL=mylevs_radvlag
   COLBAR,COORDS=[2000,3000,26000,3700],TITLE='Mean correlation coefficient',/ALT
   PSCLOSE,/NOVIEW
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf.many_distance_tstep_egu.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/mjo_diabatic_timestep_precip_twodpdf.many_time_tstep_egu.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
