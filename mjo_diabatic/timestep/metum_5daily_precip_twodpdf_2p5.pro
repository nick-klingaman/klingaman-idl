PRO metum_5daily_precip_twodpdf_2p5
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         infile=gc2+'/antia/antia.jun-sep_5dmeans.precip.2p5x2p5.nc'
         tsteps=23
         time_offset=1
         tstep_length=86400
         multiplier=86400.
         ...
         all_dx(i)=400 ; in km
         all_dt(i)=120 ; in hours
         all_colors(i)='darkslateblue'
	 all_box_size(i)=2000
         all_syms(i)=1
      END
      999 : BEGIN
         infile=gc2+'/anvtu/anvtu.jun-sep_5dmeans.precip.2p5x2p5.nc'
         tsteps=23
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=2000
      END
      1 : BEGIN
         infile=gc2+'/antib/antib.jun-sep_5dmeans.precip.2p5x2p5.nc'
         tsteps=23
         time_offset=1
         tstep_length=86400
         multiplier=86400.
	 ...
	 all_box_size(i)=2000
      ...
      END
      2 : BEGIN
         infile=gc2+'/anrid/anrid.jun-sep_5dmeans.precip.2p5x2p5.nc'
         tsteps=15
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
	 ...
	 all_box_size(i)=2000
      ...
      ;END
      3 : BEGIN
         infile=um6+'/answa_N1024param/wp_5dmeans_2p5x2p5.nc'
         tsteps=23
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
      ...
      END   
      4 : BEGIN
         infile=um6+'/answc_N1024explt/wp_5dmeans_2p5x2p5.nc'
         tsteps=23
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
      ...
      END
      5 : BEGIN
         infile=trmm+'/native_resolution/TRMM_3B42v6A.jun-sep_5dmeans.1999-2010.precip.2p5x2p5.nc'
         tsteps=120*12/5
         time_offset=0
         tstep_length=86400
         multiplier=24.
      ...
      ;END
      6 : BEGIN
         infile=cmorph+'/CMORPH.jun-sep_5dmeans_ts.2001-2012.precip.2p5x2p5.nc'
         tsteps=11700/40
         time_offset=0
         tstep_length=86400
         multiplier=8.
  ...
  ; psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_precip_twodpdf.'+psfile_title+'_prct.ps'
  ...
  ; PSCLOSE,/NOVIEW
   ...
   mylevs_prct=['1e-5','2e-5','4e-5','7e-5','1e-4','2e-4','4e-4','7e-4','1e-3','2e-3','4e-3','7e-3','1e-2','2e-2','4e-2','7e-2','1e-1']
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_precip_twodpdf_2p5.'+psfile_title+'_prct.ps'
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_spatialscale_2p5.'+psfile_title+'.'+$
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_precip_twodpdf_2p5.many_distance_tstep_egu.ps'
...
AXES,XSTEP=100,XMINOR=50,XTITLE='Distance (km)',$
     YTITLE='Correlation of pentad-mean precipitation with central point (x=0)',$
     YSTEP=0.1,YMINOR=0.05,NDECS=1
PSCLOSE

psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_5daily_precip_twodpdf_2p5.many_time_tstep_egu.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
...
GLEGEND,labels=all_psfile_titles,COL=FSC_COLOR(all_colors),length=0,SYM=all_syms,LEGPOS=9
AXES,XSTEP=5,XMINOR=2.5,XTITLE='Time (day)',$
     YTITLE='Lag correlation of gridpoint pentad precipitation',$
     YSTEP=0.1,YMINOR=0.05,NDECS=1
PSCLOSE
