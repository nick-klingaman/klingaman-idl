PRO metum_daily_precip_twodpdf_allyears
...
;         infile=gc2+'/antia/antia.jun-sep_dmeans.precip.nc'
;         tsteps=119
         infile=gc2+'/antia/hadgem3_ga6_n96.jun-sep_dmeans_ts.years1-27.precip.nc'
         tsteps=120*27-1
         time_offset=1
         tstep_length=86400
         multiplier=86400.
...
;         infile=gc2+'/antib/antib.jun-sep_dmeans.precip.nc'
;         tsteps=119
         infile=gc2+'/antib/hadgem3_ga6_n216.jun-sep_dmeans_ts.years1-27.precip.nc'
         tsteps=120*27-1
         time_offset=1
         tstep_length=86400
         multiplier=86400.
...
;         infile=gc2+'/anrid/anrid.jun-sep_dmeans.precip.nc'
;         tsteps=82
         infile=gc2+'/anrid/hadgem3_ga6_n512.jun-sep_dmeans_ts.years1-9.precip.nc'
         tsteps=1109
         tstep_length=86400
         multiplier=86400.
         lon_name='longitude'
  ...
  ; PSCLOSE,/NOVIEW
   ...
   mylevs_prct=['1e-5','2e-5','4e-5','7e-5','1e-4','2e-4','4e-4','7e-4','1e-3','2e-3','4e-3','7e-3','1e-2','2e-2','4e-2','7e-2','1e-1']
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_precip_twodpdf.'+psfile_title+'_prct_alljjas.ps'
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_spatialscale.'+psfile_title+'.'+$
          STRTRIM(STRING(domain_size),1)+'x'+STRTRIM(STRING(domain_size),1)+'.corr_coeffs_radvlag_alljjas.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_precip_twodpdf.many_distance_tstep_egu_alljjas.ps'
...
psfile='/home/ss901165/idl/mjo_diabatic/timestep/metum_daily_precip_twodpdf.many_time_tstep_egu_alljjas.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=150,TFONT=150,MARGIN=2000,XOFFSET=1000,/PORTRAIT,YOFFSET=1000
