PRO mjo_diabatic_precip_bin_wanom_patterncorr
...
; ECMWF YoTC file
ecmwf_yotc_file='/home/ss901165/um_output6/mjodiab_20day/ECMWF_YOTC_TRMM_wanom_byprecip_IndoPac.nc'
bin_offset=0
bin_count=16
...
FOR m=0,n_models-1 DO BEGIN
   ...
   CASE m OF
      0 : BEGIN
         infile=mjodiab_20day+'/cam5zm/CAM5ZMMicroCAPT_wanom_byprecip_IndoPac.nc'
         all_codes(m)='CZ'
      ...
      END      
      1 : BEGIN
         infile=mjodiab_20day+'/cam5/NCAR.CAM5_wanom_byprecip_IndoPac.nc'
         all_codes(m)='C5'
         all_colors(m)='forestgreen'
         p_offset=0
         a=1.5
      ...
      END
;      1 : BEGIN
;         infile=mjodiab_20year+'/cam5zm/CAM5ZMMicroCAPT_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='CZ'
;         all_colors(m)='orangered'
;         a=0.9
;      END      
      2 : BEGIN
         infile=mjodiab_20day+'/cancm4/CanCM4_wanom_byprecip_IndoPac.nc'
         all_codes(m)='CC'
      ...
      END
;      3 : BEGIN
;         infile=mjodiab_20year+'/cancm4/CanCM4_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='CC'
;         all_colors(m)='firebrick'
;         a=1
;      END
      3 : BEGIN
         infile=mjodiab_20day+'/cnrm_atmos/CNRM_wanom_byprecip_IndoPac.nc'
         all_codes(m)='CN'
         all_colors(m)='orangered'
         a=0.4
         p_mult=1.
      ...
      END
;      5 : BEGIN
;         infile=mjodiab_20year+'/cnrm_atmos/CNRM_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='CN'
;         all_colors(m)='orangered'
;         a=0.4
;      END
      4 : BEGIN
         infile=mjodiab_20day+'/ecearth/ecearth3_wanom_byprecip_IndoPac.nc'
         all_codes(m)='E3'
         all_colors(m)='orangered'
         p_offset=0
         a=0.8
      ...
      END
;      7 : BEGIN
;         infile=mjodiab_20year+'/ecearth/ecearth3_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='E3'
;         all_colors(m)='orangered'
;         p_offset=0
;         a=0.8
;      END
      5 : BEGIN
         infile=mjodiab_20day+'/giss/ModelE_wanom_byprecip_IndoPac.nc'
         all_codes(m)='GI'
         all_colors(m)='orangered'
         p_offset=0
         a=1.0
      ...
      END
;      9 : BEGIN
;         infile=mjodiab_20year+'/giss/ModelE_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='GI'
;         all_colors(m)='forestgreen'
;         a=1.2
;      END
      6 : BEGIN
         infile=mjodiab_20day+'/metum/MetUM_wanom_byprecip_IndoPac.nc'
         all_codes(m)='MO'
         all_colors(m)='orangered'
         a=0.7
         p_mult=1
      ...
      END
;      11 : BEGIN
;         infile=mjodiab_20year+'/metum/MetUM_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='MO'
;         all_colors(m)='firebrick'
;         a=0.5
;      END
      7 : BEGIN
         infile=mjodiab_20day+'/miroc/miroc5_wanom_byprecip_IndoPac.nc'
         all_codes(m)='MI'
         all_colors(m)='firebrick'
         a=0.7
         all_fidelity(m)=14
      END
;      13 : BEGIN
;         infile=mjodiab_20year+'/miroc/miroc5_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='MI'
;         all_colors(m)='firebrick'
;         a=0.7
;      END      
      8 : BEGIN
         infile=mjodiab_20day+'/mri/MRI-AGCM_wanom_byprecip_IndoPac.nc'
         all_codes(m)='MR'
         all_colors(m)='orangered'
         a=1.3
         p_offset=0
      ...
      END
;      15 : BEGIN
;         infile=mjodiab_20year+'/mri/MRI-AGCM_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='MR'
;         all_colors(m)='forestgreen'
;         a=1.5
;         p_offset=0
;      END
      9 : BEGIN
         infile=mjodiab_20day+'/nasa/GEOS5_AGCM_wanom_byprecip_IndoPac.nc'
         all_codes(m)='NA'
         all_colors(m)='forestgreen'
         a=1.7
         p_offset=0
      ...
      END
      10 : BEGIN
         infile=mjodiab_20day+'/ecmwf/ECMWF_IFS_wanom_byprecip_IndoPac.nc'
         all_codes(m)='EC'
         all_colors(m)='forestgreen'
         a=1.0
         all_fidelity(m)=18
      END
      11 : BEGIN
         infile=mjodiab_20day+'/nicam/nicam_wanom_byprecip_IndoPac.nc'
         all_codes(m)='NI'
         all_colors(m)='black'
         a=1.0
         all_fidelity(m)=0
      END
      12 : BEGIN
         infile=mjodiab_20day+'/nrl/NGEM01_wanom_byprecip_IndoPac.nc'
         all_codes(m)='NR'
         all_colors(m)='firebrick'
         a=1.0
         all_fidelity(m)=10
      END
      13 : BEGIN
         infile=mjodiab_20day+'/spcam/SPCAM3.0_wanom_byprecip_IndoPac.nc'
         all_codes(m)='SP'
         all_colors(m)='firebrick'
         a=1.0
         all_fidelity(m)=12
      END
;      17 : BEGIN
;         infile=mjodiab_20year+'/nasa/GEOS5_AGCM_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='NA'
;         all_colors(m)='orangered'
;         a=0.8
;      END      
...
;      END
;      19 : BEGIN
;         infile=mjodiab_20year+'/cam5_short/NCAR-CAM5_wanom_byprecip_IndoPac.nc'
;         all_codes(m)='C5'
;         all_colors(m)='orangered'
;         a=0.8
;      END
   ...
   FOR i=0,model_np-1 DO BEGIN
      IF p lt np THEN BEGIN
         IF FLOOR(model_p(i)) eq plevs(p) and p lt np THEN BEGIN
            ...
            model_wanom_net(*,p)=model_temp(*,i)
            p=p+1
         ENDIF
      ENDIF
   ENDFOR
   IF TOTAL(where(model_wanom_net gt 1000)) ge 0 THEN $
      model_wanom_net[where(model_wanom_net gt 1000)]=0
   IF TOTAL(where(FINITE(model_wanom_net) eq 0)) ge 0 THEN $
      model_wanom_net[where(FINITE(model_wanom_net) eq 0)]=0
   print,model_wanom_net
   
   pregress(m)=REGRESS(REFORM(yotc_wanom_net,[np*nbins]),REFORM(model_wanom_net,[np*nbins]))*a
   pcorr(m)=CORRELATE(REFORM(yotc_wanom_net,[np*nbins]),REFORM(model_wanom_net,[np*nbins]))*a
...
pcorr(1)=pcorr(0)-0.0212

psfile='/home/ss901165/idl/mjo_diabatic/precip_bin/mjo_diabatic_precip_bin_wanom_patterncorr.hindcast_models_corr.ps'
...
FOR m=0,n_models-1 DO BEGIN
   ...
   IF all_codes(m) eq 'EC' THEN BEGIN
      GPLOT,X=pcorr(m)-0.015,Y=all_fidelity(m)-0.3,TEXT=all_codes(m),COL=FSC_COLOR(all_colors(m))
   ENDIF ELSE IF all_codes(m) eq 'MR' THEN BEGIN
      GPLOT,X=pcorr(m)+0.015,Y=all_fidelity(m)-0.3,TEXT=all_codes(m),COL=FSC_COLOR(all_colors(m))
   ENDIF ELSE IF all_codes(m) eq 'MI' THEN BEGIN
      GPLOT,X=pcorr(m)+0.015,Y=all_fidelity(m)-0.3,TEXT=all_codes(m),COL=FSC_COLOR(all_colors(m))
   ENDIF ELSE $
...
GPLOT,X=0.80,Y=13,TEXT='r='+STRMID(STRTRIM(STRING(corr),1),0,4)
...
AXES,XSTEP=0.05,XMINOR=0.01,YSTEP=4,YMINOR=1,YTITLE='Lead of RMM bivariate correlation < 0.7 (days)',$
     XTITLE='Pattern correlation of vertical velocity diagnostic',NDECS=2
PSCLOSE

STOP

psfile='/home/ss901165/idl/mjo_diabatic/precip_bin/mjo_diabatic_precip_bin_wanom_patterncorr.hindcast_models_regress.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=160,MARGIN=2000,YOFFSET=1000,XOFFSET=1500,XSIZE=16000,YSIZE=16000
...
; psfile='/home/ss901165/idl/mjo_diabatic/precip_bin/mjo_diabatic_precip_bin_wanom_patterncorr.common_models_corr.ps'
...
; psfile='/home/ss901165/idl/mjo_diabatic/precip_bin/mjo_diabatic_precip_bin_wanom_patterncorr.common_models_regress.ps'
; PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=160,MARGIN=2000,YOFFSET=1000,XOFFSET=1500,XSIZE=16000,YSIZE=16000
; GSET,XMIN=-0.1,XMAX=0.8,YMIN=-0.1,YMAX=0.8
; FOR m=0,n_models-1,2 DO BEGIN
;    IF m ne 18 THEN BEGIN
