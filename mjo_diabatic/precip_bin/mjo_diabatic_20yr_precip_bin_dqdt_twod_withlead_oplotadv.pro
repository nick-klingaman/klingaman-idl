PRO mjo_diabatic_20yr_precip_bin_dqdt_twod_withlead_oplotadv,model_names=model_names,box,box_name,mask_type,plot_yotc=plot_yotc
...
ENDIF ELSE $
   our_model_names=['cancm4','giss','ecearth','cnrm_atmos','mri','metum','miroc','nasa','cam5zm']
...
IF KEYWORD_SET(plot_yotc) THEN BEGIN
   ...
   NCDF_VARPUT,id,varids(2),REFORM(all_dqdt_binned(i,*,*))
...
FOR i=0,n_models-1 DO BEGIN
   ...
   CASE our_model_names(i) OF
      ...
      END
      'cam5zm' : BEGIN
         indir='/home/ss901165/um_output6/mjodiab_20year/cam5zm'
   ...
   model_dqdt_infile=indir+'/'+file_desc+'.tnhus.1991-2010.nc'
   model_dqadt_infile=indir+'/'+file_desc+'.tnhusa.1991-2010.nc'
   model_pr_infile=indir+'/'+file_desc+'.pr.1991-2010.nc'
   ...
   model_z=OPEN_AND_EXTRACT(model_dqdt_infile(0),level_name)*level_multiplier+0.0001
   ...
   psfile='/home/ss901165/idl/mjo_diabatic/precip_bin/mjo_diabatic_20yr_precip_bin_dqdt_twod_withlead_oplotadv.'+$
