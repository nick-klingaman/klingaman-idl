PRO mjo_diabatic_rmm_wheel_constinit,model_names,start_date,stop_date,dates_nth=dates_nth,lead_times=lead_times,$
                                     dots_nth=dots_nth
...
;   rmm2_plot=SMOOTH(obs_rmm2,17)
   ...
   FOR j=0,n_days-1,our_dates_nth DO BEGIN      
      IF FINITE(this_model_rmm1(j,0)) eq 1 THEN BEGIN
         ...
         rmm1_plot=this_model_rmm1(j,*)-(this_model_rmm1(j,0)-obs_rmm1(j))*0.85
         rmm2_plot=this_model_rmm2(j,*)-(this_model_rmm2(j,0)-obs_rmm2(j))*0.85
