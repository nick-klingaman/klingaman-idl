PRO mjo_diabatic_tendencies_composite_olr_q,model_names,start_date,stop_date,box,region_name,lead_times=lead_times

; Composite humidity tendencies by suppressed/transition/active MJO
...
;                  ' using hindcast initialised on '+initial_date
   ...
   FOR k=0,n_lead_times-1 DO BEGIN      
      ...
      GSET,XMIN=-0.5,XMAX=0.5,YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=plot_desc+' dT/dt '+region_name+$
      ...
      AXES,XSTEP=0.05,XMINOR=0.025,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',XTITLE='Moistening rate (g kg!U-1!N mm!U-1!N)',NDECS=1,$
      ...
      PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE3=200,XOFFSET=2000,YOFFSET=2000,TFONT=2,TCHARSIZE=90,$
             CB_WIDTH=110,SPACE2=2000,/PORTRAIT
      GSET,XMIN=-4,XMAX=4,YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=plot_desc+' dT/dt '+region_name+$
      ...
      GPLOT,X=[0,0],Y=[MIN(model_z),MAX(model_z)+25],COL=FSC_COLOR('black'),STYLE=1
      GLEGEND,labels=REVERSE(increment_descs),COL=REVERSE(FSC_COLOR(increment_colors)),LEGXOFFSET=2000,LEGYOFFSET=26000
      AXES,XSTEP=0.4,XMINOR=0.2,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',XTITLE='Moistening rate (g kg!U-1!N mm!U-1!N)',NDECS=1,$
           /NORIGHT,/NOUPPER,ORIENTATION=30
      PSCLOSE
      ...
      PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE3=200,XOFFSET=2000,YOFFSET=2000,TFONT=2,TCHARSIZE=90,$
             CB_WIDTH=110,SPACE2=2000,/PORTRAIT
      GSET,XMIN=-2,XMAX=2,YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=plot_desc+' dT/dt '+region_name+$
      ...
      GPLOT,X=[0,0],Y=[MIN(model_z),MAX(model_z)+25],COL=FSC_COLOR('black'),STYLE=1
      GLEGEND,labels=REVERSE(increment_descs),COL=REVERSE(FSC_COLOR(increment_colors)),LEGXOFFSET=2000,LEGYOFFSET=26000
      AXES,XSTEP=0.2,XMINOR=0.1,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',XTITLE='Moistening rate (g kg!U-1!N mm!U-1!N)',NDECS=1,$
           /NORIGHT,/NOUPPER,ORIENTATION=30
      PSCLOSE
