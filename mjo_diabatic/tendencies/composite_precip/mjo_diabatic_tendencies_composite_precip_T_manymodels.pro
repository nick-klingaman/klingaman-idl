PRO mjo_diabatic_tendencies_composite_precip_t_manymodels,model_names=model_names,inc_type,start_date,stop_date,box,region_name,lead_times=lead_times
...
FOR i=0,n_models-1 DO BEGIN
   ...
   CASE inc_type OF
      'physics' : BEGIN
         ...
         xmin=[-6,-3,-4,-3,-1]
         xmax=[45,5,12,5,4]
         xstep=[6,0.5,2,0.5,0.25]
      END
      'advection' : BEGIN
         increment_name='tnta'
         xmin=[-45,-3,-10,-4,-4]
         xmax=[6,5,2,4,4]
         xstep=[6,0.5,1,0.5,0.5]
      END
      'radiation' : BEGIN
         increment_name='tnt_radiation'
         xmin=[-3,-4,-3,-4,-4]
         xmax=[3,1,3,2,2]
         xstep=[0.5,0.5,0.5,0.5,0.5]
      END
      'all' : BEGIN
         increment_name='tnt'
         xmin=[-3,-2,-2,-2,-2]
         xmax=[3,2,2,2,2]
         xstep=[0.5,0.4,0.4,0.4,0.4]
      END      
   ENDCASE
   ...
   FOR k=0,n_lead_times-1 DO BEGIN
      ...
      frac_nearzero_points(i,k)=FLOAT(total_nearzero_points(k))/FLOAT(model_nlon*model_nlat*n_times_per_day*n_days)
   ENDFOR
ENDFOR

FOR k=0,n_lead_times-1 DO BEGIN      
   psfile='/home/ss901165/idl/mjo_diabatic/tendencies/composite_precip/mjo_diabatic_tendencies_composite_precip_T_manymodels.by_quartile.'+$
   ...
   GSET,XMIN=xmin(0),XMAX=xmax(0),YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=inc_type+' dT/dt '+region_name+$
   ...
   AXES,XSTEP=xstep(0),XMINOR=xstep(0)/2.,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',$
        XTITLE='Heating rate (K day!U-1!N)',NDECS=2,/NORIGHT,/NOUPPER,ORIENTATION=30   
   ...
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE3=200,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,$
          CB_WIDTH=110,SPACE2=2000,/PORTRAIT
   GSET,XMIN=xmin(1),XMAX=xmax(1),YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=inc_type+' dT/dt '+region_name+$
   ...
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE3=200,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,$
          CB_WIDTH=110,SPACE2=2000,/PORTRAIT
   GSET,XMIN=xmin(2),XMAX=XMAX(2),YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=inc_type+' dT/dt '+region_name+$
   ...
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE3=200,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,$
          CB_WIDTH=110,SPACE2=2000,/PORTRAIT
   GSET,XMIN=xmin(3),XMAX=xmax(3),YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=inc_type+' dT/dt '+region_name+$
   ...
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE3=200,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,$
          CB_WIDTH=110,SPACE2=2000,/PORTRAIT
   GSET,XMIN=xmin(4),XMAX=xmax(4),YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=inc_type+' dT/dt '+region_name+$
