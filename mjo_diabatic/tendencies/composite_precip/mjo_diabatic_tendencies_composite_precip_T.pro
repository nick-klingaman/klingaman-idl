PRO mjo_diabatic_tendencies_composite_precip_T,model_names,start_date,stop_date,box,region_name,lead_times=lead_times
...
;   print,total_active_precip,total_transactive_precip(k),total_transsuppressed_precip(k),total_suppressed_precip(k)
   FOR k=0,n_lead_times-1 DO BEGIN      
      psfile='/home/ss901165/idl/mjo_diabatic/tendencies/composite_precip/mjo_diabatic_tendencies_composite_precip_T.by_quartile.'+$
      ...
      GSET,XMIN=-1,XMAX=1,YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=plot_desc+' dT/dt '+region_name+$
      ...
      GPLOT,X=-0.9,Y=40,TEXT='Mean precip in bin: '+$
      ...
      PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE3=200,XOFFSET=2000,YOFFSET=2000,TFONT=2,TCHARSIZE=90,$
             CB_WIDTH=110,SPACE2=2000,/PORTRAIT
      GSET,XMIN=-10,XMAX=10,YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=plot_desc+' dT/dt '+region_name+$
      ...
      GPLOT,X=[0,0],Y=[MIN(model_z),MAX(model_z)+25],COL=FSC_COLOR('black'),STYLE=1
      GPLOT,X=-9,Y=40,TEXT='Mean precip in bin: '+$
      ...
      GLEGEND,labels=REVERSE(increment_descs),COL=REVERSE(FSC_COLOR(increment_colors)),LEGXOFFSET=2000,LEGYOFFSET=26000
      AXES,XSTEP=1.,XMINOR=0.5,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',XTITLE='Heating rate (K mm!U-1!N)',NDECS=1,$
           /NORIGHT,/NOUPPER,ORIENTATION=30
      PSCLOSE,/NOVIEW
      ...
      GLEGEND,labels=REVERSE(increment_descs),COL=REVERSE(FSC_COLOR(increment_colors)),LEGXOFFSET=2000,LEGYOFFSET=26000
      AXES,XSTEP=0.2,XMINOR=0.1,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',XTITLE='Heating rate (K mm!U-1!N)',NDECS=1,$
           /NORIGHT,/NOUPPER,ORIENTATION=30
      PSCLOSE,/NOVIEW
      ...
      PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE3=200,XOFFSET=2000,YOFFSET=2000,TFONT=2,TCHARSIZE=90,$
             CB_WIDTH=110,SPACE2=2000,/PORTRAIT
      GSET,XMIN=-3,XMAX=3,YMIN=MAX(model_z)+25,YMAX=MIN(model_z),TITLE=plot_desc+' dT/dt '+region_name+$
      ...
      GPLOT,X=[0,0],Y=[MIN(model_z),MAX(model_z)+25],COL=FSC_COLOR('black'),STYLE=1
      GPLOT,X=-2.7,Y=40,TEXT='Mean precip in bin: '+$
      ...
      GLEGEND,labels=REVERSE(increment_descs),COL=REVERSE(FSC_COLOR(increment_colors)),LEGXOFFSET=2000,LEGYOFFSET=26000
      AXES,XSTEP=0.3,XMINOR=0.15,YVALS=FLOOR(model_z+0.01),YTITLE='Pressure (hPa)',XTITLE='Heating rate (K mm!U-1!N)',NDECS=1,$
           /NORIGHT,/NOUPPER,ORIENTATION=30
      PSCLOSE,/NOVIEW
