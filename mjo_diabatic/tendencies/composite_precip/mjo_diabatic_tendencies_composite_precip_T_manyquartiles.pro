PRO mjo_diabatic_tendencies_composite_precip_T_manyquartiles,model_names=model_names,inc_type,start_date,stop_date,box,region_name,lead_times=lead_times
...
FOR i=0,n_models-1 DO BEGIN
   ...
   CASE our_model_names(i) OF
      ...
      'metum' : BEGIN
         ...
         valid_dates=STRTRIM(STRING([indgen(22)+20091010,indgen(5)+20091101,$
                                     indgen(16)+20091107,indgen(2)+20091124,$
                                     indgen(22)+20091210,indgen(10)+20100101,indgen(13)+20100112]),1)
         longitude_name='longitude'
         latitude_name='latitude'
         level_name='level'        
         reverse_levels(i)=0
...
FOR m=0,n_models-1 DO BEGIN
   psfile='/home/ss901165/idl/mjo_diabatic/tendencies/composite_precip/mjo_diabatic_tendencies_composite_precip_T_manyquartiles.'+$
   ...
   GLEGEND,labels=REVERSE(['Wettest Quartile','2nd Quartile','3rd Quartile','Driest Quartile','< 0.2 mm day!U-1!N']),$
           COL=REVERSE([FSC_COLOR(['blue','cyan','orange','red','black'])]),LEGPOS=3
   GLEGEND,labels=REVERSE(['All','Increasing','Steady/not sig','Decreasing']),$
           STYLE=REVERSE([0,1,2,3]),LEGPOS=1,SYM=REVERSE(syms)
