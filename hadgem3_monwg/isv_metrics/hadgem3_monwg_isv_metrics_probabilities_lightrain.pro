PRO hadgem3_monwg_isv_metrics_probabilities_lightrain
...
FOR i=0,n_sets-1 DO BEGIN
    ...
    IF i eq 0 THEN BEGIN
        psfile='/home/ss901165/idl/hadgem3_monwg/isv_metrics/hadgem3_monwg_isv_metrics_probabilities_lightrain.n96.ps'
...
GLEGEND,labels=REVERSE(items),COL=REVERSE(color_numbers),LEGPOS=7
