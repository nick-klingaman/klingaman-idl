PRO hadgem3_monwg_isv_metrics_probabilities_ga30
...
hadgem3kpp_50N50S_infile='/home/ss901165/um_output6/xihvd/hadgem3kpp_1.5xentrain_ga30_50N50S.jan-dec_dmeans.years1-23.precip.nc'
...
FOR i=0,n_sets-1 DO BEGIN
   ...
   CASE i OF
      ...
      END
      3 : BEGIN
         infile=hadgem3kpp_ctl_infile
         mask_infile=mask_n96_infile
         plot_title='Kwp-CTL-OBS'
         start_read=150
         n_years=20
         fived=0
         multiplier=86400.
      END
      4 : BEGIN
         infile=hadgem3kpp_15xentrain_infile
         mask_infile=mask_n96_infile
         plot_title='Kwp-ENT-OBS'
         start_read=150
         n_years=20
         fived=0
         multiplier=86400.         
   ...
   ENDCASE
    ...
    IF i eq 0 THEN BEGIN
        psfile='/home/ss901165/idl/hadgem3_monwg/isv_metrics/hadgem3_monwg_isv_metrics_probabilities_ga30.india.n96.ps'
        PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2000,SPACE2=300,XOFFSET=1200,YOFFSET=500,TFONT=2,TCHARSIZE=100,SPACE3=300
        items=[plot_title(0)]
        colors=[color_numbers(0)]
        GSET,XMIN=MIN(heaviside),XMAX=MAX(heaviside),YMIN=0,YMAX=1,$
          TITLE='For all land points in 10-30N, 70-90E, the probabilities of rain given rain (solid) and not-rain given not-rain (dashed)'
