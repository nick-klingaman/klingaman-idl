PRO hadgem3_monwg_lag_correlations_lin08_ga30
...
nick_1xentrain_file='/home/ss901165/um_output5/xgspo/hadgem3a_ukmo_1.0xentrain_vn78.jan-dec_dmeans.years1-20.precip.filter30-50.nc'
nick_15xentrain_file='/home/ss901165/um_output5/xgspj/hadgem3a_ukmo_1.5xentrain_vn78.jan-dec_dmeans.years1-20.precip.filter30-50.nc'
kpp_1xentrain_file='/home/ss901165/um_output5/xgspp/hadgem3kpp_1.0xentrain_ga30.jan-dec_dmeans.j4-k1.precip.filter30-50.nc'
kpp_15xentrain_file='/home/ss901165/um_output5/xgspm/hadgem3kpp_1.5xentrain_ga30.jan-dec_dmeans.i2-k1.precip.filter30-50.nc'
...
FOR i=0,n_sets-1 DO BEGIN
    CASE i OF
        ...
        END
	1: BEGIN
           infile=kpp_15xentrain_file
           plot_title='GA3.0+KPP 1.5x entrain (N96, 20 years)'
           psfile_title='hadgem3kpp_15xentrain_ga30'
           filter_start_read=151
           n_days=120
           n_years=20
           multiplier=[86400,1.53]
           sig_level=0.274
        END
        0 : BEGIN
           infile=nick_15xentrain_file
           varname='precip'
	   plot_title='GA3.0 1.5x entrain clim SST (N96, 20 years)'
           psfile_title='hadgem3a_ukmo_15xentrain_vn78'
           filter_start_read=151
           n_days=120
           n_years=20
           multiplier=[86400,1.21]
           sig_level=0.274
        END
	2 : BEGIN
	   infile=nick_1xentrain_file
	   varname='precip'
	   plot_title='GA3.0 control clim SST (N96, 20 years)'
	   psfile_title='hadgem3a_ukmo_1xentrain_vn78'
	   filter_start_read=151
	   n_days=120
	   n_years=20
	   multiplier=[86400,1]
    ...
    FOR j=0,n_years-1 DO BEGIN
        thisyear_precip_filtered=REFORM(OPEN_AND_EXTRACT(infile,varname,$
                                                         ...
                                                         count=[n_lon,n_lat,n_days,1]))*multiplier(0)
    ...
    psfile='/home/ss901165/idl/hadgem3_monwg/lag_correlations/hadgem3_monwg_lag_correlations_lin08_ga30.'+psfile_title+'.ps'
