PRO hadgem3_monwg_timestep_twodpdf_darwinmean

infiles=['/home/ss901165/datasets/DARWIN_RADAR/domain_rain2005Final.sav',$
         '/home/ss901165/datasets/DARWIN_RADAR/domain_rain2006Final.sav',$
         '/home/ss901165/datasets/DARWIN_RADAR/domain_rain2007Final.sav']

precip_10min=[0]
FOR i=0,N_ELEMENTS(infiles)-1 DO BEGIN
   restore,infiles(i)
   precip_10min=[precip_10min,REFORM(domain_rain(5,*))]
ENDFOR
n_steps=N_ELEMENTS(precip_10min)
...
FOR i=0,n_means-1 DO BEGIN   
   ...
   FOR j=LONG(0),n_means-1 DO $
      ts(j)=MEAN(precip_10min(j*mean_periods(i):(j+1)*mean_periods(i)-1),/NaN)   
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/timestep/hadgem3_monwg_timestep_twodpdf_darwinmean.'+STRTRIM(STRING(mean_periods(i)),1)+'mean'+'_prct.ps'
   ...
   IF TOTAL(where(oned_pdf_prct lt 0.001)) ge 0 THEN BEGIN
      print,where(oned_pdf_prct lt 0.001),oned_pdf_prct
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/timestep/hadgem3_monwg_timestep_twodpdf_darwinmean.'+STRTRIM(STRING(mean_periods(i)),1)+'mean'+'_prct_norm_col.ps'
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/timestep/hadgem3_monwg_timestep_twodpdf_darwinmean.'+STRTRIM(STRING(mean_periods(i)),1)+'mean'+'_prct_norm_row.ps'
   PSOPEN,file=psfile,TFONT=6,FONT=6,CHARSIZE=125,TCHARSIZE=110,XSIZE=16500,YSIZE=16500,SPACE2=2000,YOFFSET=1000
   GSET,XMIN=0,XMAX=n_heavi+1,YMIN=0,YMAX=n_heavi+1
   CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,white=[2]
   LEVS,MANUAL=mylevs
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/timestep/hadgem3_monwg_timestep_twodpdf_darwinmean.'+STRTRIM(STRING(mean_periods(i)),1)+'mean'+'_prct_norm_col2.ps'
   PSOPEN,file=psfile,TFONT=6,FONT=6,CHARSIZE=125,TCHARSIZE=110,XSIZE=16500,YSIZE=16500,SPACE2=2000,YOFFSET=1000
   GSET,XMIN=0,XMAX=n_heavi+1,YMIN=0,YMAX=n_heavi+1
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/timestep/hadgem3_monwg_timestep_twodpdf_darwinmean.'+STRTRIM(STRING(mean_periods(i)),1)+'mean'+'_prct_norm_row2.ps'
   PSOPEN,file=psfile,TFONT=6,FONT=6,CHARSIZE=125,TCHARSIZE=110,XSIZE=16500,YSIZE=16500,SPACE2=2000,YOFFSET=1000
   GSET,XMIN=0,XMAX=n_heavi+1,YMIN=0,YMAX=n_heavi+1
   CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs_norm)+1,white=[12]
   LEVS,MANUAL=mylevs_norm
