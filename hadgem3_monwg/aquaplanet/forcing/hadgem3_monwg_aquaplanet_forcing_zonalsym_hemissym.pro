...
input_file='/home/users/npklingaman/datasets/HADGEM3-KPP_ANCIL/fcorr_columbia_aqua_n216e.nc'
output_file='/home/users/npklingaman/datasets/HADGEM3-KPP_ANCIL/fcorr_columbia_aqua_hemissym_n216e.nc'

longitude=OPEN_AND_EXTRACT(input_file,'longitude')
latitude=OPEN_AND_EXTRACT(input_file,'latitude')
z=OPEN_AND_EXTRACT(input_file,'t')
n_lon=N_ELEMENTS(longitude)
n_lat=N_ELEMENTS(latitude)
n_z=N_ELEMENTS(z)

input=OPEN_AND_EXTRACT(input_file,'fcorr',$
                              offset=[0,0,0],$
...
varids(4)=NCDF_VARDEF(id,'fcorr',[dimids(0),dimids(1),dimids(2)])
