PRO hadgem3_monwg_aquaplanet_forcing_qobs_n96e
...
grid_file='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/landfrac_n96e_hadgem3-8.5.nc'
...
FOR i=0,n_lat-1 DO BEGIN
   ...
   ENDIF ELSE BEGIN
      ...
      sst2=sst_max*(1-sin(latitude(i)*!Pi/180.*3/2.)^4)
...
outfile='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/aquaplanet_sst.qobs.n96e.nc'
