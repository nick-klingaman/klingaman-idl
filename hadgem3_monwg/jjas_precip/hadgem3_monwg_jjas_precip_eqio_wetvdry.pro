PRO hadgem3_monwg_jjas_precip_eqio_wetvdry
...
;         temp_precip[where(n96_mask_rev eq 0)]=!Values.F_NaN
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.'+runid+'.wet_composite.ps'
   ...
   CON,FIELD=REFORM(hadgem3_wet_composite(k,*,*)),X=hadgem3_longitude,Y=hadgem3_latitude,$
       TITLE="JJAS rainfall for composite of wettest "+STRTRIM(STRING(nyears_wet),1)+" years over 60-90E, 10N-10S "+runid,CB_TITLE='mm day!U-1!N',$
       /NOLINES
   PSCLOSE

   psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.'+runid+'.dry_composite.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
   CS,SCALE=40,NCOLS=N_ELEMENTS(mylevs_diff_small)+1,/REV
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_raw
   CON,FIELD=REFORM(hadgem3_dry_composite(k,*,*)),X=hadgem3_longitude,Y=hadgem3_latitude,$
       TITLE="JJAS rainfall for composite of driest "+STRTRIM(STRING(nyears_dry),1)+" years over 60-90E, 10N-10S "+runid,CB_TITLE='mm day!U-1!N',$
       /NOLINES
   PSCLOSE

   psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.'+runid+'.wet_composite_anom.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.'+runid+'.dry_composite_anom.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_diff_small)+1,/REV
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_diff_small
   ...
   psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.'+runid+'.wet-minus-dry_composite.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_diff_small)+1,/REV
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_diff_small
...
psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.1.5x-minus-1.0x.wet_composite.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_diff_small)+1,/REV
MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
LEVS,MANUAL=mylevs_diff_small
CON,FIELD=REFORM(hadgem3_wet_composite(1,*,*)-hadgem3_wet_composite(0,*,*)),X=hadgem3_longitude,Y=hadgem3_latitude,$
    TITLE="JJAS diff in composite of wettest "+STRTRIM(STRING(nyears_wet),1)+" years over 60-90E, 10N-10S 1.5x minus 1.0x",CB_TITLE='mm day!U-1!N',$
    /NOLINES
PSCLOSE

psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.1.5x-minus-1.0x.dry_composite.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_diff_small)+1,/REV
MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
LEVS,MANUAL=mylevs_diff_small
CON,FIELD=REFORM(hadgem3_dry_composite(1,*,*)-hadgem3_dry_composite(0,*,*)),X=hadgem3_longitude,Y=hadgem3_latitude,$
    TITLE="JJAS diff in composite of driest "+STRTRIM(STRING(nyears_dry),1)+" years over 60-90E, 10N-10S 1.5x minus 1.0x",CB_TITLE='mm day!U-1!N',$
    /NOLINES
PSCLOSE

psfile='/home/ss901165/idl/hadgem3_monwg/jjas_precip/hadgem3_monwg_jjas_precip_eqio_wetvdry.1.5x-minus-1.0x.wet-minus-dry_composite.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,YSIZE=12000,SPACE3=500
CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_diff_small)+1,/REV
MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
LEVS,MANUAL=mylevs_diff_small
