PRO hadgem3_monwg_africa_jjas_precip_entrain
...
hadgem3_longitude[where(hadgem3_longitude gt 180.)]=hadgem3_longitude[where(hadgem3_longitude gt 180.)]-360.
...
trmm_longitude[where(trmm_longitude gt 180.)]=trmm_longitude[where(trmm_longitude gt 180.)]-360.
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.akkvg_mean.ps'
...
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
LEVS,MANUAL=mylevs
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.hadgem3a_amip2_ctl_vn74_mean.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=120
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[2]
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
LEVS,MANUAL=mylevs
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.trmm_3B42v6_mean.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=120
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[2]
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
LEVS,MANUAL=mylevs
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.hadgem3a_amip2_15xentrain_vn74_mean.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=120
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[2]
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
LEVS,MANUAL=mylevs
...
mylevs=['-8.5','-7.5','-6.5','-5.5','-4.5','-3.5','-2.5','-1.5','-0.5','0.5','1.5','2.5','3.5','4.5','5.5','6.5','7.5','8.5']
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.akkvg_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[11]
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.amip2-ctl_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[11]
;white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
CON,FIELD=diff_amip2_ctl_trmm,X=hadgem3_longitude,Y=trmm_latitude,$
  TITLE="Diff in JJAS-mean rainfall (mm day!U-1!N) for Nick HadGEM3 (vn7.4) AMIP2 1.0x entrain minus TRMM",$
  /NOLINES
PSCLOSE

psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.amip2-1.5xentrain_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[11]
;white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
CON,FIELD=diff_amip2_15xentrain_trmm,X=hadgem3_longitude,Y=trmm_latitude,$
  TITLE="Diff in JJAS-mean rainfall (mm day!U-1!N) for Nick HadGEM3 (vn7.4) AMIP2 1.5x entrain minus TRMM",$
  /NOLINES
PSCLOSE

psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.amip2-1.5xentrain_minus_amip2-ctl.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV,white=[11]
;white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.ahsaf_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.hadkpp_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.dge_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.ahsaf_minus_dge.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.ahsaf_minus_hadgem1.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
...
psfile='/home/ss901165/idl/hadgem3_monwg/africa/jjas_precip/hadgem3_monwg_africa_precip_entrain.hadgem1_minus_trmm.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=150,MARGIN=1500,SPACE2=300,XOFFSET=500,YOFFSET=200,TFONT=2,TCHARSIZE=100
CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
white=FSC_COLOR("white",N_ELEMENTS(mylevs)/2+1)
MAP,LONMIN=-40,LONMAX=80,LATMIN=-30,LATMAX=30
