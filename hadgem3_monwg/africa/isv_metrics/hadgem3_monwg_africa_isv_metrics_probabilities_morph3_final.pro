PRO hadgem3_monwg_africa_isv_metrics_probabilities_morph3_final
...
FOR i=0,n_sets-1 DO BEGIN
    ...
    mask=(OPEN_AND_EXTRACT(mask_infile,'lsm',$
                           ...
                           count=[mask_nlon,mask_nlat,1,1],/WRAP))
...
;       print,j
       IF fived eq 1 THEN BEGIN
          thisyear_precip=$
             REFORM(OPEN_AND_EXTRACT(infile,varname,$
                                     ...
                                     count=[n_lon,n_lat,1,n_days,1],/WRAP))*multiplier
       ENDIF ELSE $
          thisyear_precip=$
          REFORM(OPEN_AND_EXTRACT(infile,varname,$
                                  offset=[box_tx(1),box_tx(0),start_read,j],$
                                  count=[n_lon,n_lat,n_days,1],/WRAP))*multiplier
    ...
    IF i eq 0 THEN BEGIN
       psfile='/home/ss901165/idl/hadgem3_monwg/africa/isv_metrics/hadgem3_monwg_africa_isv_metrics_probabilities_morph3_final.'+box_name+'-2.ps'
       PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2000,SPACE2=300,XOFFSET=700,YOFFSET=500,TFONT=2,TCHARSIZE=100
       items=[plot_title(0)]
