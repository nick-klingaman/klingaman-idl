PRO spcam_ssts_make_smooth_ts_enso
...
kpp_sst_file='/group_workspaces/jasmin2/klingaman/cam/spcam_iceedge_free_spccsm_enso/kpp_ocean/sst.nc'
obs_sst_file='/home/users/npklingaman/datasets/SPCAM-KPP_ANCIL/spcam-kpp_sst_spccsm_enso.jan-dec_dmean_3yrclim.64x128.nc'
...
smooth_length=31
out_sst_file='/home/users/npklingaman/datasets/SPCAM-KPP_ANCIL/spcam_iceedge_free_spccsm_enso.jan-dec_dmeans_smooth31.years1-60.sst.nc'
   ...
   FOR j=0,n_lat-1 DO BEGIN
      IF landfrac(i,j) ne 1 THEN BEGIN
		...
		sst_out(i,j,k+1)=kpp_sst(i,j-kpp_latoff,k)*cplwght(i,j)+$
                                obs_sst(i,j,enso_date)*(1.-cplwght(i,j))
                                ;IF n_time MOD 365 ne 0 THEN $
