PRO qld_20thc_precip_clim_compare_silo_smeans_ensmem
...
;twentyc_smeans_sprd_infile='/home/ss901165/datasets_mango/20THC_REANALYSIS/precip_sprd/20thc_reanalysis.nov-apr_smeans.1891-2007.precip_sprd.nc'
twentyc_ensmem_smeans_infile='/home/ss901165/datasets_mango/20THC_REANALYSIS/every_member/precip/20thc_reanalysis_allmembers.nov-apr_smeans.1891-2007.precip.nc'
...
twentyc_ensmem_smeans=REFORM(OPEN_AND_EXTRACT(twentyc_ensmem_smeans_infile,'prate',$
                                              offset=[twentyc_box_tx(1),twentyc_box_tx(0),0,0],$
                                              count=[twentyc_nlon,twentyc_nlat,twentyc_nmembers,nyear]))*86400.                                              
...
twentyc_ensmem_smeans_qld_aavg=fltarr(twentyc_nmembers,nyear)
twentyc_stddev_smeans_qld_aavg=fltarr(nyear)
...
FOR i=0,nyear-1 DO BEGIN
   ...
   FOR j=0,twentyc_nmembers-1 DO $
      twentyc_ensmem_smeans_qld_aavg(j,i)=TOTAL(REFORM(twentyc_ensmem_smeans(*,*,j,i))*t63_weights)
   twentyc_stddev_smeans_qld_aavg(i)=STDDEV(twentyc_ensmem_smeans_qld_aavg(*,i)*365.)
ENDFOR
twentyc_smeans_clim=fltarr(twentyc_nlon,twentyc_nlat)
;twentyc_smeans_sprd_clim=fltarr(twentyc_nlon,twentyc_nlat)
...
;         twentyc_smeans_sprd_clim(i,j)=MEAN(twentyc_smeans_sprd(i,j,*))
      ENDIF ELSE BEGIN
         twentyc_smeans_clim(i,j)=!Values.F_NaN
;         twentyc_smeans_sprd_clim(i,j)=!Values.F_NaN
      ENDELSE
   ENDFOR
ENDFOR
...
;psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.silo_t62_may-apr_1891-2007_clim.ps'
...
;CON,X=silo_longitude,Y=silo_latitude,FIELD=silo_smeans_clim*365,/NOLINELABELS,$
;    TITLE='Clim ann-total (May-Apr) precip from SILO on T62 grid (as 20th cent.) - 1891-2008',/BLOCK,/NOLINES
;PSCLOSE,/NOVIEW
;
;psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc_t62_may-apr_1891-2007_clim.ps'
;PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=300,XOFFSET=1200,YOFFSET=1000,TFONT=2,TCHARSIZE=100,CB_WIDTH=110,/PORTRAIT
;CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
;LEVS,MANUAL=mylevs
;MAP,LATMIN=qld_box(2),LATMAX=qld_box(0),LONMIN=qld_box(1)+1,LONMAX=qld_box(3)-0.25,/HIRES
;CON,X=silo_longitude,Y=silo_latitude,FIELD=twentyc_smeans_clim*365,/NOLINELABELS,$
;    TITLE='Clim ann-total (May-Apr) precip from 20th Cent V2 - 1891-2008',/BLOCK,/NOLINES
;PSCLOSE,/NOVIEW
;

;psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc_sprd_t62_may-apr_1891-2007_cli;m.ps'
;PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=300,XOFFSET=1200,YOFFSET=1000,TFONT=2,TCHARSIZE=100,CB_WIDTH=110,/PORTRAIT
;CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs)+1,/REV
;LEVS,MANUAL=mylevs
;MAP,LATMIN=qld_box(2),LATMAX=qld_box(0),LONMIN=qld_box(1)+1,LONMAX=qld_box(3)-0.25,/HIRES
;CON,X=silo_longitude,Y=silo_latitude,FIELD=twentyc_smeans_sprd_clim*180,/NOLINELABELS,$
;    TITLE='Clim ann-total (May-Apr) ensemble spread in precip from 20th Cent V2 - 1891-2008',/BLOCK,/NOLINES
;PSCLOSE
       
;psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc-minus-silo_t62_may-apr_1891-20;07_clim.ps'
;PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=300,XOFFSET=1200,YOFFSET=1000,TFONT=2,TCHARSIZE=100,CB_WIDTH=110,/PORTRAIT
;CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs_diff)+1,/REV,white=[8]
;LEVS,MANUAL=mylevs_diff
;MAP,LATMIN=qld_box(2),LATMAX=qld_box(0),LONMIN=qld_box(1)+1,LONMAX=qld_box(3)-0.25,/HIRES
;CON,X=silo_longitude,Y=silo_latitude,FIELD=twentyc_smeans_clim*180-silo_smeans_clim*180,/NOLINELABELS,$
;    TITLE='Diff in clim ann-total (May-Apr) precip for 20thC V2 minus SILO - 1891-2008',/BLOCK,/NOLINES
;PSCLOSE,/NOVIEW

;psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc-ratio-silo_t62_may-apr_1891-20;07_clim.ps'
;PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=300,XOFFSET=1200,YOFFSET=1000,TFONT=2,TCHARSIZE=100,CB_WIDTH=110,/PORTRAIT
;CS,SCALE=26,NCOLS=N_ELEMENTS(mylevs_ratio)+1,/REV,white=[8]
;LEVS,MANUAL=mylevs_ratio
;MAP,LATMIN=qld_box(2),LATMAX=qld_box(0),LONMIN=qld_box(1)+1,LONMAX=qld_box(3)-0.25,/HIRES
;CON,X=silo_longitude,Y=silo_latitude,FIELD=twentyc_smeans_clim*365/(silo_smeans_clim*365),/NOLINELABELS,$
;    TITLE='Ratio of clim ann-total (May-Apr) precip for 20thC V2 divided by SILO - 1891-2008',/BLOCK,/NOLINES
;PSCLOSE,/NOVIEW
 
;psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc_silo_t62_may-apr_1891-2007_ts.;ps'
;PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE2=300,XOFFSET=400,YOFFSET=1000,TFONT=2,TCHARSIZE=80
;GSET,XMIN=1890,XMAX=2008,YMIN=200,YMAX=1500,TITLE='Comparison of 20thC V2 (ensemble-mean) and SILO (on T62 grid) area-avg, annual total (May-April) rainfall for Que;ensland - 1891-2007'
;black=FSC_COLOR("black",2)
;red=FSC_COLOR("red",3)
;HIST,X=indgen(nyear)+1891,Y=silo_smeans_qld_aavg*365,FILLCOL=2,WIDTH=45
;GPLOT,X=indgen(nyear)+1891,Y=twentyc_smeans_qld_aavg*365,COL=3,THICK=200
...
;GPLOT,X=indgen(nyear)+1891,Y=twentyc_smeans_qld_aavg*365/(silo_smeans_qld_aavg*365),STYLE=2,THICK=150,COL=3
...
psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc_sprd_silo_t62_nov-apr_1891-2007_ts.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE2=300,XOFFSET=400,YOFFSET=1000,TFONT=2,TCHARSIZE=100
GSET,XMIN=1890,XMAX=2008,YMIN=0,YMAX=1400,TITLE='Comparison of 20thC V2 and SILO (on T62 grid) area-averaged, seasonal-mean (November-April) rainfall for Queensland - 1891-2007'
black=FSC_COLOR("black",2)
red=FSC_COLOR("red",3)
cyan=FSC_COLOR("blue",4)
HIST,X=indgen(nyear)+1891,Y=silo_smeans_qld_aavg*182,FILLCOL=2,WIDTH=45
GPLOT,X=indgen(nyear)+1891,Y=twentyc_smeans_qld_aavg*182,COL=3,THICK=200
;GPLOT,X=indgen(nyear)+1891,Y=twentyc_smeans_sprd_qld_aavg*365,COL=3,STYLE=2,THICK=200
AXES,XSTEP=10,YSTEP=100,XTITLE='Year at beginning of November-April seasonal-mean',YTITLE='Queensland area-averaged, seasonal-total (November-April) rainfall (mm)',/NORIGHT,YMINOR=50,XMINOR=5
GSET,XMIN=1890,XMAX=2008,YMIN=0,YMAX=200
GPLOT,X=indgen(nyear)+1891,Y=twentyc_stddev_smeans_qld_aavg,STYLE=2,THICK=200,COL=4
AXES,XSTEP=10,YSTEP=20,YTITLE='Standard deviation of 20CR ens-mem QLD area-avg Nov-Apr rainfall (mm)',/ONLYRIGHT,NDECS=2,YMINOR=10
items=['Standard deviation of 20CR ensemble members','20CR ensemble-mean rainfall','SILO rainfall (on 20CR T62 grid)']
GLEGEND,labels=items,LEGPOS=9,COL=[4,3,2],STYLE=[2,0,0],SYM=[0,0,1],SIZE=[0,0,100],LENGTH=[100,100,0]
PSCLOSE
...
elnino_regression=REGRESS(silo_smeans_qld_aavg[elnino_years]*365,twentyc_smeans_qld_aavg[elnino_years]*365,CONST=elnino_constant,CORRELATION=elnino_correlation)
lanina_regression=REGRESS(silo_smeans_qld_aavg[lanina_years]*365,twentyc_smeans_qld_aavg[lanina_years]*365,CONST=lanina_constant,CORRELATION=lanina_correlation)
neutral_regression=REGRESS(silo_smeans_qld_aavg[neutral_years]*365,twentyc_smeans_qld_aavg[neutral_years]*365,CONST=neutral_constant,CORRELATION=neutral_correlation)
total_regression=REGRESS(silo_smeans_qld_aavg*365.,twentyc_smeans_qld_aavg*365.,CONST=total_constant,CORRELATION=total_correlation)

psfile='/home/ss901165/idl/queensland/reanalysis/twentieth_century/precip_clim/qld_20thc_precip_clim_compare_silo_smeans_ensmem.20thc_silo_t62_may-apr_1891-2007_scatter.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE2=300,XOFFSET=400,YOFFSET=1000,TFONT=2,TCHARSIZE=100
...
black=FSC_COLOR("black",2)
GPLOT,X=silo_smeans_qld_aavg*365,Y=twentyc_smeans_qld_aavg*365,COL=2,THICK=200,SYM=6,/NOLINES
GPLOT,X=silo_smeans_qld_aavg[lanina_years]*365,Y=twentyc_smeans_qld_aavg[lanina_years]*365,COL=4,THICK=200,SYM=6,/NOLINES
GPLOT,X=silo_smeans_qld_aavg[elnino_years]*365,Y=twentyc_smeans_qld_aavg[elnino_years]*365,COL=3,THICK=200,SYM=6,/NOLINES
