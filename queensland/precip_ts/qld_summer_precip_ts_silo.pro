...
psfile='/home/ss901165/idl/queensland/precip_ts/qld_summer_precip_ts_silo.ndjfma_silo025_total.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=2500,SPACE2=300,XOFFSET=2000,YOFFSET=500,TFONT=2,$
       TCHARSIZE=100,CB_WIDTH=110
GSET,XMIN=1900,XMAX=1900+silo_nyears,YMIN=-70,YMAX=100
;GSET,XMIN=1900,XMAX=2007,YMIN=0,YMAX=1200
red=FSC_COLOR("red",10)
black=FSC_COLOR("black",11)
HIST,X=indgen(silo_nyears)+1900,Y=silo_aavg_precip_ts,WIDTH=50,FILLCOL=10
GPLOT,X=indgen(silo_nyears-11)+1905,Y=silo_aavg_precip_ts_smooth(5:silo_nyears-6),COL=11,THICK=225
AXES,XSTEP=10,YSTEP=10,XTITLE="Year at beginning of November-April season",YTITLE="Percentage anomaly of November-April Queensland area-averaged rainfall"
