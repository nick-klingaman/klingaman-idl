PRO qld_iacorr_bypoint_silon216_makemask

; Give a SILO t62 file for latitude and longitude coorindates

qld_box=[-30,138,-10,154]
silo_infile='/home/ss901165/datasets_mango/SILO/n216/SILO_precip.may-apr_ameans.1900-2007.n216.nc'
...
mask_infile='/home/ss901165/um_output/mask_n216_nugam.nc'
...
;mask=fltarr(silo_nlon,silo_nlat)
;mask[where(silo_precip ge 1E6)]=0.0
;mask[where(silo_precip lt 1E6)]=1.0
...
FOR i=0,silo_nlon-1 DO BEGIN
   FOR j=0,silo_nlat-1 DO BEGIN
      IF silo_precip(i,j) lt 10000 and mask(i,j) eq 1.0 THEN BEGIN
...
psfile='/home/ss901165/idl/queensland/interannual_correlations/qld_iacorr_bypoint_silon216.region_map.may-apr.ps'
...
MAP,LONMIN=138.75,LONMAX=153.75,LATMIN=qld_box(0),LATMAX=qld_box(2),/hires
LEVS,MANUAL=mylevs
CON,FIELD=FLOAT(silo_regions),X=silo_longitude,Y=silo_latitude,$
    TITLE='Region map for SILO n216',/NOLINES,/BLOCK
PSCLOSE

mask_outfile='/home/ss901165/datasets_mango/SILO/n216/SILO_qld_region_mask.n216.may-apr.nc'
