PRO qld_iacorr_bypoint_silon96_makemask

; Give a SILO n96 file for latitude and longitude coorindates

qld_box=[-30,138,-10,154]
silo_infile='/home/ss901165/datasets_mango/SILO/n96/SILO.jan-dec_dmeans.1881.precip.n96.nc'
...
psfile='/home/ss901165/idl/queensland/interannual_correlations/qld_iacorr_bypoint_silon96.region_map.may-apr.ps'
...
CON,FIELD=FLOAT(silo_regions),X=silo_longitude,Y=silo_latitude,$
    TITLE='Region map for SILO n96',/NOLINES,/BLOCK
PSCLOSE

mask_outfile='/home/ss901165/datasets_mango/SILO/n96/SILO_qld_region_mask.n96.may-apr.nc'
