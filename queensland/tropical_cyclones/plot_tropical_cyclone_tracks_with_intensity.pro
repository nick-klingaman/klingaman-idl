PRO plot_tropical_cyclone_tracks_with_intensity
...
; Start plot
psfile='/home/ss901165/idl/queensland/tropical_cyclones/plot_tropical_cyclone_tracks_with_intensity.'+data_source+'_'+year+'_'+$
       STRTRIM(STRING(min_mslp_threshold),1)+'hPa.ps'
...
ENDFOR
; Plot title
GPLOT,X=180,Y=5,ALIGN=0.5,TEXT='Tropical cyclone tracks for '+data_source+' for season '+year+' (October-May) - only storms that attain < '+$
