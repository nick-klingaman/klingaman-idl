PRO plot_tropical_cyclone_densities_ibtracs_gden_enlndiff
...
input_file='/home/ss901165/datasets/IBTRACS/stat_trs_scl.oct-may_smeans.1979-2007.IBTRACS_SP.nc'
...
track_densities=OPEN_AND_EXTRACT(input_file,'gden',$
                                    ...
                                    count=[n_lon,n_lat,IBTrACS_nyears])
...
psfile='/home/ss901165/idl/queensland/tropical_cyclones/ibtracs_gden_enlndiff.ps'
...
LEVS,MANUAL=contour_levels,NDECS=2
...
CON,X=longitude,Y=latitude,FIELD=enlndiff,/NOLINES,$
    TITLE='Difference in observed tropical-cyclone genesis density [storms year!U-1!N (10!U6!N km)!U-1!N] (El Nino-La Nina)'
