PRO qld_wet_days_percentiles_freqtrend_corr_nino4_ipo
...
;      exceedance_frequency_corr(i,j)=R_CORRELATE(
   ENDFOR
ENDFOR

FOR i=0,n_lon-1 DO BEGIN
   FOR j=0,n_lat-1 DO BEGIN
      temp=R_CORRELATE(REFORM(exceedance_frequency(i,j,*)),nino4_mar_may)
...
;psfile='/home/swu07adk/silo/qld_wet_days_percentiles_nion4.sep-nov_1910-49a.ps'
...
CON,FIELD=correlations,Y=latitude,X=longitude,$
    ...
    ' percentile of daily rainfall - Sep-Nov - SILO 1910-49 and Sep-Nov NINO4 SSTs',/NOLINES,/BLOCK,$
