PRO qld_wet_days_percentiles_freqtrend_scatter_region
...
nino4='/home/ss901165/datasets/NINO/nino4_hadisst.dec-feb_smeans.1871-2007.nc'
...
start_date=[1,12,1901]            ; 1 March
stop_date=[28,2,1901]           ; 31 May
...
;psfile='/home/swu07adk/silo/qld_wet_days_percentiles_nion4.sep-nov_scatter_reg3.ps'
psfile='/home/ss901165/idl/queensland/temp.ps'

PSOPEN,file=psfile,THICK=200,TCHARSIZE=150
xpts=nino4_anomalies
ypts=exceedance_frequency_area_avg
GSET,XMIN=-2,XMAX=2,YMIN=0,YMAX=2.5
GPLOT,X=xpts,Y=ypts,SYM=2,/NOLINES
    TITLE='Scatter-plot of NINO4 SST anomalies and exceedance frequency at the 95th percentile in Region 3'
AXES,NDECS=2,XSTEP=0.2,YSTEP=0.25
PSCLOSE
