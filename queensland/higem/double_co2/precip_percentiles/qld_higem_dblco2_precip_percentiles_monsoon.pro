PRO qld_higem_dblco2_precip_percentiles_monsoon

onset_threshold=5
retreat_threshold=95
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF
      ...
      END
      1 : BEGIN
         infile='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eadwu.may-apr_dmeans.o2-r3.precip.global_domain.nc'
         n_years=28
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon.onset_spatial.'+model_name+'.'+region_name+'_region.'+pct_name+'.ps'
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon.retreat_spatial.'+model_name+'.'+region_name+'_region.'+pct_name+'.ps'
   PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
          TCHARSIZE=100,SPACE3=500,/PORTRAIT
   ...
   IF i gt 0 THEN BEGIN     
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
             'qld_higem_dblco2_precip_percentiles_monsoon.onset_spatial.'+model_names(i)+'-minus-'+model_names(0)+'.'+region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=100,SPACE3=500,/PORTRAIT
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
             'qld_higem_dblco2_precip_percentiles_monsoon.retreat_spatial.'+model_names(i)+'-minus-'+model_names(0)+'.'+region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=100,SPACE3=500,/PORTRAIT
      CS,SCALE=1,NCOLS=N_ELEMENTS(diff_levs)+1
      LEVS,MANUAL=diff_levs
      MAP,LONMIN=box(1),LONMAX=box(3),LATMIN=box(0),LATMAX=box(2)
      CON,X=longitude,Y=latitude,FIELD=REFORM(mean_retreat_dates(i,*,*))-REFORM(mean_retreat_dates(0,*,*)),$
...
psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_monsoon.onset_pdf.'+region_name+'_region.'+pct_name+'.ps'
PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
...
psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_monsoon.retreat_pdf.'+region_name+'_region.'+pct_name+'.ps'
PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
        TCHARSIZE=100,SPACE3=500
...
psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_monsoon.change_byonset.'+region_name+'_region.'+pct_name+'.ps'
PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
        TCHARSIZE=100,SPACE3=500
...
psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_monsoon.change_byretreat.'+region_name+'_region.'+pct_name+'.ps'
PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
        TCHARSIZE=100,SPACE3=500
