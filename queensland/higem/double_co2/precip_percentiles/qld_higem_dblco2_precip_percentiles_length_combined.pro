PRO qld_higem_dblco2_precip_percentiles_length_combined
...
FOR s=0,n_seasons-1 DO BEGIN
   CASE s OF
      0 : BEGIN
         ...
         stbl_input_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eafee_eadwu.dec-feb_dmeans.m9-s0.precip.global_domain.nc'
         n_days=90
         season_name='dec-feb'
         a=1.005
      END
      1 : BEGIN
         ...
         stbl_input_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eafee_eadwu.mar-may_dmeans.m9-s0.precip.global_domain.nc'
         n_days=90
         season_name='mar-may'
         a=1.0
      END
      4 : BEGIN
         ...
         stbl_input_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eafee_eadwu.jun-aug_dmeans.m9-s0.precip.global_domain.nc'
         n_days=90
         season_name='jun-aug'
      END
      3 : BEGIN
         ...
         stbl_input_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eafee_eadwu.sep-nov_dmeans.m9-s0.precip.global_domain.nc'
         n_days=90
         season_name='sep-nov'
      END
      2 : BEGIN
         ...
         stbl_input_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eafee_eadwu.may-apr_dmeans.m9-s0.precip.global_domain.nc'
         n_days=360
         season_name='may-apr'
         a=1.005
      END
   ...
   FOR m=0,n_models-1 DO BEGIN
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_length_combined.'+model_name+'.'+$
   ...
   mylevs=['0.74','0.78','0.82','0.86','0.90','0.94','0.98','1.02','1.06','1.11','1.16','1.22','1.28','1.35']
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_length_combined.higem_stbl-ratio-higem_ctl.'+$
          season_name+'_'+region_name+'.ps'
   PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=200,SPACE2=1000,XOFFSET=0,YOFFSET=1000,TFONT=3,$
          TCHARSIZE=100,SPACE3=500
   ...
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs)+1,/REV
   LEVS,MANUAL=mylevs
   ratio=FLOAT(REFORM(length_distribution(1,*,*)))/FLOAT(REFORM(length_distribution(0,*,*)))
   ratio[where(REFORM(length_distribution(0,*,*)) le 0.02)]=!Values.F_NaN
   CON,Y=indgen(max_length)+1.5,X=indgen(n_percentiles)+0.5,FIELD=ratio,$
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_length_combined.higem_stbl-ratio-higem_ctl.'+season_name+'_length_mean.ps'
   ...
   GSET,XMIN=0,XMAX=n_percentiles,YMIN=1,YMAX=3
   ctl_mean=fltarr(n_percentiles)
   stbl_mean=fltarr(n_percentiles)
   FOR k=0,n_percentiles-1 DO BEGIN
      ctl_mean(k)=TOTAL(length_distribution(0,k,*)/TOTAL(length_distribution(0,k,*))*(indgen(10)+1))
      stbl_mean(k)=TOTAL(length_distribution(1,k,*)/TOTAL(length_distribution(1,k,*))*(indgen(10)+1))*a^k
   ENDFOR
