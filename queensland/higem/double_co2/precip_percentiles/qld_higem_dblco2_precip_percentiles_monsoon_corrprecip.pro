PRO qld_higem_dblco2_precip_percentiles_monsoon_corrprecip
...
totalprecip_regress_levels=['-0.55','-0.45','-0.35','-0.25','-0.15','-0.05','0.05','0.15','0.25','0.35','0.45','0.55']
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF
      ...
      2 : BEGIN
         ...
         monthly_infile='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_eadwu.jan-dec_mmeans.o2-r3.precip.global_domain.nc'
         var_name='precip'
         n_years=30
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.onset_corrprecip.'+model_name+'.'$
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.retreat_corrprecip.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
   PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
          TCHARSIZE=100,SPACE3=500,/PORTRAIT
   CS,SCALE=26,NCOLS=N_ELEMENTS(regress_levels)+1,/REV
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.length_corrprecip.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
   PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
   ...
   FOR m=0,n_months-1 DO BEGIN
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.onset_corrprecip_monthly_'+months_names(m)+'.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=90,SPACE3=500,/PORTRAIT
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.retreat_corrprecip_monthly_'+months_names(m)+'.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=90,SPACE3=500,/PORTRAIT
      CS,SCALE=26,NCOLS=N_ELEMENTS(monthly_regress_levels)+1,/REV
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.length_corrprecip_monthly_'+months_names(m)+'.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=90,SPACE3=500,/PORTRAIT
      CS,SCALE=26,NCOLS=N_ELEMENTS(monthly_regress_levels)+1,/REV
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.totalprecip_corrprecip_monthly_'+months_names(m)+'.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=90,SPACE3=500,/PORTRAIT
      CS,SCALE=26,NCOLS=N_ELEMENTS(totalprecip_regress_levels)+1,/REV
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/'+$
          'qld_higem_dblco2_precip_percentiles_monsoon_corrprecip.fracprecip_corrprecip_monthly_'+months_names(m)+'.'+model_name+'.'$
          +region_name+'_region.'+pct_name+'.ps'
      PSOPEN,file=psfile,FONT=3,CHARSIZE=100,MARGIN=2000,SPACE1=100,SPACE2=500,XOFFSET=0,YOFFSET=1000,TFONT=3,$
             TCHARSIZE=90,SPACE3=500,/PORTRAIT
