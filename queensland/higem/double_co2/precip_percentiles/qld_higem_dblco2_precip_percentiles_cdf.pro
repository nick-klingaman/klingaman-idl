PRO qld_higem_dblco2_precip_percentiles_cdf
...
FOR i=0,n_seasons-1 DO BEGIN
   ...
   psfile='/home/ss901165/idl/queensland/higem/double_co2/precip_percentiles/qld_higem_dblco2_precip_percentiles_cdf.'+box_name+'.'+season_name+'.ps'
   ...
   ENDFOR
   AXES,XSTEP=xmax/10.,XMINOR=xmax/20.,YVALS=[0.001,0.002,0.003,0.005,0.007,0.01,0.015,0.02,0.03,0.04,0.06,0.08,0.10,0.15,0.20,0.30,0.40],$
        YLABELS=['99.9','99.8','99.7','99.5','99.3','99.0','98.5','98.0','97.0','96.0','94.0','92.0','90.0','85.0','80.0','70.0','60.0'],NDECS=3,$
        XTITLE='Daily precipitation (mm)',YTITLE='Cumulative probability',/NORIGHT
   ...
   GPLOT,X=[0,maxpdf],Y=[1,1],STYLE=1,COL=FSC_COLOR('blue')
   FOR j=0,n_chunks-1 DO BEGIN
   ...
   ENDFOR
   AXES,XSTEP=xmax/10.,XMINOR=xmax/20.,YSTEP=0.1,YTITLE='Ratio of (1-CDF) values at each precipitation amount',/ONLYRIGHT,NDECS=2
