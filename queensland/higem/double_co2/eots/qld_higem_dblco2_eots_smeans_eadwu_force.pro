PRO qld_higem_dblco2_eots_smeans_eadwu_force
...
;      this_eot_str=STRTRIM(STRING(k+1),1)
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/eots/qld_higem_eots_'+filename_runids+'_force.'+smean_period+'_smeans.eot'+this_eot_str+'.'+$
...
;         output_eot_raw_ts(i,j)=higem_smeans_eots_raw_ts(j,i)
   ...
   output_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_'+filename_runids+'_force.'+smean_period+'_smeans.'+stbl_year_range_str+'.eots.nc'
