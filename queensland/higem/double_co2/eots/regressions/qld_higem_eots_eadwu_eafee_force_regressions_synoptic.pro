PRO qld_higem_eots_eadwu_eafee_force_regressions_synoptic
...
;         xminor=[10,5,5,5]
   ...
   FOR n=1,n_sets-1 DO BEGIN
      CASE n OF 
         0 : BEGIN
            model_name='eadwu'
            year_range='o2-r3'
            eots_infile=eots_basedir+'/higem_eadwu_force.'+season_name+'_smeans.'+year_range+'.eots.nc'
            higem_mslp_infile=higem_basedir+'/higem_eadwu.'+season_name+'_smeans.'+year_range+'.mslp.global_domain.nc'
            higem_u850_infile=higem_basedir+'/higem_eadwu.'+season_name+'_smeans.'+year_range+'.u850.global_domain.nc'
            higem_v850_infile=higem_basedir+'/higem_eadwu.'+season_name+'_smeans.'+year_range+'.v850.global_domain.nc'
            sig_level=0.195
         END
         1 : BEGIN
            ...
            higem_mslp_infile=higem_basedir+'/higem_eafee_eadwu.'+season_name+'_smeans.'+year_range+'.mslp.global_domain.nc'
            higem_u850_infile=higem_basedir+'/higem_eafee_eadwu.'+season_name+'_smeans.'+year_range+'.u850.global_domain.nc'
            higem_v850_infile=higem_basedir+'/higem_eafee_eadwu.'+season_name+'_smeans.'+year_range+'.v850.global_domain.nc'
            sig_level=0.195
         END
      ENDCASE
      ...
      FOR j=0,n_eots-1 DO BEGIN
         ...
         FOR k=0,higem_nulon-1 DO BEGIN
            FOR m=0,higem_nulat-1 DO BEGIN
               eot_u850_regressions_higem(j,k,m)=REGRESS(REFORM(eots_loadings(*,j)),$
                                                         ...
                                                         CORRELATION=temp)*STDDEV(eots_loadings(*,j))*1.5
         ...
         psfile='/home/ss901165/idl/queensland/higem/double_co2/eots/regressions/qld_higem_eots_eadwu_eafee_force_regressions_synoptic.'+season_name+'_eot'+$
