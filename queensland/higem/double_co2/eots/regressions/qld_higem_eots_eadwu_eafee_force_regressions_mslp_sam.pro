PRO qld_higem_eots_eadwu_eafee_force_regressions_mslp_sam

eots_basedir='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu'
higem_basedir=eots_basedir
n_seasons=2
higem_offset=0
n_years=51
n_eots=4                        ; Number of EOTs to analyze
higem_siglevel=0.265
...
FOR i=0,n_seasons-1 DO BEGIN
   ...
   higem_infile=higem_basedir+'/higem_eafee_eadwu.'+season_name+'_smeans.m9-s0.mslp.global_domain.nc'
   ...
   FOR j=0,n_eots-1 DO BEGIN
      psfile='/home/ss901165/idl/queensland/higem/double_co2/eots/regressions/qld_higem_eots_eadwu_eafee_force_regressions_mslp_sam.'+season_name+'_eot'+$
             STRTRIM(STRING(j+1),1)+'_higem_corr.m9-s0.ps'
      ...
      CON,X=higem_longitude,Y=higem_latitude,FIELD=REFORM(eot_mslp_correlations_higem(j,*,*)),/NOLINES,/BLOCK,$
          TITLE='Correlation of EOT'+STRTRIM(STRING(j+1),1)+' of '+season_name+' rainfall with HiGEM 2xCO2 MSLP for m9-s0',$
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/eots/regressions/qld_higem_eots_eadwu_eafee_force_regressions_mslp_sam.'+season_name+'_eot'+$
             STRTRIM(STRING(j+1),1)+'_higem_regress.m9-s0.ps'
      ...
      CON,X=higem_longitude,Y=higem_latitude,FIELD=REFORM(eot_mslp_regressions_higem(j,*,*)),/NOLINES,/BLOCK,$
          TITLE='Regression of EOT'+STRTRIM(STRING(j+1),1)+' of '+season_name+' rainfall with HiGEM 2xCO2 MSLP for m9-s0'
