PRO qld_higem_dblco2_eots_smeans_eadwu_anomctl

; Perform the EOT procedure described in Smith et al. (2004) from van
; den Dool et al. (2000).
  
; Compute 2xCO2 and 2%CO2 anomalies relative to CTL climate, rather than their own climate.
...
;      print,VARIANCE(higem_smeans_eots_explained,/NaN)/higem_smeans_stvar
   ...
   FOR k=0,n_eots-1 DO BEGIN
      ...
      psfile='/home/ss901165/idl/queensland/higem/double_co2/eots/qld_higem_eots_'+filename_runids+'.'+smean_period+'_smeans_anomctl.eot'+this_eot_str+'.'+$
...
;         output_eot_raw_ts(i,j)=higem_smeans_eots_raw_ts(j,i)
   ...
   output_file='/home/ss901165/higem_qccce/es_2xco2stbl_eadwu/higem_'+filename_runids+'.'+smean_period+'_smeans_anomctl.'+stbl_year_range_str+'.eots.nc'
