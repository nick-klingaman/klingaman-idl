PRO higem_calculate_nino_indices
...
FOR m=0,2 DO BEGIN
   ...
   FOR i=0,n_months-1 DO BEGIN
      xbylr_clim_file=xbylr_indir+'/higem_xbylr.'+months(i)+'_mmean_clim.h9-p9.surf_temp.pac_domain.nc'
      xbylr_mmean_file=xbylr_indir+'/higem_xbylr.'+months(i)+'_mmeans.h9-p9.surf_temp.pac_domain.nc'
...
outfile='/home/ss901165/higem_qccce/hpcx_control_xbylr/higem_xbylr.jan-dec_mmeans.h9-p9.nino_indices.nc'
