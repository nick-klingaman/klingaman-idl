PRO qld_higem_eots_smeans_eafeb_regressions_synoptic
...
;         xminor=[10,5,5,5]
   ...
   higem_mslp_infile=higem_basedir+'/higem_eafeb.'+season_name+'_smeans.h9-w8.mslp.pac_domain.nc'
   ...
   FOR j=0,n_eots-1 DO BEGIN
      ...
      psfile='/home/ss901165/idl/queensland/higem/eots/regressions/qld_higem_eots_smeans_eafeb_regressions_synoptic.'+season_name+'_eot'+$
