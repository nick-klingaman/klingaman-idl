PRO qld_higem_eots_smeans_eafeb_regressions_tropcyc

eots_basedir='/home/ss901165/higem_qccce/es_control_eafeb'
tropcyc_basedir='/home/ss901165/higem_qccce/es_control_eafeb/tropical_cyclones'
n_seasons=4
...
;         n_years_tropcyc=58
   ...
   tropcyc_infile=tropcyc_basedir+'/stat_trs_scl.oct-may_smeans.i0-w8.nc'
   ...
   tropcyc_tden_smeans=REFORM(OPEN_AND_EXTRACT(tropcyc_infile,'tden',$
                                          ...
                                          count=[tropcyc_nlon,tropcyc_nlat,n_years_tropcyc]))*3
   ...
   FOR j=0,n_eots-1 DO BEGIN
      psfile='/home/ss901165/idl/queensland/higem/eots/regressions/qld_higem_eots_smeans_eafeb_regressions_tropcyc.tden_'+season_name+'_eot'+$
             STRTRIM(STRING(j+1),1)+'_tropcyc_corr.h9-w8.ps'
      ...
      CON,X=tropcyc_longitude,Y=tropcyc_latitude,FIELD=REFORM(eot_tden_correlations_tropcyc(j,*,*)),/NOLINES,/BLOCK,$
          ...
          ' of tropical cyclones HiGEM for h9-w8',CB_TITLE='Correlation coefficient'
      FOR k=0,tropcyc_nlon-1 DO BEGIN
         FOR m=0,tropcyc_nlat-1 DO BEGIN
      ...
      psfile='/home/ss901165/idl/queensland/higem/eots/regressions/qld_higem_eots_smeans_eafeb_regressions_tropcyc.tden_'+season_name+'_eot'+$
             STRTRIM(STRING(j+1),1)+'_tropcyc_regress.h9-w8.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=130,MARGIN=1500,SPACE2=800,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,CB_WIDTH=105,SPACE3=1000
...
;      eot_tden_regressions_tropcyc[where(ABS(eot_tden_correlations_tropcyc) lt sig_level)]=!Values.F_NaN
      CON,X=tropcyc_longitude,Y=tropcyc_latitude,FIELD=con_input,/NOLINES,/BLOCK,$
          TITLE='Regression of EOT'+STRTRIM(STRING(j+1),1)+' of '+season_name+' rainfall onto track density of tropical cyclones HiGEM for h9-w8',$
     ...
     ; ENDFOR
      ...
      psfile='/home/ss901165/idl/queensland/higem/eots/regressions/qld_higem_eots_smeans_eafeb_regressions_tropcyc.gden_'+season_name+'_eot'+$
             STRTRIM(STRING(j+1),1)+'_tropcyc_regress.h9-w8.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=130,MARGIN=1500,SPACE2=800,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,CB_WIDTH=105,SPACE3=1000
      ...
      CON,X=tropcyc_longitude,Y=tropcyc_latitude,FIELD=REFORM(eot_gden_regressions_tropcyc(j,*,*)),/NOLINES,/BLOCK,$
          TITLE='Regression of EOT'+STRTRIM(STRING(j+1),1)+' of '+season_name+' rainfall onto genesis density of tropical cyclones HiGEM for h9-w8',$
     ...
     ; ENDFOR
      ...
      psfile='/home/ss901165/idl/queensland/higem/eots/regressions/qld_higem_eots_smeans_eafeb_regressions_tropcyc.lden_'+season_name+'_eot'+$
             STRTRIM(STRING(j+1),1)+'_tropcyc_regress.h9-w8.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=130,MARGIN=1500,SPACE2=800,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=90,CB_WIDTH=105,SPACE3=1000
      ...
      CON,X=tropcyc_longitude,Y=tropcyc_latitude,FIELD=REFORM(eot_lden_regressions_tropcyc(j,*,*))*1.2,/NOLINES,/BLOCK,$          
          TITLE='Regression of EOT'+STRTRIM(STRING(j+1),1)+' of '+season_name+' rainfall onto lysis density of tropical cyclones HiGEM for h9-w8',$
          CB_TITLE='hPa per '+STRTRIM(STRING(FLOOR(STDDEV(eots_loadings(*,j)))),1)+$
          ' mm season!U-1!N (1 stddev) change in rainfall EOT timeseries'
     ; FOR k=0,tropcyc_nlon-1 DO BEGIN
     ;    FOR m=0,tropcyc_nlat-1 DO BEGIN
