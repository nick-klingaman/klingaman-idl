PRO all_reanalysis_teleconn_analysis_nino4_common
...
silo_nyears=44
  ...
  ; era40_reanalysis_precip_amean[where(mask_era40 eq 0)]=!Values.F_NaN
   ...
   thcent_reanalysis_precip_amean=REFORM(OPEN_AND_EXTRACT(thcent_reanalysis_infile_amean,'PRATE',$
                                                  offset=[ncep_reanalysis_box_tx(1),ncep_reanalysis_box_tx(0),67],$
                                                  count=[ncep_reanalysis_nlon,ncep_reanalysis_nlat,ncep_reanalysis_nyears]))
...
ENDFOR
   ...
   thcent_regression_coeff=fltarr(ncep_reanalysis_nlon,ncep_reanalysis_nlat)
   ...
   thcent_correlation_coeff=fltarr(ncep_reanalysis_nlon,ncep_reanalysis_nlat)
  ...
  FOR i=0,ncep_reanalysis_nlon-1 DO BEGIN
      FOR j=0,ncep_reanalysis_nlat-1 DO BEGIN
            ...
            ncep_regression_coeff(i,j)=REGRESS(nino4_index_era40_amean,ncep_temp_rainfall,CORRELATION=ncep_temp)*STDDEV(nino4_index_era40_amean)
            ncep_correlation_coeff(i,j)=ncep_temp
      ENDFOR
   ENDFOR

 
   psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_amean_ncep_common.1958-2001.ps'
   ...
   CON,FIELD=ncep_correlation_coeff,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Correlation of annual-mean daily rainfall rates between NCEP/NCAR reanalysis and NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE

   psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_amean_ncep_common.1958-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=ncep_regression_coeff,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rates between NCEP/NCAR reanalysis and NINO4 Index (1958-2001)',/NOLINES,$
  ...
  FOR i=0,era40_reanalysis_nlon-1 DO BEGIN
      FOR j=0,era40_reanalysis_nlat-1 DO BEGIN
            ...
            era40_regression_coeff(i,j)=REGRESS(nino4_index_era40_amean,era40_temp_rainfall,CORRELATION=era40_temp)*STDDEV(nino4_index_era40_amean)
            era40_correlation_coeff(i,j)=era40_temp
      ENDFOR
   ENDFOR

 
   psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_amean_era40_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_correlation_coeff,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Correlation of annual-mean daily rainfall rates between ERA-40 reanalysis and NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE

 psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_amean_era40_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_regression_coeff,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rates between ERA-40 reanalysis and NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  ...
  PSCLOSE
   ...
   FOR i=0,thcent_reanalysis_nlon-1 DO BEGIN
     FOR j=0,thcent_reanalysis_nlat-1 DO BEGIN
            ...
            thcent_regression_coeff(i,j)=REGRESS(nino4_index_era40_amean,thcent_temp_rainfall,CORRELATION=thcent_temp)*STDDEV(nino4_index_era40_amean)
            thcent_correlation_coeff(i,j)=thcent_temp
      ENDFOR
  ENDFOR

  psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_amean_thcent_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
  MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
  LEVS,MANUAL=mylevs_corr,NDECS=2
  CON,FIELD=thcent_correlation_coeff,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
      TITLE='- Correlation of annual-mean daily rainfall rates between 20th Century reanalysis and NINO4 Index (1958-2001)',/NOLINES,$
      CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
  AXES,XSTEP=10,YSTEP=5
 PSCLOSE   

 psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_amean_thcent_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_regression_coeff,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rate between 20th Century Reanalysis and NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
   PFILL,FIELD=thcent_correlation_coeff,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,MIN=0.29,MAX=1.5
   PFILL,FIELD=thcent_correlation_coeff,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,MIN=-1.5,MAX=-0.29
  PSCLOSE

FOR i=0,silo_t62_nlon-1 DO BEGIN
      FOR j=0,silo_t62_nlat-1 DO BEGIN
            silo_temp_rainfall=REFORM(silo_t62_precip_amean(i,j,*))
            silo_regression_coeff(i,j)=REGRESS(nino4_index_era40_amean,silo_temp_rainfall,CORRELATION=silo_temp)*STDDEV(nino4_index_era40_amean)
            silo_correlation_coeff(i,j)=silo_temp
      ENDFOR
   ENDFOR

 
   psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_amean_silo_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=silo_correlation_coeff,X=silo_t62_longitude,Y=silo_t62_latitude,$ 
       TITLE='- Correlation of annual-mean daily rainfall rate between SILO observations and NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE

 psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_amean_silo_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=silo_regression_coeff,X=silo_t62_longitude,Y=silo_t62_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rate between SILO observations and NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
...
FOR k=0,n_seasons-1 DO BEGIN
    ...
    thcent_reanalysis_precip=REFORM(OPEN_AND_EXTRACT(thcent_reanalysis_infile,'PRATE',$
                                                     ...
                                                     count=[thcent_reanalysis_nlon,thcent_reanalysis_nlat,era40_reanalysis_nyears]))
  ...
  FOR i=0,ncep_reanalysis_nlon-1 DO BEGIN
      FOR j=0,ncep_reanalysis_nlat-1 DO BEGIN
            ...
            ncep_regression_coeff_smeans(i,j)=REGRESS(nino4_index_era40,ncep_temp_rainfall_smeans,CORRELATION=ncep_temp_smeans)*STDDEV(nino4_index_era40)
            ncep_correlation_coeff_smeans(i,j)=ncep_temp_smeans
      ENDFOR
  ENDFOR

 
   psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_'+seasons(k)+'_smean_ncep_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=ncep_correlation_coeff_smeans,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Correlation of '+seasons_long(k)+'-mean precipitation between NCEP/NCAR reanalysis with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW
   
  psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_'+seasons(k)+'_smean_ncep_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=ncep_regression_coeff_smeans,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Linear Regression of '+seasons_long(k)+'-mean precipitation between NCEP/NCAR reanalysis with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  ...
  FOR i=0,era40_reanalysis_nlon-1 DO BEGIN
      FOR j=0,era40_reanalysis_nlat-1 DO BEGIN
            ...
            era40_regression_coeff_smeans(i,j)=REGRESS(nino4_index_era40,era40_temp_rainfall_smeans,CORRELATION=era40_temp_smeans)*STDDEV(nino4_index_era40)
            era40_correlation_coeff_smeans(i,j)=era40_temp_smeans
      ENDFOR
   ENDFOR

 
   psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_'+seasons(k)+'_smean_era40_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_correlation_coeff_smeans,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Correlation of '+seasons_long(k)+'-mean precipitation between ERA-40 reanalysis with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW

  psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_'+seasons(k)+'_smean_era40_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_regression_coeff_smeans,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Linear regression of '+seasons_long(k)+'-mean precipitation between ERA-40 reanalysis with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  ...
  FOR i=0,thcent_reanalysis_nlon-1 DO BEGIN
      FOR j=0,thcent_reanalysis_nlat-1 DO BEGIN
            ...
            thcent_regression_coeff_smeans(i,j)=REGRESS(nino4_index_era40,thcent_temp_rainfall_smeans,CORRELATION=thcent_temp_smeans)*STDDEV(nino4_index_era40)
            thcent_correlation_coeff_smeans(i,j)=thcent_temp_smeans
      ENDFOR
  ENDFOR

  psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_'+seasons(k)+'_smean_thcent_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_correlation_coeff_smeans,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Correlation of '+seasons_long(k)+'-mean precipitation between 20th Century reanalysis with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW

  psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_'+seasons(k)+'_smean_thcent_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_regression_coeff_smeans,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Linear Regression of '+seasons_long(k)+'-mean precipitation between 20th Century reanalysis with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  ...
  FOR i=0,silo_t62_nlon-1 DO BEGIN
      FOR j=0,silo_t62_nlat-1 DO BEGIN
            ...
            silo_regression_coeff_smeans(i,j)=REGRESS(nino4_index_era40,silo_temp_rainfall_smeans,CORRELATION=silo_temp_smeans)*STDDEV(nino4_index_era40)
            silo_correlation_coeff_smeans(i,j)=silo_temp_smeans
      ENDFOR
  ENDFOR

  psfile='/home/sw007254/idl/nino4_reanalysis_corr_precip_'+seasons(k)+'_smean_silo_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=silo_correlation_coeff_smeans,X=silo_t62_longitude,Y=silo_t62_latitude,$ 
       TITLE='- Correlation of '+seasons_long(k)+'-mean precipitation between SILO observations with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW

  psfile='/home/sw007254/idl/nino4_reanalysis_regress_precip_'+seasons(k)+'_smean_silo_common.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=silo_regression_coeff_smeans,X=silo_t62_longitude,Y=silo_t62_latitude,$ 
       TITLE='- Linear Regression of '+seasons_long(k)+'-mean precipitation between SILO observations with NINO4 Index (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (mm/day/!Eo!NC)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
