PRO all_reanalysis_teleconn_analysis_blocking_140E
...
mask=REFORM(OPEN_AND_EXTRACT(mask_t62_infile,'lsmask',$
   ...
   block_infile_ncep_amean='/home/ss901165/datasets_mango/20THC_REANALYSIS/zonal_wind/20thc_reanalysis.may-apr_ameans.1891-2007.bom_blocking_index.lon140E.nc'
   block_index_ncep_amean=REFORM(OPEN_AND_EXTRACT(block_infile_ncep_amean,'blocking_index',$
                                                  offset=[57],$
                                                  count=[60]))
   
   block_index_era40_amean=REFORM(OPEN_AND_EXTRACT(block_infile_ncep_amean,'blocking_index',$
                                                   offset=[67],$
                                                   count=[44]))
  
   block_index_thcent_amean=REFORM(OPEN_AND_EXTRACT(block_infile_ncep_amean,'blocking_index',$
                                                    offset=[0],$
                                                    count=[116]))
  ...
  FOR i=0,ncep_reanalysis_nlon-1 DO BEGIN
      FOR j=0,ncep_reanalysis_nlat-1 DO BEGIN
            ...
            ncep_regression_coeff(i,j)=REGRESS(block_index_ncep_amean,ncep_temp_rainfall,CORRELATION=ncep_temp)*STDDEV(block_index_ncep_amean)
            ncep_correlation_coeff(i,j)=ncep_temp
      ENDFOR
   ENDFOR

 
   psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_corr_precip_amean_ncep.1948-2007.ps'
   ...
   CON,FIELD=ncep_correlation_coeff,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Correlation of annual-mean daily rainfall rate between NCEP/NCAR reanalysis and Blocking Index -140E (1948-2007)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE

 
   psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_regress_precip_amean_ncep.1948-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=ncep_regression_coeff,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rate between NCEP/NCAR reanalysis and Blocking Index- 140E (1948-2007)',/NOLINES,$
       CB_TITLE='Regression Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
   PFILL,FIELD=ncep_correlation_coeff,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,MIN=0.25,MAX=1.5
   PFILL,FIELD=ncep_correlation_coeff,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,MIN=-1.5,MAX=-0.25
  PSCLOSE
  ...
  FOR i=0,era40_reanalysis_nlon-1 DO BEGIN
      FOR j=0,era40_reanalysis_nlat-1 DO BEGIN
            ...
            era40_regression_coeff(i,j)=REGRESS(block_index_era40_amean,era40_temp_rainfall,CORRELATION=era40_temp)
            era40_correlation_coeff(i,j)=era40_temp
      ENDFOR
   ENDFOR

 
   psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_corr_precip_amean_era40.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_correlation_coeff,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Correlation of annual-mean daily rainfall rate between ERA-40 reanalysis and Blocking Index -140E (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE

 psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_regress_precip_amean_era40.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_regression_coeff,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rate between ERA-40 reanalysis and Blocking Index-140E (1958-2001)',/NOLINES,$
       CB_TITLE='Regressionn Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
   PFILL,FIELD=era40_regression_coeff,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,MIN=0.30,MAX=1.5
   PFILL,FIELD=era40_regression_coeff,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,MIN=-1.5,MAX=-0.30
  PSCLOSE
   ...
   FOR i=0,thcent_reanalysis_nlon-1 DO BEGIN
     FOR j=0,thcent_reanalysis_nlat-1 DO BEGIN
            ...
            thcent_regression_coeff(i,j)=REGRESS(block_index_thcent_amean,thcent_temp_rainfall,CORRELATION=thcent_temp)
            thcent_correlation_coeff(i,j)=thcent_temp
      ENDFOR
   ENDFOR

  psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_corr_precip_amean_thcent.1891-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
  MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
  LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_correlation_coeff,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Correlation of annual-mean daily rainfall rate between 20th Century reanalysis and Blocking Index -140E (1891-2007)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE  

  psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_regress_precip_amean_thcent.1891-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
  MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
  LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_regression_coeff,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Linear Regression of annual-mean daily rainfall rate between 20th Century reanalysis and Blocking Index -140E (1891-2007)',/NOLINES,$
       CB_TITLE='Regression Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
...
FOR k=0,n_seasons-1 DO BEGIN
   ...
   ncep_reanalysis_precip=REFORM(OPEN_AND_EXTRACT(ncep_reanalysis_infile,'prate',$
                                                  offset=[ncep_reanalysis_box_tx(1),ncep_reanalysis_box_tx(0),0],$
                                                  count=[ncep_reanalysis_nlon,ncep_reanalysis_nlat,ncep_reanalysis_nyears-1]))
   ...
   thcent_reanalysis_precip=REFORM(OPEN_AND_EXTRACT(thcent_reanalysis_infile,'PRATE',$
                                             offset=[thcent_reanalysis_box_tx(1),thcent_reanalysis_box_tx(0),0],$
                                             count=[thcent_reanalysis_nlon,thcent_reanalysis_nlat,107]))
   thcent_reanalysis_precip=thcent_reanalysis_precip*86400.
   thcent_reanalysis_precip[where(mask_twentyc eq 0)]=!Values.F_NaN


   block_infile_ncep='/home/ss901165/datasets_mango/20THC_REANALYSIS/zonal_wind/20thc_reanalysis.'+seasons(k)+'_smeans.1891-2007.bom_blocking_index.lon140E.nc'
   block_index_ncep=REFORM(OPEN_AND_EXTRACT(block_infile_ncep,'blocking_index',$
                                             offset=[57],$
                                             count=[59]))
   
   block_index_era40=REFORM(OPEN_AND_EXTRACT(block_infile_ncep,'blocking_index',$
                                             offset=[67],$
                                             count=[44]))

   block_index_thcent=REFORM(OPEN_AND_EXTRACT(block_infile_ncep,'blocking_index',$
                                             offset=[9],$
                                             count=[107]))
  ...
  FOR i=0,ncep_reanalysis_nlon-1 DO BEGIN
      FOR j=0,ncep_reanalysis_nlat-1 DO BEGIN
            ...
            ncep_regression_coeff_smeans(i,j)=REGRESS(block_index_ncep,ncep_temp_rainfall_smeans,CORRELATION=ncep_temp_smeans)
            ncep_correlation_coeff_smeans(i,j)=ncep_temp_smeans
      ENDFOR
   ENDFOR

 
   psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_corr_precip_'+seasons(k)+'_smean_ncep.1948-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=ncep_correlation_coeff_smeans,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Correlation of'+seasons_long(k)+'-mean precipitation between NCEP/NCAR reanalysis with Blocking Index -140E (1948-2007)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW

  psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_regress_precip_'+seasons(k)+'_smean_ncep.1948-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=ncep_regression_coeff_smeans,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,$ 
       TITLE='- Linear Regression of'+seasons_long(k)+'-mean precipitation between NCEP/NCAR reanalysis with Blocking Index -140E (1948-2007)',/NOLINES,$
       CB_TITLE='Regression Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
   PFILL,FIELD=ncep_regression_coeff_smeans,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,MIN=0.25,MAX=1.0
   PFILL,FIELD=ncep_regression_coeff_smeans,X=ncep_reanalysis_longitude,Y=ncep_reanalysis_latitude,MIN=-1.0,MAX=-0.25
  PSCLOSE,/NOVIEW
  ...
  FOR i=0,era40_reanalysis_nlon-1 DO BEGIN
      FOR j=0,era40_reanalysis_nlat-1 DO BEGIN
            ...
            era40_regression_coeff_smeans(i,j)=REGRESS(block_index_era40,era40_temp_rainfall_smeans,CORRELATION=era40_temp_smeans)
            era40_correlation_coeff_smeans(i,j)=era40_temp_smeans
      ENDFOR
   ENDFOR

 
   psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_corr_precip_'+seasons(k)+'_smean_era40.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_correlation_coeff_smeans,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Correlation of '+seasons_long(k)+'-mean precipitation between ERA-40 reanalysis with Blocking Index -140E (1958-2001)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW

   psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_regress_precip_'+seasons(k)+'_smean_era40.1958-2001.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
   MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
   LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=era40_regression_coeff_smeans,X=era40_reanalysis_longitude,Y=era40_reanalysis_latitude,$ 
       TITLE='- Linear Regression of '+seasons_long(k)+'-mean precipitation between ERA-40 reanalysis with Blocking Index -140E (1958-2001)',/NOLINES,$
       CB_TITLE='Regression Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
...
FOR i=0,thcent_reanalysis_nlon-1 DO BEGIN
     FOR j=0,thcent_reanalysis_nlat-1 DO BEGIN
            ...
            thcent_regression_coeff_smeans(i,j)=REGRESS(block_index_thcent,thcent_temp_rainfall_smeans,CORRELATION=thcent_temp_smeans)
            thcent_correlation_coeff_smeans(i,j)=thcent_temp_smeans
      ENDFOR
   ENDFOR

  psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_corr_precip_'+seasons(k)+'_smean_thcent.1891-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
  MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
  LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_correlation_coeff_smeans,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Correlation of '+seasons_long(k)+'-mean daily rainfall rate between 20th Century reanalysis and Blocking Index -140E (1891-2007)',/NOLINES,$
       CB_TITLE='Correlation Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
  PSCLOSE,/NOVIEW  

  psfile='/home/ss901165/idl/queensland/blocking_140E_reanalysis_regress_precip_'+seasons(k)+'_smean_thcent.1891-2007.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=120,MARGIN=1500,SPACE2=1000,XOFFSET=200,YOFFSET=4000,TFONT=2,TCHARSIZE=100,CB_WIDTH=100,XSIZE=18000
   CS,SCALE=21,NCOLS=N_ELEMENTS(mylevs_corr)+1,WHITE=[11]
  MAP,LONMIN=box_plot(1),LONMAX=box_plot(3),LATMIN=box_plot(0),LATMAX=box_plot(2)
  LEVS,MANUAL=mylevs_corr,NDECS=2
   CON,FIELD=thcent_regression_coeff_smeans,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,$ 
       TITLE='- Linear Regression of '+seasons_long(k)+'-mean daily rainfall rate between 20th Century reanalysis and Blocking Index -140E (1891-2007)',/NOLINES,$
       CB_TITLE='Regression Coefficient (unitless)',/BLOCK
   AXES,XSTEP=10,YSTEP=5
   PFILL,FIELD=thcent_regression_coeff_smeans,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,MIN=0.195,MAX=1.0
   PFILL,FIELD=thcent_regression_coeff_smeans,X=thcent_reanalysis_longitude,Y=thcent_reanalysis_latitude,MIN=-1.0,MAX=-0.195
  PSCLOSE,/NOVIEW  
