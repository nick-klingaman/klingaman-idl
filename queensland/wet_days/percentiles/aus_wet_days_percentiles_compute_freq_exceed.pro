PRO aus_wet_days_percentiles_compute_freq_exceed
...
input_dir='/home/ss901165/datasets_mango/NCEP_REANALYSIS/precipitation'
...
FOR i=0,n_output_periods-1 DO BEGIN
   ...
   outfile=input_dir+'/ncep-ncar_reanalysis.'+period_name+'_'+period_type+'s.1958-2000.precip_freq_exceed.t62_gauss.nc'
