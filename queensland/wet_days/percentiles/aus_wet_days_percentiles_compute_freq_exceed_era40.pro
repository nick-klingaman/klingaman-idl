PRO aus_wet_days_percentiles_compute_freq_exceed_era40
...
input_dir='/home/ss901165/datasets/ERA40/PRECIP'
percentiles_input_file=input_dir+'/era40.mar-feb_dmeans.1958-2001.precip_percentiles.aus_domain.nc'
...
FOR i=0,n_output_periods-1 DO BEGIN
   ...
   outfile=input_dir+'/era40.'+period_name+'_'+period_type+'s.1958-2000.precip_freq_exceed.aus_domain.nc'
