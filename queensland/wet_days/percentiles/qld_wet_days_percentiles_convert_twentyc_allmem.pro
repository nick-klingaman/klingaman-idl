PRO qld_wet_days_percentiles_convert_twentyc_allmem
...
print,'Converting ensemble member '+STRTRIM(STRING(m+1),1)+' ...'

twentyc_infile='/home/ss901165/datasets_mango/20THC_REANALYSIS/every_member/precip/20thc_reanalysis_member'+$
               STRTRIM(STRING(m+1),1)+'.mar-feb_dmeans.1958-2001.precip.nc.rearrange'
mask_infile='/home/ss901165/datasets_mango/20THC_REANALYSIS/mask_t62_revlat.nc'
twentyc_nyears=44
...
outfile='/home/ss901165/datasets_mango/20THC_REANALYSIS/every_member/precip/20thc_reanalysis_member'+$
        STRTRIM(STRING(m+1),1)+'.mar-feb_dmeans.1958-2001.precip_percentiles.aus_domain.nc'
dimids=intarr(5)
varids=intarr(8)
