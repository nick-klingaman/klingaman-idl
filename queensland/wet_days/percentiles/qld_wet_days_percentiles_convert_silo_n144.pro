PRO qld_wet_days_percentiles_convert_silo_n144
...
silo_infile='/home/ss901165/datasets/SILO/n144/SILO.may-apr_dmeans.1900-2010.precip.n144.nc.rearrange'
...
outfile='/home/ss901165/datasets/SILO/n144/SILO.may-apr_dmeans.1900-2010.precip_percentiles.n144.nc'
dimids=intarr(5)
varids=intarr(8)
...
;                                            count=[1,1,silo_ndays_per_year,silo_nyears]),[total_days])
      ...
      print,mask_revlat(i,j),thispt_precip(0,0)
