PRO uk_cold_winters_20cr_ensmem_spread_cet
  
; Give the file containing the 20th Century Reanalysis every-member data
twentyc_nao_file='/home/ss901165/datasets/20THC_REANALYSIS/temp_2m/20thc_reanalysis.dec-feb_smeans.1871-2007.ctl_eng_temp.twod.nc'
; Give the file containing the observed NAO index
obs_nao_file='/home/ss901165/datasets/CTL_ENG_TEMP/ctl_eng_temp.dec-feb_smeans.1659-2009.twod.nc'
; Number of ensemble members in 20CR
twentyc_nmembers=56
; Start year and total number of years
my_start_year=1871
twentyc_nao_start_year=1871
obs_nao_start_year=1659
n_years=137

; Read observed NAO index
twentyc_nao=OPEN_AND_EXTRACT(twentyc_nao_file,'ctl_eng_temp',offset=[0,(my_start_year-twentyc_nao_start_year)],$
                           count=[twentyc_nmembers,n_years])

; Read 20CR NAO index
obs_nao=OPEN_AND_EXTRACT(obs_nao_file,'ctl_eng_temp',offset=[my_start_year-obs_nao_start_year],$
                           count=[n_years])
...
max_bin=2.5    ; Value of the maximum bin in hPa (units of NAO index)
min_bin=-4.5   ; Value of the minimum bin in hPa (units of NAO index)
n_bins=31      ; Number of bins between the maximum and minimum
