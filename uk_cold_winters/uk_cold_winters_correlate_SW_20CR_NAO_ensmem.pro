PRO uk_cold_winters_correlate_SW_20CR_NAO_ensmem
...
twentyc_nao_file='/home/ss901165/datasets/20THC_REANALYSIS/mslp/20thc_reanalysis_allmembers.jan-dec_mmeans.1871-2008.nao_index.twod.nc'
...
SW_index=OPEN_AND_EXTRACT(SW_index_file,'swwind_index',offset=[0,(my_start_year-SW_index_start_year),0],$
                         count=[56,n_years,12])
twentyc_cet=OPEN_AND_EXTRACT(twentyc_nao_file,'nao_index',offset=[0,(my_start_year-twentyc_start_year),0],$
                             count=[56,n_years,12])
...
; Give the name for the PostScript format output file
psfile='/home/ss901165/idl/uk_cold_winters/uk_cold_winters_correlate_SW_20CR_NAO_ensmem_monthly.ps'
...
; Give the name for the PostScript format output file
psfile='/home/ss901165/idl/uk_cold_winters/uk_cold_winters_correlate_SW_20CR_NAO_ensmem_djf.ps'
