PRO kpp_scm_plot_fluxes_T_hmix_swapflux

basedir='/export/mango/data-10/ss901165/kpp_ocean/runs/flxcorr_hadgem3_1.5xentrain_n96_1mtop_3hr_ukmo_sal60_amip_vn78_scm_swapflux'
...
FOR i=0,n_runs-1 DO BEGIN
   flux_infile='/export/mango/data-10/ss901165/kpp_ocean/ancillaries/flux_data/xgspj.fluxes_for_kpp.jan-dec_dmeans.'+years(i)+'.3hr_n96_tgrid.swap_0N60E_2.5S60E.nc'
   FOR j=0,n_pts-1 DO BEGIN
      ...
      psfile='/home/ss901165/idl/kpp_forced/scm_tests/kpp_scm_plot_fluxes_T_hmix_swapflux.T_hmix.'+kpp_pt+'.'+runs(i)+'.'+kpp_time+'.nc'
      ...
      CON,X=kpp_t,Y=kpp_z,FIELD=kpp_temp_tz,$
          TITLE='Fluxes, temperatures and hmix for '+runs(i)+' at pt '+kpp_pt+' with swapped fluxes',/NOLINES
      ...
      psfile='/home/ss901165/idl/kpp_forced/scm_tests/kpp_scm_plot_fluxes_T_hmix_swapflux.T_diff_init.'+kpp_pt+'.'+runs(i)+'.'+kpp_time+'.nc'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=800,XOFFSET=1000,YOFFSET=500,TFONT=2,TCHARSIZE=100,SPACE3=500
      ...
      CON,X=kpp_t,Y=kpp_z,FIELD=kpp_temp_tz_diffinit,$
          TITLE='Difference in temperature from initial conditions for '+runs(i)+' at pt '+kpp_pt+' with swapped fluxes',/NOLINES
      GPLOT,X=kpp_t,Y=-1.*(kpp_hmix)
      AXES,XTITLE='Time in KPP integration (days, 15 = start)',YTITLE='Depth',XSTEP=1,XMINOR=0.125,YSTEP=10,YMINOR=5
      PSCLOSE

      psfile='/home/ss901165/idl/kpp_forced/scm_tests/kpp_scm_plot_fluxes_T_hmix_swapflux.Tinc.'+kpp_pt+'.'+runs(i)+'.'+kpp_time+'.nc'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=800,XOFFSET=1000,YOFFSET=500,TFONT=2,TCHARSIZE=100,SPACE3=500
      ...
      CON,X=kpp_t,Y=kpp_z,FIELD=kpp_temp_tz_inc,$
          TITLE='Temperature increment for '+runs(i)+' at pt '+kpp_pt+' with swapped fluxes',/NOLINES,CB_TITLE='degrees C per timestep (1 hour)',$
          CB_WIDTH=115
      GPLOT,X=kpp_t,Y=-1.*(kpp_hmix)
      AXES,XTITLE='Time in KPP integration (days, 15 = start)',YTITLE='Depth',XSTEP=1,XMINOR=0.125,YSTEP=10,YMINOR=5
      PSCLOSE,/NOVIEW

      psfile='/home/ss901165/idl/kpp_forced/scm_tests/kpp_scm_plot_fluxes_T_hmix_swapflux.fluxes.'+kpp_pt+'.'+runs(i)+'.'+kpp_time+'.nc'
