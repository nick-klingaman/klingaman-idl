PRO mjo_coupling_plot_phase_relationship
...
psfile='/home/ss901165/idl/mjo_coupling/mjo_coupling_plot_phase_relationship.obs_olr_sst_IndOcn.ps'
...
GSET,XMIN=MIN(lags),XMAX=MAX(lags),YMIN=-0.5,YMAX=0.5,TITLE='Lead-lag correlation between SST and OLR in the Indian Ocean from observations (1998-2009)'
