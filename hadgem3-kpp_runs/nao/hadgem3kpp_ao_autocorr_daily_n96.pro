PRO hadgem3kpp_ao_autocorr_daily_n96
...
FOR m=0,nmodels-1 DO BEGIN
   CASE m OF
      0 : BEGIN
         ao_file='/home/ss901165/um_output6/xihvi/hadgem3kpp_fwgbl_1.0xentrain_ga30_n96.jan-dec_dmeans_ts.years1-75.ao_index_goml.nc'
         ntime=19*360         
         offset=25*360
         nsets=3
         all_names(m)='goml1_n96_jan-dec_owneof'
         all_descs(m)='GOML1 N96 Jan-Dec'
         all_colors(m)='purple'
         all_symbols(m)=3
         all_styles(m)=0
         days=[0,360]
      ...
      1 : BEGIN
         ...
         ntime=19*360
         offset=25*360
         all_names(m)='goml1_n96_dec-feb_owneof'
         all_descs(m)='GOML1 N96 Dec-Feb'
         all_colors(m)='purple'
         all_symbols(m)=3
         all_styles(m)=0
         days=[330,420]
      ...
      2 : BEGIN
         ...
         ntime=19*360
         offset=25*360
         all_names(m)='goml1_n96_jun-aug_owneof'
         all_descs(m)='GOML1 N96 Jun-Aug'
         all_colors(m)='purple'
         all_symbols(m)=3
         all_styles(m)=0
         days=[150,240]
      ...
      END 
      3 : BEGIN
         ao_file='/home/ss901165/um_output6/xihvi/hadgem3a_kppfwgbl31day_1.0xentrain_ga30_n96.jan-dec_mmeans_ts.years1-75.ao_index_ga3-31d.nc'                        
         ntime=19*360
         offset=25*360
         all_names(m)='ga3-31d_n96_jan-dec_owneof'
         all_descs(m)='GA3-31d N96 Jan-Dec'
         all_colors(m)='red'
         all_symbols(m)=3
         all_styles(m)=0
         days=[0,360]
      ...
      4 : BEGIN
         ...
         ntime=19*360
         offset=25*360
         all_names(m)='ga3-31d_n96_dec-feb_owneof'
         all_descs(m)='GA3-31d N96 Dec-Feb'
         all_colors(m)='red'
         all_symbols(m)=3
         all_styles(m)=0
         days=[330,420]
      ...
      5 : BEGIN
         ...
         ntime=19*360
         offset=25*360
         all_names(m)='ga3-31d_n96_jun-aug_owneof'
         all_descs(m)='GA3-31d N96 Jun-Aug'
         all_colors(m)='red'
         all_symbols(m)=3
         all_styles(m)=0
         days=[150,240]
      ...
      END
      6 : BEGIN
         ao_file='/home/ss901165/um_output6/xihvi/hadgem3a_kppfwgblclim_1.0xentrain_ga30_n96.jan-dec_mmeans_ts.years1-75.ao_index_ga3clim.nc'                        
         ntime=19*360
         offset=25*360
         all_names(m)='ga3-clim_n96_jan-dec_owneof'
         all_descs(m)='GA3-clim N96 Jan-Dec'
         all_colors(m)='blue'
         all_symbols(m)=3
         all_styles(m)=0
         days=[0,360]
      ...
      7 : BEGIN
         ...
         ntime=19*360
         offset=25*360
         all_names(m)='ga3-clim_n96_dec-feb_owneof'
         all_descs(m)='GA3-clim N96 Dec-Feb'
         all_colors(m)='blue'
         all_symbols(m)=3
         all_styles(m)=0
         days=[330,420]
      ...
      8 : BEGIN
         ...
         ntime=19*360
         offset=25*360
         all_names(m)='ga3-clim_n96_jun-aug_owneof'
         all_descs(m)='GA3-clim N96 Jun-Aug'
         all_colors(m)='blue'
         all_symbols(m)=3
         all_styles(m)=0
         days=[150,240]
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.'+all_names(m)+'.ps'
...
nlevs_corr=N_ELEMENTS(mylevs_corr)
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.jan-dec_owneof_allefold.ps'
...
; All models for Jan-Dec
nlevs_corr=N_ELEMENTS(mylevs_corr)
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.jan-dec_owneof_allplev.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=2000,SPACE2=2000,SPACE3=200
GSET,XMIN=0,XMAX=MAX(lags),YMIN=0,YMAX=nlev_save
FOR m=0,nmodels-1,3 DO BEGIN
...
nlevs_corr=N_ELEMENTS(mylevs_corr)
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.dec-feb_owneof_allefold.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=2000,SPACE2=2000,SPACE3=200
GSET,XMIN=0,XMAX=MAX(lags),YMIN=0,YMAX=nlev_save
...
; All models for Dec-Feb
nlevs_corr=N_ELEMENTS(mylevs_corr)
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.dec-feb_owneof_allplev.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=2000,SPACE2=2000,SPACE3=200
GSET,XMIN=0,XMAX=MAX(lags),YMIN=0,YMAX=nlev_save
FOR m=1,nmodels-1,3 DO BEGIN
   ;toplot=REFORM(efold(m,0:nlev-1))
...
nlevs_corr=N_ELEMENTS(mylevs_corr)
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.jun-aug_owneof_allefold.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=2000,SPACE2=2000,SPACE3=200
GSET,XMIN=0,XMAX=MAX(lags),YMIN=0,YMAX=nlev_save
...
; All models for Jun-Feb
nlevs_corr=N_ELEMENTS(mylevs_corr)
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_ao_autocorr_daily_n96.jun-aug_owneof_allplev.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=2000,SPACE2=2000,SPACE3=200
GSET,XMIN=0,XMAX=MAX(lags),YMIN=0,YMAX=nlev_save
FOR m=2,nmodels-1,3 DO BEGIN
   ;toplot=REFORM(efold(m,0:nlev-1))
