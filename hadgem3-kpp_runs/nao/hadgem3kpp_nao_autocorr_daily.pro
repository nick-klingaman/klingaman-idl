...
FOR m=0,nmodels-1 DO BEGIN
   CASE m OF
      ...
      END
      12 : BEGIN
         nao_file='/home/ss901165/datasets/20THC_REANALYSIS/mslp/20thc_reanalysis.jan-dec_dmeans_ts.1871-2010.nao_index_20CR.nc'
         ntime=LONG(140)*LONG(365)
         offset=0
         all_names(m)='20CR, Jan-Dec'
   ...
   FOR i=0,nlags-1 DO BEGIN
      ...
      FOR j=0,my_nyears-1 DO BEGIN
         central(LONG(j)*LONG(this_ndpy):LONG((j+1))*LONG(this_ndpy)-LONG(1))=nao_index_allyears(LONG(j)*LONG(ndpy):LONG(j)*LONG(ndpy)+LONG(this_ndpy)-1)
         lagged(LONG(j)*LONG(this_ndpy):LONG((j+1))*LONG(this_ndpy)-LONG(1))=nao_index_allyears(LONG(j)*LONG(ndpy)+LONG(lags(i)):LONG((j+1))*LONG(ndpy)-1)         
      ...
      FOR j=0,my_nyears-1 DO BEGIN
         this_central=central(LONG(j)*LONG(this_ndpy):LONG((j+1))*LONG(this_ndpy)-1)
         this_lagged=lagged(LONG(j)*LONG(this_ndpy):LONG((j+1))*LONG(this_ndpy)-1)
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_owneof.ps'
...
; Just Jan-Dec
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_owneof_all.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=500,SPACE2=100,SPACE3=200
...
; Just DJF
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_owneof_djf.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=500,SPACE2=100,SPACE3=200
...
; Just JJA
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_owneof_jja.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=500,SPACE2=100,SPACE3=200
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_owneof_djf_decorr.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=500,SPACE2=100,SPACE3=200
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_owneof_jja_decorr.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=16000,XOFFSET=1500,YOFFSET=500,SPACE2=100,SPACE3=200
GSET,XMIN=0,XMAX=ndecorr_bins+1,YMIN=0,YMAX=0.85 ;,TITLE='Auto-correlation of DJF daily NAO indices'
...
FOR m=0,nmodels-1 DO BEGIN
   CASE m OF
      0 : BEGIN
         nao_file='/home/ss901165/um_output6/xjhwb/hadgem3kpp_nrglobal_n216.jan-dec_dmeans_ts.years1-66.nao_index_eraint.nc'
         ntime=66*360
         offset=0
         all_names(m)='GOML1, Jan-Dec'
         all_colors(m)='purple'         
      ...
      END
      3 : BEGIN
         nao_file='/home/ss901165/um_output6/xjhwe/hadgem3a_kppnrglobalsmooth31_n216.jan-dec_dmeans_ts.years1-66.nao_index_eraint.nc'
         ntime=66*360
         offset=0
         all_names(m)='GA3-31d, Jan-Dec'
         all_colors(m)='red'
      ...
      END
      6 : BEGIN
         nao_file='/home/ss901165/um_output6/xjhwh/hadgem3a_nrglobal_n216.jan-dec_dmeans_ts.years1-66.nao_index_eraint.nc'
         ntime=66*360
         offset=0
         all_names(m)='GA3-clim, Jan-Dec'
         all_colors(m)='blue'
...
;         allyears_autocorr(m,j,i)=CORRELATE(central(j*this_ndpy:(j+1)*this_ndpy-1),lagged(j*this_ndpy:(j+1)*this_ndpy-1))
      ...
      FOR j=0,my_nyears-1 DO BEGIN
         ...
         allyears_autocorr(m,j,i)=TOTAL((this_central-allyears_mean)*(this_lagged-allyears_mean))/(allyears_var)/FLOAT(this_ndpy)
      ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_eraeof.ps'
...
FOR m=0,nmodels-1 DO BEGIN
   CASE m OF
      0 : BEGIN
         nao_file='/home/ss901165/um_output6/xjhwb/hadgem3kpp_nrglobal_n216.jan-dec_dmeans_ts.years1-66.nao_index_goml.nc'
         ntime=66*360
         offset=0
         all_names(m)='GOML1, Jan-Dec'
         all_colors(m)='purple'         
      ...
      END
      3 : BEGIN
         nao_file='/home/ss901165/um_output6/xjhwe/hadgem3a_kppnrglobalsmooth31_n216.jan-dec_dmeans_ts.years1-66.nao_index_goml.nc'
         ntime=66*360
         offset=0
         all_names(m)='GA3-31d, Jan-Dec'
         all_colors(m)='red'
      ...
      END
      6 : BEGIN
         nao_file='/home/ss901165/um_output6/xjhwh/hadgem3a_nrglobal_n216.jan-dec_dmeans_ts.years1-66.nao_index_goml.nc'
         ntime=66*360
         offset=0
         all_names(m)='GA3-clim, Jan-Dec'
         all_colors(m)='blue'
      ...
      END
      9 : BEGIN
         nao_file='/home/ss901165/datasets/ERA-INTERIM/MSL/ERA-Interim.jan-dec_dmeans_ts.1979-2013.nao_index_goml_n216.nc'
         ntime=35*365
         offset=0
         all_names(m)='ERA-Int, Jan-Dec'
         all_colors(m)='black'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/nao/hadgem3kpp_nao_autocorr_daily.metum_goml1_n216_gomleof.ps'
PSOPEN,file=psfile,FONT=6,TFONT=6,CHARSIZE=140,MARGIN=2000,XSIZE=16000,YSIZE=17000,XOFFSET=1500,YOFFSET=500
GSET,XMIN=0,XMAX=MAX(lags),YMIN=-0.2,YMAX=1
FOR m=0,nmodels-1 DO $
   GPLOT,X=findgen(nlags),Y=REFORM(autocorr(m,*)),SYM=all_symbols(m),COL=FSC_COLOR(all_colors(m)),STYLE=all_styles(m),SIZE=65
