PRO hadgem3kpp_ssts_make_smoothed_ts_fw_xmlok

; Make a smoothed timeseries of SST
; Need to combine KPP and obs SST using coupling weight file

;kpp_sst_file='/group_workspaces/jasmin2/bobble/metum/climate_n216/xmlok/kpp_ocean/sst.nc'
kpp_sst_file='/group_workspaces/jasmin2/bobble/metum/climate_n216/xmlok/xmlok.jan-dec_dmean_clim.years1-28.sst.nc'
obs_sst_file='/home/users/npklingaman/datasets/METO_OCEAN_ANALYSIS/n216e/meto_ocean_analysis.jan-dec_dmean-interp-mmean_amip_clim.1980-2009.sst.n216e.nc'
cplwght_file='/home/users/npklingaman/datasets/HADGEM3-KPP_ANCIL/cplwght_for_kpp.n216e.12ptblend.nrglobal.nc'
mask_file='/home/users/npklingaman/datasets/HADGEM3-KPP_ANCIL/landfrac_n216e_hadgem3-8.5.nc'
;obs_ice_file='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/sice_amip2_5108_n216_v7.0.jan-dec_dmeans_clim.nc'
obs_ice_file='/home/users/npklingaman/datasets/HADGEM3-KPP_ANCIL/sice_amip2/reynolds_amip2_v1p0.jan-dec_dmeans_clim.1981-2012.seaice.n216e.nc'

smooth_length=31
out_sst_file='/group_workspaces/jasmin2/bobble/metum/climate_n216/xmlok/smoothed_sst_xmlok_31day_clim.nc'
...
count=360
; Get SSTs
kpp_sst=OPEN_AND_EXTRACT(kpp_sst_file,'sst',offset=[0,0,start],count=[kpp_nlon,kpp_nlat,count])
...
FOR i=0,n_lon-1 DO BEGIN
   ...
   FOR j=0,n_lat-1 DO BEGIN
      ...
      ENDIF ELSE $
         sst_out(i,j,*)=2e20
      temp = [REFORM(sst_out(i,j,*)),REFORM(sst_out(i,j,*)),REFORM(sst_out(i,j,*))]
      temp = SMOOTH(temp,smooth_length)
      sst_out(i,j,*) = temp[count:count*2-1]
