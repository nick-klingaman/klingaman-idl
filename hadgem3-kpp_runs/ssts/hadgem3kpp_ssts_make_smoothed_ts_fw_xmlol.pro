PRO hadgem3kpp_ssts_make_smoothed_ts_fw_xmlol

; Make a smoothed timeseries of SST
; Need to combine KPP and obs SST using coupling weight file

;kpp_sst_file='/group_workspaces/jasmin2/bobble/metum/climate_n96/xmlol/kpp_ocean/sst.nc'
kpp_sst_file='/group_workspaces/jasmin2/bobble/metum/climate_n96/xmlol/xmlol.jan-dec_dmean_clim.years1-29.sst.nc'
...
cplwght_file='/home/users/npklingaman/datasets/HADGEM3-KPP_ANCIL/cplwght_for_kpp.n96e.5ptblend.nrglobal.nc'
...
smooth_length=31
out_sst_file='/group_workspaces/jasmin2/bobble/metum/climate_n96/xmlol/smoothed_sst_xmlol_31day_clim.nc'
