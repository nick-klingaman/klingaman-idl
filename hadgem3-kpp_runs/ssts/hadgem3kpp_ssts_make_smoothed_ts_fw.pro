...
kpp_sst_file='/home/ss901165/um_output6/xjhwd/xjhwm_sst.nc'
obs_sst_file='/home/ss901165/datasets/METO_OCEAN_ANALYSIS/n216/meto_ocean_analysis.jan-dec_dmean-interp-mmean_clim.1980-2009.sst.n216.nc'
cplwght_file='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/kpp_cplwght_n216.12ptblend.nrglobal.nc'
mask_file='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/landfrac_n216_hadgem3-7.8.nc'
;obs_ice_file='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/sice_amip2_5108_n216_v7.0.jan-dec_dmeans_clim.nc'
obs_ice_file='/home/ss901165/um_output6/xjhwb/clim_ice_n216_iceconc.nc'

smooth_length=31
out_sst_file='/home/ss901165/um_output6/xjhwd/smoothed_sst_xjhwm_long_31day.nc'
...
FOR i=0,n_lon-1 DO BEGIN
   FOR j=0,n_lat-1 DO BEGIN
      IF landfrac(i,j) ne 1 THEN BEGIN
         ...
         ENDIF ELSE BEGIN
            FOR k=0,n_time/360-1 DO $
               sst_out(i,j,k*360:(k+1)*360-1)=kpp_sst(i,j-kpp_latoff,k*360:(k+1)*360-1)*cplwght(i,j)+$
               obs_sst(i,j,*)*(1.-cplwght(i,j))
            IF n_time MOD 360 ne 0 THEN $
               sst_out(i,j,n_time/360*360:n_time-1)=kpp_sst(i,j-kpp_latoff,n_time/360*360:n_time-1)$
