PRO hadgem3kpp_fcorr_calculate_expostfacto_perfectfluxes_ctl_ga30cpl_sal60_amip_vn78_smooth_12421_ind,runid,month1,month2
...
noflx_coupled_indir='/home/ss901165/kpp_ocean3/flxcorr_hadgem3_1.0xentrain_n96_1mtop_3hr_ga30cpl_sal60_amip_vn78_smooth_12421_ind/'+runid
...
foam_infile='/net/10.100.0.5/mango/data-02/ss901165/HADGEM3-KPP_ANCIL/ga30_coupled_TandS/hadgem3ao_ajtzr_ga30.'+STRMID(month1,0,3)+'15-'+$
            STRMID(month2,0,3)+'15_mmean-amip_clim.pot_temp.n96.nc'
...
landfrac_infile='/net/10.100.0.5/mango/data-02/ss901165/HADGEM3-KPP_ANCIL/landfrac_n96_hadgem3-7.3.nc'

; Ocean depth file
ocndepth_infile='/net/10.100.0.5/mango/data-02/ss901165/HADGEM3-KPP_ANCIL/lsm_ocndepth_for_kpp.n96.coastal_tiling.nearest_neighbor.nc'
...
FOR i=0,coupled_nlon-1 DO BEGIN
    FOR j=0,coupled_nlat-1 DO BEGIN
        FOR k=0,coupled_nz-1 DO BEGIN
            IF (ABS(fcorr_kppgrid(i,j,k)) gt 100 and landfrac(i,j) lt 1) THEN BEGIN
                print,i,j,k
...
; read in by KPP.
id = NCDF_CREATE('/net/10.100.0.5/mango/data-02/ss901165/HADGEM3-KPP_ANCIL/heat_corrections/'+runid+'_flxcorr_1mtop_3hr_ga30cpl_sal60_amip_vn78_smooth_12421_ind.'+month1+'_mmean.n96.nc',/CLOBBER)
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_calculate_expostfacto_perfectfluxes_ctl_ga30cpl_sal60_amip_vn78_smooth_12421_ind.'+$
...
CON,X=coupled_longitude,Y=coupled_latitude,FIELD=REFORM(foam_temps_mmean(*,*,0)),/NOLINES,/BLOCK,$
    TITLE='15 '+month1+'--15 '+month2+' clim SSTs from GA3.0 coupled run (ajtzr) climatology'
PSCLOSE,/NOVIEW
...
CON,X=coupled_longitude,Y=coupled_latitude,FIELD=REFORM(noflx_temps_mmean_foamgrid(*,*,0))-REFORM(foam_temps_mmean(*,*,0)),/NOLINES,/BLOCK,$
    TITLE='Diff in 15 '+month1+'--15 '+month2+' SSTs for KPP (fluxes from '+runid+') minus GA3.0 coupled (ajtzr) climatology'
PSCLOSE,/NOVIEW
