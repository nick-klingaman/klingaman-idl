PRO hadgem3kpp_ocnTcorr_interpolate_analyses
...
;ocnT_infile='/home/users/npklingaman/datasets/METO_OCEAN_ANALYSIS/'+resolution+'/meto_ocean_analysis.jan-dec_dmean-interp-mmean_amip_clim.1980-2009.pot_temp.BoB_zmean.'+resolution+'.nc'
...
ocnT_infile='/home/users/npklingaman/klingaman/datasets/METO_OCEAN_ANALYSIS/'+resolution+'/meto_ocean_analysis_enso_anoms.jan-dec_dmeans-interp-mmeans_amip_3yrclim'+time_range+'.pot_temp_'+resolution+'.nc'
varname='pot_temp'
depth_varname='z_t'

; Temperature outfile on KPP vertical grid
;ocnT_outfile='/home/ss901165/datasets/HADGEM3-KPP_ANCIL/n512/meto_ocean_analysis.'+perenso+'_mmean-amip_clim.1980-2009.pot_temp.n512.kpp_1000m_100lev-2.nc'
...
;ocnT_outfile='/home/users/npklingaman/datasets/METO_OCEAN_ANALYSIS/'+resolution+'/meto_ocean_analysis.jan-dec_dmean-interp-mmean_amip_clim.1980-2009.pot_temp.BoB_zmean.'+resolution+'.kpp_1000m_100lev.nc'
...
ocnT_outfile='/home/users/npklingaman/klingaman/datasets/METO_OCEAN_ANALYSIS/'+resolution+'/meto_ocean_analysis_enso_anoms.jan-dec_dmeans-interp-mmeans_amip_3yrclim'+time_range+'.ocnT_'+resolution+'.kpp_1000m_100lev.nc'
...
global_latitude=OPEN_AND_EXTRACT(ocnT_infile,'lat')
global_longitude=OPEN_AND_EXTRACT(ocnT_infile,'lon')
...
ocnT_varid=NCDF_VARDEF(id,'temperature',[lon_dimid,lat_dimid,z_dimid,t_dimid])
