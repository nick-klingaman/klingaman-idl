PRO hadgem3kpp_fcorr_calculate_expostfacto_perfectfluxes_entrain_junstart_ukmo_sal60_ind_no204,id,month
...
noflx_coupled_indir='/home/ss901165/kpp_ocean3/flxcorr_hadgem3_1.5xentrain_n96_1mtop_3hr_junstart_ukmo_sal60_ind_no204/'+id
...
FOR i=0,coupled_nlon-1 DO BEGIN
    FOR j=0,coupled_nlat-1 DO BEGIN
        ...
        IF landfrac(i,j) lt 1 THEN BEGIN
           ...
           noflx_temps_mmean_foamgrid=SPLINE(ABS(coupled_depth),REFORM(noflx_temps_mmean(i,j,*)),ABS(foam_depth),10)
...
;            fcorr_kppgrid(i,j,*) = SPL_INTERP(ABS(foam_depth),fcorr_foamgrid,foam_to_kpp_spline,ABS(coupled_depth))
            test=SPLINE(ABS(foam_depth),fcorr_foamgrid,ABS(coupled_depth),10)
...
; read in by KPP.
id = NCDF_CREATE('/home/ss901165/datasets/HADGEM3-KPP_ANCIL/heat_corrections/hadgem3_flxcorr_1mtop_3hr_junstart_ukmo_sal60_no204_'+id+'.'+month+'_mmean.n96.nc',/CLOBBER)
