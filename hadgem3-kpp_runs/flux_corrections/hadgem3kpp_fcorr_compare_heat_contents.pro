PRO hadgem3kpp_fcorr_compare_heat_contents
...
FOR i=0,n_time-1 DO BEGIN
   ...
   infile='/home/ss901165/um_output6/xgspm/kpp_ocean/KPPocean_'+time+'_means.nc'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_heat_contents.xgspm_mmean.70E_10S.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=110
GSET,XMIN=6,XMAX=n_time-6,YMIN=-1E2,YMAX=1E2,TITLE='Monthly change (with annual smoothing) in heat content at 10S, 70E in xgspm'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_heat_contents.xgspm_amean.70E_10S.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=110
GSET,XMIN=1,XMAX=n_time/12,YMIN=-350,YMAX=350,TITLE='Annual change in heat content at 10S, 70E in xgspm'
...
atmos_clim_flux=-5.063*86400.*360./1E6
GPLOT,X=[1,n_time/12],Y=[atmos_clim_flux,atmos_clim_flux],COL=FSC_COLOR('purple')
GPLOT,X=[1,n_time/12],Y=[0,0],STYLE=1
GLEGEND,labels=['Clim input from atmos-only','Residual (bottom heat correction?)','Net input from atmosphere','Net input from flux correction','Change in ocean heat content'],COL=[FSC_COLOR('purple'),FSC_COLOR('black'),FSC_COLOR('red'),FSC_COLOR('blue'),FSC_COLOR('black')],STYLE=[0,2,0,0,0],LEGPOS=3
AXES,XSTEP=1,XMINOR=0.5,YSTEP=35,NDECS=1,YTITLE='Change in 200m integrated heat content (MJ)',XTITLE='Year of integration'
PSCLOSE
