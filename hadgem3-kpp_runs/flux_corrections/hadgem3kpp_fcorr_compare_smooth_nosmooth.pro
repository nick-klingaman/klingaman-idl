PRO hadgem3kpp_fcorr_compare_smooth_nosmooth
...
basedir_smooth_uncorr='/home/ss901165/kpp_ocean3/flxcorr_hadgem3_1.5xentrain_n96_1mtop_3hr_ukmo_sal60_amip_vn78_smooth'
basedir_smooth_corr='/export/mango/data-10/ss901165/kpp_ocean/runs/flxcorr_hadgem3_1.5xentrain_n96_1mtop_3hr_ukmo_sal60_amip_vn78_smooth'
...
file_smooth_fcorr=basedir_fcorr+'/hadgem3_1.5xentrain_ensmean_1mtop_3hr_ukmo_sal60_amip_vn78_smooth.jan-dec_mmeans.flxcorr.n96.nc'
...
FOR i=0,n_times-1 DO BEGIN
   FOR j=0,n_runs-1 DO BEGIN   
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_uncorr-minus-obs.'+$
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_corr-minus-obs.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_corr-minus-nosmooth_uncorr.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_uncorr-minus-obs.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_corr-minus-obs.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_corr-minus-smooth_uncorr.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_uncorr-minus-nosmooth_uncorr.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_corr-minus-nosmooth_corr.'+$
             runids(j)+'_'+obs_times(i)+'.sst.ps'
      PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
      CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   ENDFOR
                                ...
                                ; Plot SST bias for uncorrected, unsmoothed run
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_uncorr_ensmean-minus-obs.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST bias for corrected, unsmoothed run
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_corr_ensmean-minus-obs.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST difference between corrected and uncorrected unsmoothed runs
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_corr_ensmean-minus-nosmooth_uncorr_ensmean.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST bias for uncorrected, smoothed run
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_uncorr_ensmean-minus-obs.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST bias for corrected, smoothed run
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_corr_ensmean-minus-obs.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST difference between corrected and uncorrected smoothed runs
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth_corr_ensmean-minus-smooth_uncorr_ensmean.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST difference between smoothed and unsmoothed uncorrected runs
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_uncorr_ensmean-minus-nosmooth_uncorr_ensmean.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   PSCLOSE,/NOVIEW
                                ...
                                ; Plot SST difference between smoothed and unsmoothed corrected runs
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth_corr_ensmean-minus-nosmooth_corr_ensmean.'+$
          obs_times(i)+'.sst.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_sst_diff)+1,white=[12]
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth.'+$
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.nosmooth.'+$
          obs_times(i)+'.fcorr_surface.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_fcorr_surface)+1,white=[10]
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/flux_corrections/hadgem3kpp_fcorr_compare_smooth_nosmooth.smooth-minus-nosmooth.'+$
          obs_times(i)+'.fcorr_surface.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=110,MARGIN=1500,SPACE2=1300,XOFFSET=500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          YSIZE=10000,SPACE3=500
