PRO hadgem3kpp_cascade_aug08_hovmollers
...
FOR i=0,n_sets-1 DO BEGIN
   CASE i OF
      ...
      END
      1 : BEGIN
         precip_infile='/home/ss901165/um_output3/xfrle/xfrlea.26aug08_precip.nc'
         precip_name='xfrle'
         precip_ncname='precip'
         precip_multiplier=86400.
         u200_infile='/home/ss901165/um_output3/xfrle/xfrlea.26aug08_u200.nc'
         u200_name='xfrle'
         u200_ncname='u'
         u850_infile='/home/ss901165/um_output3/xfrle/xfrlea.26aug08_u850.nc'
         u850_name='xfrle'
         u850_ncname='u'
         olr_infile='/home/ss901165/um_output3/xfrle/xfrlea.26aug08_olr.nc'
         olr_name='xfrle'
         olr_ncname='olr'
         time_offset=0
      END
      2 : BEGIN
         precip_infile='/home/ss901165/um_output3/xfrlf/xfrlfa.26aug08_precip.nc'
         precip_name='xfrlf'
         precip_ncname='precip'
         u200_infile='/home/ss901165/um_output3/xfrlf/xfrlfa.26aug08_u200.nc'
         u200_name='xfrlf'
         u200_ncname='u'
         u850_infile='/home/ss901165/um_output3/xfrlf/xfrlfa.26aug08_u850.nc'
         u850_name='xfrlf'
         u850_ncname='u'
         olr_infile='/home/ss901165/um_output3/xfrlf/xfrlfa.26aug08_olr.nc'
         olr_name='xfrlf'
         olr_ncname='olr'
         time_offset=0
      END
      3 : BEGIN
         precip_infile='/home/ss901165/um_output3/xfrlg/xfrlga.26aug08_precip.nc'
         precip_name='xfrlg'
         precip_ncname='precip'
         u200_infile='/home/ss901165/um_output3/xfrlg/xfrlga.26aug08_u200.nc'
         u200_name='xfrlg'
         u200_ncname='u'
         u850_infile='/home/ss901165/um_output3/xfrlg/xfrlga.26aug08_u850.nc'
         u850_name='xfrlg'
         u850_ncname='u'
         olr_infile='/home/ss901165/um_output3/xfrlg/xfrlga.26aug08_olr.nc'
         olr_name='xfrlg'
         olr_ncname='olr'
         time_offset=0
      END
      4 : BEGIN
         precip_infile='/home/ss901165/um_output3/xfrlh/xfrlha.26aug08_precip.nc'
         precip_name='xfrlh'
         precip_ncname='precip'
         u200_infile='/home/ss901165/um_output3/xfrlh/xfrlha.26aug08_u200.nc'
         u200_name='xfrlh'
         u200_ncname='u'
         u850_infile='/home/ss901165/um_output3/xfrlh/xfrlha.26aug08_u850.nc'
         u850_name='xfrlh'
         u850_ncname='u'
         olr_infile='/home/ss901165/um_output3/xfrlh/xfrlha.26aug08_olr.nc'
         olr_name='xfrlh'
         olr_ncname='olr'
         time_offset=0
      END
   ...
   FOR j=0,n_variables-1 DO BEGIN
      ...
      psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/hovmollers/hadgem3kpp_cascade_aug08_hovmollers.'+name+'_'+varname+'_n96.ps'
      ...
      AXES,XSTEP=15,XTITLE='Longitude (degrees east)',YTITLE='Time',YLABELS=['26 Aug 2008','31 Aug 2008','5 Sep 2008','10 Sep 2008','15 Sep 2008','20 Sep 2008','25 Sep 2008'],YVALS=[0,5,10,15,20,25,30]
