PRO hadgem3kpp_cascade_aug08_rmmphase
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.obs.ps'
...
GSET,XMIN=-3.0,XMAX=3.0,YMIN=-2.5,YMAX=2.5
GPLOT,X=REPLICATE(0,3),Y=[-2.5,-1],STYLE=0,THICK=80
GPLOT,X=REPLICATE(0,3),Y=[1,2.5],STYLE=0,THICK=80
...
GPLOT,X=0,Y=2.75,TEXT='Western Pacific',ALIGN=0.5,CHARSIZE=100
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='16 Aug',ALIGN=0.0
...
analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.apr-sep_dmeans.2008.rmm_indices.nc'
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xfrle'
         dirname='xfrle'
         description='Control simulation (xfrle)'
      ...
      1 : BEGIN
         runid='xfrlf'
         dirname='xfrlf'
         description='1.5*entrainment (xfrlf)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='26aug08'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xfrlh'
         dirname='xfrlh'
         description='1.5*entrain and no CMT (xfrlh)'
         obs_offset_time=10
         start_date='26aug08'
         model_ndays=30
         color='purple'
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      ...
      GPLOT,X=4.00,Y=-0.85,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=4.00,Y=-1.00,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=4.75,Y=-0.85,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=4.75,Y=-1.00,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=5.60,Y=-0.85,TEXT='Speed',ALIGN=0.0
      GPLOT,X=5.60,Y=-1.00,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=6.35,Y=-0.85,TEXT='Speed',ALIGN=0.0
      GPLOT,X=6.35,Y=-1.00,TEXT='(days 1-10)',ALIGN=0.0
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_aug08_rmmphase.phase_speed.16days.ps'
