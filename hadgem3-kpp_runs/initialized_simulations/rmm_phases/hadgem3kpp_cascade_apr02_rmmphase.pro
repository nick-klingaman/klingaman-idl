PRO hadgem3kpp_cascade_apr02_rmmphase
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.obs.ps'
...
GPLOT,X=1.00,Y=3.50,TEXT='Phase 6'
GPLOT,X=-1.00,Y=3.50,TEXT='Phase 7'
...
analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.dec-may_dmeans.2001-2002.rmm_indices.nc'
analysis_time_offset=146        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xfsei'
         dirname='xfsei'
         description='Control simulation (xfsei)'
      ...
      1 : BEGIN
         runid='xfsej'
         dirname='xfsej'
         description='1.5*entrainment (xfsej)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='26apr02'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xfsel'
         dirname='xfsel'
         description='1.5*entrain and no CMT (xfsel)'
         obs_offset_time=10
         start_date='26apr02'
         model_ndays=30
         color='purple'
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      ...
      GPLOT,X=4.50,Y=-1.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=5.25,Y=-1.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=5.25,Y=-1.90,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=6.10,Y=-1.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=6.10,Y=-1.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=6.85,Y=-1.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=6.85,Y=-1.90,TEXT='(days 1-10)',ALIGN=0.0
      ...
      GPLOT,X=3.75,Y=-2.35,TEXT='Observations',ALIGN=0.0,COL=30
      GPLOT,X=6.10,Y=-2.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed)),1),0,5),ALIGN=0.0,COL=30
      GPLOT,X=6.85,Y=-2.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed(0:9))),1),0,5),ALIGN=0.0,COL=30
   ENDIF
   GPLOT,X=3.75,Y=-2.75-0.25*(i),TEXT=runid,ALIGN=0.0,COL=31+i
   GPLOT,X=4.50,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1(i)+rmse_pc2(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=5.25,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1_tendays(i)+rmse_pc2_tendays(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=6.10,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,*))),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=6.85,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,0:9))),1),0,5),ALIGN=0.0,COL=31+i
ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase.phase_speed.16days.ps'
