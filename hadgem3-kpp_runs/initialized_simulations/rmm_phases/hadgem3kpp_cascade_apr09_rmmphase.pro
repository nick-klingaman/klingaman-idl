PRO hadgem3kpp_cascade_apr09_rmmphase
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.bw_pub.ps'
PSOPEN,file=psfile,FONT=6,CHARSIZE=140,MARGIN=2500,SPACE3=1500,XOFFSET=500,YOFFSET=0,TFONT=2,TCHARSIZE=100,CB_WIDTH=110,XSIZE=14000,YSIZE=14000
...
GPLOT,X=0,Y=-3.75,TEXT='Indian Ocean',ALIGN=0.5,CHARSIZE=100
...
GPLOT,X=-3.85,Y=0,TEXT='Western Hemisphere and Africa',ALIGN=0.5,CHARSIZE=100,ORIENTATION=90
GPLOT,X=0,Y=-4.05,TEXT='RMM1'
GPLOT,X=-4.05,Y=0,TEXT='RMM2',ORIENTATION=90
...
GPLOT,X=-1.8,Y=-2.5,TEXT='Phase 2'
GPLOT,X=1.8,Y=-2.5,TEXT='Phase 3'
GPLOT,X=2.5,Y=-1.5,TEXT='Phase 4'
GPLOT,X=2.5,Y=1.5,TEXT='Phase 5'
GPLOT,X=1.8,Y=2.5,TEXT='Phase 6'
GPLOT,X=-1.8,Y=2.5,TEXT='Phase 7'
...
FOR i=0,obs_ndays-2,2 DO BEGIN
   IF i ne model_offset THEN $
      GPLOT,X=obs_rmm1(i),Y=obs_rmm2(i),/NOLINES,SYM=5,SIZE=100,COL=30
ENDFOR
...
GPLOT,X=obs_rmm1(obs_ndays-1)-0.5,Y=obs_rmm2(obs_ndays-1)-0.15,TEXT='6 May'
...
FOR i=0,n_models-1 DO BEGIN
   ...
   FOR j=1,model_ndays-2,2 DO $
      GPLOT,X=model_rmm1(j),Y=model_rmm2(j),/NOLINES,SYM=symbol,SIZE=100,COL=FSC_COLOR(color)
   GPLOT,X=model_rmm1(0),Y=model_rmm2(0),/NOLINES,SYM=3,SIZE=100,COL=FSC_COLOR(color)
   GPLOT,X=model_rmm1(model_ndays-1),Y=model_rmm2(model_ndays-1),/NOLINES,SYM=1,SIZE=100,COL=FSC_COLOR(color)
...
;GLEGEND,STYLE=REVERSE([all_styles,0]),SYM=REVERSE([all_symbols,5]),LABELS=REVERSE([all_descriptions,'Observations']),LEGXOFFSET=1000,LEGYOFFSET=19000
PSCLOSE
STOP

psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.phase_angle_amplitude.16days.ps'
...
GLEGEND,COL=REVERSE([3,4,indgen(n_models)+31]),SYM=REVERSE([5,5,all_symbols]),LABELS=REVERSE(['Observations','UKMO Analysis',all_descriptions]),LEGXOFFSET=2000,LEGYOFFSET=0,SIZE=80
PSCLOSE,/NOVIEW

psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.phase_speed.16days.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2000,XOFFSET=1300,YOFFSET=700,TFONT=2,TCHARSIZE=100
...
AXES,YTITLE='Phase speed (lag-1 difference in phase angle; degrees)',XSTEP=4,XMINOR=1,XTITLE='Days since 6 April 2009',NDECS=2,$
     YVALS=[3,4,5,6,8,10,12,15,17,20,22,25,30],YLABELS=['Stationary','4','5','6','8','10','12','15','17','20','22','25','Random']
GPLOT,X=0,Y=2.5,TEXT='Stationary is <= 3 degrees; Random is >= 30 degrees',ALIGN=0.0
GLEGEND,COL=REVERSE([3,4,indgen(n_models)+31]),SYM=REVERSE([5,5,all_symbols]),LABELS=REVERSE(['Observations','UKMO Analysis',all_descriptions]),LEGPOS=1
PSCLOSE,/NOVIEW
