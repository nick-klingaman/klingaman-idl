PRO hadgem3kpp_cascade_nov00_rmmphase
 
; Plot RMM phases for November 2000 case
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.obs.ps'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='3 Nov',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='13 Dec'
GPLOT,X=obs_rmm1(obs_ndays-1),Y=obs_rmm2(obs_ndays-1),SYM=1,SIZE=100,/NOLINES

analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.jul-dec_dmeans.2000.rmm_indices.nc'
analysis_time_offset=135        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xfseq'
         dirname='xfseq'
         description='Control simulation (xfseq)'
      ...
      1 : BEGIN
         runid='xfser'
         dirname='xfser'
         description='1.5*entrainment (xfser)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='13nov00'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xfset'
         dirname='xfset'
         description='1.5*entrain and no CMT (xfset)'
         obs_offset_time=10
         start_date='13nov00'
         model_ndays=30
         color='purple'
   ...
   model_rmm2=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm2',$
                                      offset=[0,0],count=[1,model_ndays]))
   model_rmm1(1:model_ndays-1)=a*model_rmm1(1:model_ndays-1)
   model_rmm2(1:model_ndays-1)=a*model_rmm2(1:model_ndays-1)
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase.phase_speed.16days.ps'
