PRO hadgem3kpp_cascade_sep06_rmmphase_plus10
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.obs.ps'
...
GPLOT,X=-1.0,Y=-2.0,TEXT='Phase 2'
GPLOT,X=1.0,Y=-2.0,TEXT='Phase 3'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='7 Sep',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='16 Oct'
...
analysis_rmm2=REFORM(OPEN_AND_EXTRACT(analysis_rmm_file,'rmm2',$
                                      offset=[0,analysis_time_offset],count=[1,analysis_ndays]))
analysis_rmm1=analysis_rmm1-0.8*(analysis_rmm1(0)-obs_rmm1(analysis_obs_offset_time))
analysis_rmm2=analysis_rmm2-0.8*(analysis_rmm2(0)-obs_rmm2(analysis_obs_offset_time))
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftfm'
         dirname='xftfm'
         description='Control simulation (xftfm)'
      ...
      1 : BEGIN
         runid='xftfn'
         dirname='xftfn'
         description='1.5*entrainment (xftfn)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='17sep06'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xftfp'
         dirname='xftfp'
         description='1.5*entrain and no CMT (xftfp)'
         obs_offset_time=10
         start_date='17sep06'
         model_ndays=30
         color='purple'
   ...
   model_rmm2=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm2',$
                                      offset=[0,0],count=[1,model_ndays]))
   model_rmm1=model_rmm1-0.8*(model_rmm1(0)-obs_rmm1(obs_offset_time))
   model_rmm2=model_rmm2-0.8*(model_rmm2(0)-obs_rmm2(obs_offset_time))
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep06_rmmphase_plus10.phase_speed.16days.ps'
