PRO hadgem3kpp_cascade_nov00_rmmphase_plus10
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.obs.ps'
...
GPLOT,X=-0.75,Y=-1.50,TEXT='Phase 2'
GPLOT,X=0.75,Y=-1.50,TEXT='Phase 3'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='13 Nov',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='23 Dec'
...
analysis_time_offset=145        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftgq'
         dirname='xftgq'
         description='Control simulation (xftgq)'
      ...
      1 : BEGIN
         runid='xftgr'
         dirname='xftgr'
         description='1.5*entrainment (xftgr)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='23nov00'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xftgt'
         dirname='xftgt'
         description='1.5*entrain and no CMT (xftgt)'
         obs_offset_time=10
         start_date='23nov00'
         model_ndays=30
         color='purple'
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      ...
      GPLOT,X=3.85,Y=-0.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=3.85,Y=-0.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=4.45,Y=-0.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=4.45,Y=-0.90,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=5.35,Y=-0.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=5.35,Y=-0.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=5.95,Y=-0.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=5.95,Y=-0.90,TEXT='(days 1-10)',ALIGN=0.0
      ...
      GPLOT,X=3.25,Y=-1.15,TEXT='Observations',ALIGN=0.0,COL=30
      GPLOT,X=5.35,Y=-1.15,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed)),1),0,5),ALIGN=0.0,COL=30
      GPLOT,X=5.95,Y=-1.15,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed(0:9))),1),0,5),ALIGN=0.0,COL=30
   ENDIF
   GPLOT,X=3.25,Y=-1.45-0.20*(i),TEXT=runid,ALIGN=0.0,COL=31+i
   GPLOT,X=3.85,Y=-1.45-0.20*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1(i)+rmse_pc2(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=4.45,Y=-1.45-0.20*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1_tendays(i)+rmse_pc2_tendays(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=5.35,Y=-1.45-0.20*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,*))),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=5.95,Y=-1.45-0.20*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,0:9))),1),0,5),ALIGN=0.0,COL=31+i
ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov00_rmmphase_plus10.phase_speed.16days.ps'
