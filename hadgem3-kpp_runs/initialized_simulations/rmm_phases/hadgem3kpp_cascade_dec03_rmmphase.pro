PRO hadgem3kpp_cascade_dec03_rmmphase
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.obs.ps'
...
GSET,XMIN=-2.0,XMAX=3.0,YMIN=-4.0,YMAX=3.0
GPLOT,X=REPLICATE(0,3),Y=[-4.0,-1],STYLE=0,THICK=80
...
analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.aug-jan_dmeans.2003-2004.rmm_indices.nc'
analysis_time_offset=124        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xfrlu'
         dirname='xfrlu'
         description='Control simulation (xfrlu)'
      ...
      1 : BEGIN
         runid='xfrlz'
         dirname='xfrlz'
         description='1.5*entrainment (xfrlv)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='03dec03'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xfrlx'
         dirname='xfrlx'
         description='1.5*entrain and no CMT (xfrlx)'
         obs_offset_time=10
         start_date='03dec03'
         model_ndays=30
         color='purple'
	...
	runid='xfrly'
	dirname='xfrly'
	description='1.5*entrain - init SSTs (xfrly)'
	obs_offset_time=10
	start_date='03dec03'
	model_ndays=30
	color='orange'
	...
	runid='xfrlz'
	dirname='xfrlz'
	description='1.5*entrain - update SSTs (xfrlz)'
	obs_offset_time=10
	start_date='03dec03'
	model_ndays=30
	color='green'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_dec03_rmmphase.phase_speed.16days.ps'
