PRO hadgem3kpp_cascade_sep00_rmmphase_plus10
 
; Plot RMM phases for September 2000 case
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.obs.ps'
...
GPLOT,X=1.5,Y=-1.00,TEXT='Phase 4'
GPLOT,X=1.5,Y=1.00,TEXT='Phase 5'
GPLOT,X=1.00,Y=3.00,TEXT='Phase 6'
GPLOT,X=-1.00,Y=3.00,TEXT='Phase 7'
GPLOT,X=-1.25,Y=0.50,TEXT='Phase 8'
GPLOT,X=-1.25,Y=-0.50,TEXT='Phase 1'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='28 Sep',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='7 Nov'
GPLOT,X=obs_rmm1(obs_ndays-1),Y=obs_rmm2(obs_ndays-1),SYM=1,SIZE=100,/NOLINES

analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.may-nov_dmeans.2000.rmm_indices.nc'
analysis_time_offset=160        ; Corresponding to start date of model integrations
analysis_ndays=30
...
analysis_rmm2=REFORM(OPEN_AND_EXTRACT(analysis_rmm_file,'rmm2',$
                                      offset=[0,analysis_time_offset],count=[1,analysis_ndays]))
;analysis_rmm1=analysis_rmm1-(analysis_rmm1(0)-obs_rmm1(analysis_obs_offset_time))
;analysis_rmm2=analysis_rmm2-(analysis_rmm2(0)-obs_rmm2(analysis_obs_offset_time))
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftgu'
         dirname='xftgu'
         description='Control simulation (xftgu)'
      ...
      1 : BEGIN
         runid='xftgv'
         dirname='xftgv'
         description='1.5*entrainment (xftgv)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='08oct00'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xftgx'
         dirname='xftgx'
         description='1.5*entrain and no CMT (xftgx)'
         obs_offset_time=10
         start_date='08oct00'
         model_ndays=30
         color='purple'
   ...
   model_rmm2=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm2',$
                                      offset=[0,0],count=[1,model_ndays]))
   model_rmm1(2:10)=a*model_rmm1(2:10)
   ;model_rmm2(2:10)=a*model_rmm2(2:10)
   ...
   rmse_pc1_tendays(i)=SQRT(MEAN((model_rmm1(1:10)-obs_rmm1(obs_offset_time:obs_offset_time+9))^2))
   print,rmse_pc1_tendays
   rmse_pc2_tendays(i)=SQRT(MEAN((model_rmm2(1:10)-obs_rmm2(obs_offset_time:obs_offset_time+9))^2))
   print,rmse_pc2_tendays
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      GPLOT,X=2.25,Y=-1.25,TEXT='Model',ALIGN=0.0
      GPLOT,X=2.65,Y=-1.25,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=2.65,Y=-1.40,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=3.15,Y=-1.25,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=3.15,Y=-1.40,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=3.65,Y=-1.25,TEXT='Speed',ALIGN=0.0
      GPLOT,X=3.65,Y=-1.40,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=4.15,Y=-1.25,TEXT='Speed',ALIGN=0.0
      GPLOT,X=4.15,Y=-1.40,TEXT='(days 1-10)',ALIGN=0.0
      ...
      GPLOT,X=2.25,Y=-1.85,TEXT='Observations',ALIGN=0.0,COL=30
      GPLOT,X=3.65,Y=-1.85,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed)),1),0,5),ALIGN=0.0,COL=30
      GPLOT,X=4.15,Y=-1.85,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed(0:9))),1),0,5),ALIGN=0.0,COL=30
   ENDIF
   GPLOT,X=2.25,Y=-2.15-0.2*(i),TEXT=runid,ALIGN=0.0,COL=31+i
   GPLOT,X=2.65,Y=-2.15-0.2*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1(i)+rmse_pc2(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=3.15,Y=-2.15-0.2*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1_tendays(i)+rmse_pc2_tendays(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=3.65,Y=-2.15-0.2*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,*))),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=4.15,Y=-2.15-0.2*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,0:9))),1),0,5),ALIGN=0.0,COL=31+i
ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase_plus10.phase_speed.16days.ps'
