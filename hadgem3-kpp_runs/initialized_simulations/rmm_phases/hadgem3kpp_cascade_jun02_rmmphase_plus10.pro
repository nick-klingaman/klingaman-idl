PRO hadgem3kpp_cascade_jun02_rmmphase_plus10
 
; Plot RMM phases for June 2002 case
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.obs.ps'
...
GPLOT,X=xmin-0.7,Y=0,TEXT='Western Hemisphere and Africa',ALIGN=0.5,CHARSIZE=100,ORIENTATION=90
GPLOT,X=0,Y=ymin-0.6,TEXT='RMM1'
GPLOT,X=xmin-0.95,Y=0,TEXT='RMM2',ORIENTATION=90
...
GPLOT,X=3.25,Y=-1.00,TEXT='Phase 4'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='5 Jun',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='15 Jul'
GPLOT,X=obs_rmm1(obs_ndays-1),Y=obs_rmm2(obs_ndays-1),SYM=1,SIZE=100,/NOLINES

analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.feb-jul_dmeans.2002.rmm_indices.nc'
analysis_time_offset=134        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftge'
         dirname='xftge'
         description='Control simulation (xftge)'
      ...
      1 : BEGIN
         runid='xftgf'
         dirname='xftgf'
         description='1.5*entrainment (xftgf)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='15jun02'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xftgh'
         dirname='xftgh'
         description='1.5*entrain and no CMT (xftgh)'
         obs_offset_time=10
         start_date='15jun02'
         model_ndays=30
         color='purple'
   ...
   model_rmm2=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm2',$
                                      offset=[0,0],count=[1,model_ndays]))
   model_rmm1(5:model_ndays-1)=model_rmm1(5:model_ndays-1)*a
   model_rmm2(5:model_ndays-1)=model_rmm2(5:model_ndays-1)*a
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jun02_rmmphase_plus10.phase_speed.16days.ps'
