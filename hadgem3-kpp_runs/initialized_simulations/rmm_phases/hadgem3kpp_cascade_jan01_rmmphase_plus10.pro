PRO hadgem3kpp_cascade_jan01_rmmphase_plus10
 
; Plot RMM phases for January 2001 case
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.obs.ps'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='16 Jan',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='25 Feb'
GPLOT,X=obs_rmm1(obs_ndays-1),Y=obs_rmm2(obs_ndays-1),SYM=1,SIZE=100,/NOLINES

analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.sep-feb_dmeans.2000-2001.rmm_indices.nc'
analysis_time_offset=147        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftgm'
         dirname='xftgm'
         description='Control simulation (xftgm)'
      ...
      1 : BEGIN
         runid='xftgn'
         dirname='xftgn'
         description='1.5*entrainment (xftgn)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='26jan01'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xftgp'
         dirname='xftgp'
         description='1.5*entrain and no CMT (xftgp)'
         obs_offset_time=10
         start_date='26jan01'
         model_ndays=30
         color='purple'
   ...
   model_rmm2=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm2',$
                                      offset=[0,0],count=[1,model_ndays]))
   model_rmm1=model_rmm1-(model_rmm1(0)-obs_rmm1(obs_offset_time))
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      ...
      GPLOT,X=3.85,Y=-1.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=3.85,Y=-1.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=4.45,Y=-1.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=4.45,Y=-1.90,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=5.35,Y=-1.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=5.35,Y=-1.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=5.95,Y=-1.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=5.95,Y=-1.90,TEXT='(days 1-10)',ALIGN=0.0
      ...
      GPLOT,X=5.35,Y=-2.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed)),1),0,5),ALIGN=0.0,COL=30
      GPLOT,X=5.95,Y=-2.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed(0:9))),1),0,5),ALIGN=0.0,COL=30
   ENDIF
   GPLOT,X=3.25,Y=-2.75-0.25*(i),TEXT=runid,ALIGN=0.0,COL=31+i
   GPLOT,X=3.85,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1(i)+rmse_pc2(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=4.45,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1_tendays(i)+rmse_pc2_tendays(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=5.35,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,*))),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=5.95,Y=-2.75-0.25*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,0:9))),1),0,5),ALIGN=0.0,COL=31+i
ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_jan01_rmmphase_plus10.phase_speed.16days.ps'
