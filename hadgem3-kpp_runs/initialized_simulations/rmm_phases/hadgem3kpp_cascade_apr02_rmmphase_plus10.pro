PRO hadgem3kpp_cascade_apr02_rmmphase_plus10
 
; Plot RMM phases for April 2002 case
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.obs.ps'
...
GPLOT,X=-1.25,Y=-2.00,TEXT='Phase 2'
GPLOT,X=1.25,Y=-2.00,TEXT='Phase 3'
GPLOT,X=2.5,Y=-1.00,TEXT='Phase 4'
GPLOT,X=2.5,Y=1.00,TEXT='Phase 5'
GPLOT,X=1.00,Y=4.50,TEXT='Phase 6'
GPLOT,X=-1.00,Y=4.50,TEXT='Phase 7'
GPLOT,X=-2.50,Y=1.00,TEXT='Phase 8'
GPLOT,X=-2.50,Y=-1.00,TEXT='Phase 1'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='26 Apr',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='5 Jun'
GPLOT,X=obs_rmm1(obs_ndays-1),Y=obs_rmm2(obs_ndays-1),SYM=1,SIZE=100,/NOLINES

analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.jan-jun_dmeans.2002.rmm_indices.nc'
analysis_time_offset=125        ; Corresponding to start date of model integrations
analysis_ndays=30
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftgi'
         dirname='xftgi'
         description='Control simulation (xftgi)'
      ...
      1 : BEGIN
         runid='xftgj'
         dirname='xftgj'
         description='1.5*entrainment (xftgj)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='06may02'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xftgl'
         dirname='xftgl'
         description='1.5*entrain and no CMT (xftgl)'
         obs_offset_time=10
         start_date='06may02'
         model_ndays=30
         color='purple'
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      GPLOT,X=4.25,Y=0,TEXT='Model',ALIGN=0.0
      GPLOT,X=5.25,Y=0,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=5.25,Y=-0.25,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=6.25,Y=-0,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=6.25,Y=-0.25,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=7.25,Y=-0,TEXT='Speed',ALIGN=0.0
      GPLOT,X=7.25,Y=-0.25,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=8.25,Y=-0,TEXT='Speed',ALIGN=0.0
      GPLOT,X=8.25,Y=-0.25,TEXT='(days 1-10)',ALIGN=0.0
      ...
      GPLOT,X=4.25,Y=-1.35,TEXT='Observations',ALIGN=0.0,COL=30
      GPLOT,X=7.25,Y=-1.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed)),1),0,5),ALIGN=0.0,COL=30
      GPLOT,X=8.25,Y=-1.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed(0:9))),1),0,5),ALIGN=0.0,COL=30
   ENDIF
   GPLOT,X=4.25,Y=-1.75-0.35*(i),TEXT=runid,ALIGN=0.0,COL=31+i
   GPLOT,X=5.25,Y=-1.75-0.35*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1(i)+rmse_pc2(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=6.25,Y=-1.75-0.35*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1_tendays(i)+rmse_pc2_tendays(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=7.25,Y=-1.75-0.35*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,*))),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=8.25,Y=-1.75-0.35*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,0:9))),1),0,5),ALIGN=0.0,COL=31+i
ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr02_rmmphase_plus10.phase_speed.16days.ps'
