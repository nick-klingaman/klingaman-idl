PRO hadgem3kpp_cascade_apr09_rmmphase_steve
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_apr09_rmmphase.20days.ps'
...
GPLOT,X=obs_rmm1(model_offset)+0.15,Y=obs_rmm2(model_offset)+0.1,TEXT='6 Apr'
GPLOT,X=obs_rmm1(obs_ndays-1)-0.35,Y=obs_rmm2(obs_ndays-1)-0.15,TEXT='26 Apr'
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
    ...
    ;     runid='xfadd'
    ;     dirname='xfadd'
    ;     description='Control simulation (1.0 x entrainment with CMT)'
    ...
    ;     runid='xfade'
    ;     dirname='xfade'
    ;     description='Without CMT (1.0 x entrain)'
    ;     obs_offset_time=5 ; Relative to start date of observations
    ;     start_date='06apr09'
    ;     model_ndays=30
    ;     color='red'
    ...
    ;     runid='xfadg'
    ;     dirname='xfadg'
    ;     description='Initialize OSTIA SSTs (xfadg)'
    ;     obs_offset_time=5
    ;     start_date='06apr09'
    ;     model_ndays=30
    ;     color='cyan'
    ...
    ;     runid='xfadl'
    ;     dirname='xfadl'
    ;     description='Without CMT (1.0 x entrainment)'
    ;     obs_offset_time=5
    ;     start_date='06apr09'
    ;     model_ndays=20
    ;     color='red'
    ...
    ;  END
      1 : BEGIN
         ...
         description='1.5 x entrainment with CMT'
         obs_offset_time=5
         start_date='06apr09'
         model_ndays=20
         color='blue'
      ...
      2 : BEGIN
         ...
         description='1.5 x entrainment without CMT'
         obs_offset_time=5
         start_date='06apr09'
         model_ndays=20
         color='purple'
     ...
     ;    runid='xfadn'
     ;    dirname='xfadn'
     ;    description='Init OSTIA, 1.5x mix entrainment (xfadn)'
     ;    obs_offset_time=5
     ;    start_date='06apr09'
     ;    model_ndays=30
     ;    color='blue'
     ...
     ;    runid='xfado'
     ;    dirname='xfado'
     ;    description='Init OSTIA, 1.5x mix-ent and no CMT (xfado)'
     ;    obs_offset_time=5
     ;    start_date='06apr09'
     ;    model_ndays=30
     ;    color='blue'
   ...
   GPLOT,X=model_rmm1,Y=model_rmm2,STYLE=0,COL=31+i,THICK=100
   FOR j=1,model_ndays-2 DO $
      GPLOT,X=model_rmm1(j),Y=model_rmm2(j),/NOLINES,SYM=symbol,SIZE=75,COL=31+i
...
GLEGEND,COL=[REVERSE(indgen(n_models)+31),FSC_COLOR("black")],SYM=[REVERSE(all_symbols),5],LABELS=[REVERSE(all_descriptions),'Observations (NCEP winds and NOAA OLR)'],LEGXOFFSET=-5000,LEGYOFFSET=19600
...
AXES,YTITLE='Phase speed (lag-1 difference in phase angle; degrees)',XSTEP=4,XMINOR=1,XTITLE='Days since 6 April 2009',NDECS=2,$
     YVALS=[3,4,5,6,8,10,12,15,17,20,22,25,30],YLABELS=['Stationary','4','5','6','8','10','12','15','17','20','22','25','Random']
GPLOT,X=0,Y=2.5,TEXT='Stationary is <= 3 degrees; Random is >= 30 degrees',ALIGN=0.0
LEGEND,COL=REVERSE([3,4,indgen(n_models)+31]),SYM=REVERSE([5,5,all_symbols]),LABELS=REVERSE(['Observations','UKMO Analysis',all_descriptions]),LEGPOS=1
PSCLOSE,/NOVIEW
