PRO hadgem3kpp_cascade_sep00_rmmphase
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.obs.ps'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='18 Sep',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='27 Oct'
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xfseu'
         dirname='xfseu'
         description='Control simulation (xfseu)'
      ...
      1 : BEGIN
         runid='xfsev'
         dirname='xfsev'
         description='1.5*entrainment (xfsev)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='28sep00'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xfsex'
         dirname='xfsex'
         description='1.5*entrain and no CMT (xfsex)'
         obs_offset_time=10
         start_date='28sep00'
         model_ndays=30
         color='purple'
...
;   all_speeds_tendays(i)=MEAN(temp_speed(0:9))
   ...
   IF i eq 0 THEN BEGIN
      GPLOT,X=2.25,Y=-0.75,TEXT='Model',ALIGN=0.0
      GPLOT,X=2.85,Y=-0.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=2.85,Y=-0.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=3.45,Y=-0.75,TEXT='RMSE',ALIGN=0.0
      GPLOT,X=3.45,Y=-0.90,TEXT='(days 1-10)',ALIGN=0.0
      GPLOT,X=4.05,Y=-0.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=4.05,Y=-0.90,TEXT='(forecast)',ALIGN=0.0
      GPLOT,X=4.65,Y=-0.75,TEXT='Speed',ALIGN=0.0
      GPLOT,X=4.65,Y=-0.90,TEXT='(days 1-10)',ALIGN=0.0
      ...
      GPLOT,X=2.25,Y=-1.35,TEXT='Observations',ALIGN=0.0,COL=30
      GPLOT,X=4.05,Y=-1.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed)),1),0,5),ALIGN=0.0,COL=30
      GPLOT,X=4.65,Y=-1.35,TEXT=STRMID(STRTRIM(STRING(MEAN(obs_speed(0:9))),1),0,5),ALIGN=0.0,COL=30
   ENDIF
   GPLOT,X=2.25,Y=-1.75-0.2*(i),TEXT=runid,ALIGN=0.0,COL=31+i
   GPLOT,X=2.85,Y=-1.75-0.2*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1(i)+rmse_pc2(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=3.45,Y=-1.75-0.2*(i),TEXT=STRMID(STRTRIM(STRING(rmse_pc1_tendays(i)+rmse_pc2_tendays(i)),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=4.05,Y=-1.75-0.2*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,*))),1),0,5),ALIGN=0.0,COL=31+i
   GPLOT,X=4.65,Y=-1.75-0.2*(i),TEXT=STRMID(STRTRIM(STRING(MEAN(all_speeds(i,0:9))),1),0,5),ALIGN=0.0,COL=31+i
ENDFOR
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_sep00_rmmphase.phase_speed.16days.ps'
