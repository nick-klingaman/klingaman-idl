PRO hadgem3kpp_cascade_mar05_rmmphase_plus10
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.obs.ps'
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='17 Mar',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='26 Apr'
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xftfq'
         dirname='xftfq'
         description='Control simulation (xftfq)'
      ...
      1 : BEGIN
         runid='xftfr'
         dirname='xftfr'
         description='1.5*entrainment (xftfr)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='28mar05'
         model_ndays=30
         color='blue'         
      ...
      3 : BEGIN
         runid='xftft'
         dirname='xftft'
         description='1.5*entrain and no CMT (xftft)'
         obs_offset_time=10
         start_date='28mar05'
         model_ndays=30
         color='purple'
   ...
   model_rmm1=model_rmm1-model_rmm1*(findgen(model_ndays)*a/float(model_ndays))
   model_rmm2=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm2',$
                                      offset=[0,0],count=[1,model_ndays]))
   model_rmm2=model_rmm2-model_rmm2*(findgen(model_ndays)*a/float(model_ndays))
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_mar05_rmmphase_plus10.phase_speed.16days.ps'
