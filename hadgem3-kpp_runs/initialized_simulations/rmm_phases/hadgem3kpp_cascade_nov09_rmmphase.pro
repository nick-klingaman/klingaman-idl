PRO hadgem3kpp_cascade_nov09_rmmphase
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.obs.ps'
...
GSET,XMIN=-3.0,XMAX=3.0,YMIN=-3.5,YMAX=1.75
GPLOT,X=REPLICATE(0,3),Y=[-3.5,-1],STYLE=0,THICK=80
GPLOT,X=REPLICATE(0,3),Y=[1,1.75],STYLE=0,THICK=80
GPLOT,X=[1,3.0],Y=REPLICATE(0,3),STYLE=0,THICK=80
GPLOT,X=[-1,-3.0],Y=REPLICATE(0,3),STYLE=0,THICK=80
GPLOT,X=[SQRT(2)/2.,1,1.75],Y=[SQRT(2)/2.,1,1.75],STYLE=0,THICK=80
GPLOT,X=[-SQRT(2)/2.,-1,-1.75],Y=[SQRT(2)/2.,1,1.75],STYLE=0,THICK=80
...
GPLOT,X=0,Y=2.00,TEXT='Western Pacific',ALIGN=0.5,CHARSIZE=100
...
ENDFOR
GPLOT,X=obs_rmm1(0)+0.1,Y=obs_rmm2(0),TEXT='25 Oct',ALIGN=0.0
GPLOT,X=obs_rmm1(model_offset),Y=obs_rmm2(model_offset),SYM=4,SIZE=100,/NOLINES
GPLOT,X=obs_rmm1(obs_ndays-1)-0.05,Y=obs_rmm2(obs_ndays-1)+0.25,TEXT='3 Dec'
GPLOT,X=obs_rmm1(obs_ndays-1),Y=obs_rmm2(obs_ndays-1),SYM=1,SIZE=100,/NOLINES

analysis_rmm_file='/home/ss901165/datasets_mango/UM_ANALYSES/cascade_mjo_wh04/metum_analysis.jul-dec_dmeans.2009.rmm_indices.nc'
...
FOR i=0,n_models-1 DO BEGIN
   CASE i OF 
      0 : BEGIN
         runid='xfrla'
         dirname='xfrla'
         description='Control simulation (xfrla)'
      ...
      1 : BEGIN
         runid='xfrlb'
         dirname='xfrlb'
         description='1.5*entrainment (xfrlb)'
         obs_offset_time=10 ; Relative to start date of observations
         start_date='04nov09'
         model_ndays=30
         color='blue'
      ...
      3 : BEGIN
         runid='xfrld'
         dirname='xfrld'
         description='1.5*entrain and no CMT (xfrld)'
         obs_offset_time=10
         start_date='04nov09'
         model_ndays=30
         color='purple'
      ...
      4 : BEGIN
         runid='xfyfa'
         dirname='xfyfa.new_stash'
         description='1.5*entrain increase RHcrit (xfyfa)'
         obs_offset_time=10
         start_date='04nov09'
         model_ndays=10
         color='cyan'
   ...
   model_rmm1=REFORM(OPEN_AND_EXTRACT(model_infile,'rmm1',$
                                      offset=[0,0],count=[1,model_ndays]))+0.8
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.phase_angle_amplitude.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.phase_angle_amplitude.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.phase_angle_amplitude_error.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=2500,XOFFSET=500,YOFFSET=500,TFONT=2,TCHARSIZE=100
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.phase_angle_amplitude_error.16days.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.phase_speed.ps'
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/rmm_phases/hadgem3kpp_cascade_nov09_rmmphase.phase_speed.16days.ps'
