PRO hadgem3kpp_cascade_sep06case_monsoon_precip_patterncorr
...
psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/monsoon_precip/hadgem3kpp_cascade_sep06case_monsoon_precip_patterncorr.trmm_n96.ps'
...
CON,X=trmm_longitude,Y=trmm_latitude,FIELD=trmm_rainfall_avg,/NOLINES,/BLOCK,$
    TITLE='Mean precipitation over 27 Sep - 17 Oct from TRMM at N96',CB_TITLE='Precipitation (mm day!U-1!N)'
...
FOR i=0,n_models-1 DO BEGIN
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/monsoon_precip/hadgem3kpp_cascade_sep06case_monsoon_precip_patterncorr.'+runid+'.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=1500,SPACE3=500,XOFFSET=1500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          XSIZE=18000,SPACE2=1200
   CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs)+1,/REV
   LEVS,MANUAL=mylevs
   ...
   CON,X=model_longitude,Y=model_latitude,FIELD=model_rainfall_avg,/NOLINES,/BLOCK,$
       TITLE='Mean precipitation over 27 Sep - 7 Oct from '+runid,CB_TITLE='Precipitation (mm day!U-1!N)'
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/initialized_simulations/monsoon_precip/hadgem3kpp_cascade_sep06case_monsoon_precip_patterncorr.'+runid+'_diff_trmm.ps'
   PSOPEN,file=psfile,FONT=2,CHARSIZE=100,MARGIN=1500,SPACE3=500,XOFFSET=1500,YOFFSET=1500,TFONT=2,TCHARSIZE=100,$
          XSIZE=18000,SPACE2=1200
   ...
   CON,X=model_longitude,Y=model_latitude(0:model_nlat-1),FIELD=diff_precip,/NOLINES,/BLOCK,$
       TITLE='Difference in mean precipitation over 27 Sep - 7 Oct for '+runid+' minus TRMM',CB_TITLE='Precipitation (mm day!U-1!N)'
   GPLOT,Y=[pcorr_box(0),pcorr_box(2)],X=[pcorr_box(1),pcorr_box(1)],STYLE=2,THICK=150
   GPLOT,Y=[pcorr_box(0),pcorr_box(2)],X=[pcorr_box(3),pcorr_box(3)],STYLE=2,THICK=150
   GPLOT,Y=[pcorr_box(0),pcorr_box(0)],X=[pcorr_box(1),pcorr_box(3)],STYLE=2,THICK=150
   GPLOT,Y=[pcorr_box(2),pcorr_box(2)],X=[pcorr_box(1),pcorr_box(3)],STYLE=2,THICK=150
