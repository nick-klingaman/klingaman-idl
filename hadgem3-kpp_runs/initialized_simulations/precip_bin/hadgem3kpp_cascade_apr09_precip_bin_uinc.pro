PRO hadgem3kpp_cascade_apr09_precip_bin_uinc
...
GSET,XMIN=-0.10,XMAX=0.12,YMIN=1005,YMAX=140
...
AXES,XSTEP=0.02,XMINOR=0.01,YVALS=indgen(18)*(-50)+1000,NDECS=2,$
...
PSOPEN,file=psfile,FONT=2,CHARSIZE=90,MARGIN=1400,SPACE2=700,XOFFSET=1000,YOFFSET=1500,TFONT=2,TCHARSIZE=80,/PORTRAIT
GSET,XMIN=-0.15,XMAX=0.12,YMIN=1005,YMAX=140
colors=['brown','red','orange','green','blue','cyan']
;model_top=NEAREST(rholvl_pres_mean,500)+1
model_top=model_nz
FOR i=0,n_bins-1 DO BEGIN
...
AXES,XSTEP=0.03,XMINOR=0.01,YVALS=indgen(18)*(-50)+1000,NDECS=2,$
...
PSOPEN,file=psfile,FONT=2,CHARSIZE=90,MARGIN=1400,SPACE2=700,XOFFSET=1000,YOFFSET=1500,TFONT=2,TCHARSIZE=80,/PORTRAIT
GSET,XMIN=-0.01,XMAX=0.04,YMIN=1005,YMAX=800
colors=['brown','red','orange','green','blue','cyan']
...
ENDFOR
GPLOT,X=[0,0],Y=[1005,800],STYLE=0,THICK=70
...
AXES,XSTEP=0.005,XMINOR=0.0025,YVALS=indgen(11)*(-20)+1000,NDECS=3,$
