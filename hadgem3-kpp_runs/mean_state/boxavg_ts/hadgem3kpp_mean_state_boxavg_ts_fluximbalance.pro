PRO hadgem3kpp_mean_state_boxavg_ts_fluximbalance
...
; simulations.  Also plot imbalance in surface fluxes over domain.
  ...
  forced_runs=['xgspj_i2','xgspj_i3','xgspj_i4','xgspj_i5','xgspj_i6','xgspj_i7',$
               'xgspj_i8','xgspj_i9','xgspj_j0','xgspj_j1']
  coupled_years=['i2','i3','i4','i5','i6','i7','i8','i9','j0','j1',$
                 'j2','j3','j4','j5','j6','j7','j8','j9','k0','k1']
  
  forced_indir='/export/mango/data-10/ss901165/kpp_ocean/runs/flxcorr_hadgem3_1.5xentrain_n96_1mtop_3hr_ukmo_sal60_amip_vn78_smooth_12421_ind'
  coupled_indir='/home/ss901165/um_output5/xgspm/kpp_ocean'
  ...
  FOR i=0,n_coupled_years-1 DO BEGIN
     ...
     ENDFOR
  ENDFOR
  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_sst.xgspm_ind3.ps'
  ...
  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_hmix.xgspm_ind3.ps'
  PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2500,SPACE2=500,XOFFSET=500,YOFFSET=1000,TFONT=2,TCHARSIZE=90,SPACE3=200
  GSET,XMIN=0,XMAX=n_months,YMIN=70,YMAX=10,TITLE='Monthly mean hmix over '+box_name+''
  FOR i=0,n_months-1 DO BEGIN
...
;     GPLOT,X=i+0.5,Y=obs_ssts(i),SYM=6,COL=FSC_COLOR('black')
  ...
  ENDFOR
  AXES,XVALS=indgen(n_months)+0.5,XLABELS=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'],$
       XTITLE='Month',YTITLE='Area-averaged hmix (m)',YSTEP=-5,YMINOR=-2.5,NDECS=1
  PSCLOSE,/NOVIEW

  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_fluximbalance.xgspm_ind3.ps'
  PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2500,SPACE2=500,XOFFSET=500,YOFFSET=1000,TFONT=2,TCHARSIZE=90,SPACE3=200
...
;     GPLOT,X=i+0.5,Y=obs_ssts(i),SYM=6,COL=FSC_COLOR('black')
  ...
  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_fluximbalance_ts.xgspm_ind3.ps'
  PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2500,SPACE2=500,XOFFSET=500,YOFFSET=1000,TFONT=2,TCHARSIZE=90,SPACE3=200
  ...
  smoothed=SMOOTH(REFORM(coupled_ssts_aavg,[n_months*n_coupled_years]),13)
  GPLOT,X=indgen(n_months*n_coupled_years-13)+6,Y=smoothed(6:n_months*n_coupled_years-7),COL=FSC_COLOR('blue'),STYLE=2
  ...
  smoothed=SMOOTH(REFORM(coupled_diff,[n_months*n_coupled_years]),13)
  GPLOT,X=indgen(n_months*n_coupled_years-13)+6,Y=smoothed(6:n_months*n_coupled_years-7),COL=FSC_COLOR('red'),STYLE=2  
  ...
  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_sst_bias_ts.xgspm_ind3.ps'
  PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2500,SPACE2=500,XOFFSET=500,YOFFSET=1000,TFONT=2,TCHARSIZE=90,SPACE3=200
  GSET,XMIN=0,XMAX=n_months*n_coupled_years,YMIN=-1.5,YMAX=1.0,TITLE='Monthly mean SST bias over '+box_name+' (ocean only)'
  ...
  GPLOT,X=[0,n_months*n_coupled_years],Y=[0,0],STYLE=1
  GPLOT,X=indgen(n_months*n_coupled_years),Y=REFORM(coupled_sst_bias,[n_months*n_coupled_years]),COL=FSC_COLOR('blue')
  smoothed=SMOOTH(REFORM(coupled_sst_bias,[n_months*n_coupled_years]),13)
  GPLOT,X=indgen(n_months*n_coupled_years-13)+6,Y=smoothed(6:n_months*n_coupled_years-7),COL=FSC_COLOR('red'),STYLE=2
  ...
  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_sst_rmse.xgspm_ind3.ps'
  PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2500,SPACE2=500,XOFFSET=500,YOFFSET=1000,TFONT=2,TCHARSIZE=90,SPACE3=200
  GSET,XMIN=0,XMAX=n_months,YMIN=0,YMAX=1.5,TITLE='RMSE in SSTs against obs climatology over '+box_name+' (ocean only)'
  FOR i=0,n_months-1 DO BEGIN
  ...
  psfile='/home/ss901165/idl/hadgem3-kpp_runs/mean_state/boxavg_ts/hadgem3kpp_mean_state_boxavg_ts_fluximbalance.'+box_name+'_sst_rmse_ts.xgspm_ind3.ps'
  PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=2500,SPACE2=500,XOFFSET=500,YOFFSET=1000,TFONT=2,TCHARSIZE=90,SPACE3=200
  GSET,XMIN=0,XMAX=n_months*n_coupled_years,YMIN=0,YMAX=1.5,TITLE='RMSE in SSTs against obs climatology over '+box_name+' (ocean only)'
  GPLOT,X=indgen(n_months*n_coupled_years),Y=REFORM(coupled_ssts_rmse,[n_months*n_coupled_years]),COL=FSC_COLOR('blue')
  smoothed=SMOOTH(REFORM(coupled_ssts_rmse,[n_months*n_coupled_years]),13)
  GPLOT,X=indgen(n_months*n_coupled_years-13)+6,Y=smoothed(6:n_months*n_coupled_years-7),COL=FSC_COLOR('blue'),STYLE=2
  AXES,XSTEP=12,XMINOR=3,XTITLE='Month since start of simulation',YSTEP=0.1,YMINOR=0.05,$
