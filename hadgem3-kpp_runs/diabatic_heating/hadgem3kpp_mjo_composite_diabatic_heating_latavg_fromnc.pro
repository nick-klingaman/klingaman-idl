PRO hadgem3kpp_mjo_composite_diabatic_heating_latavg_fromnc
...
;mylevs_phasezero=['-4.25','-3.75','-3.25','-2.75','-2.25','-1.75','-1.25','-0.75','-0.25',$
...
FOR i=1,n_phases-1 DO BEGIN
   ...
   psfile='/home/ss901165/idl/hadgem3-kpp_runs/diabatic_heating/hadgem3kpp_mjo_composite_diabatic_heating_latavg_fromnc.phase'+STRTRIM(STRING(i),1)+'.'+run_name+'.'+$
   ...
   LEVS,MANUAL=mylevs
   CON,X=longitude,Y=p_rholvl_aavg,FIELD=REFORM(phase_composite_anom_fromall(i,*,*)),/NOLINES,CB_TITLE=heating_title+' diabatic heating (K day!U-1!N)',$
       TITLE=heating_title+' diabatic heating for MJO phase '+STRTRIM(STRING(i),1)+' latavg 5S-5N for '+run_name+' - anom from mean phases 1-8'
   ...
   GSET,XMIN=box_aavg(1),XMAX=box_aavg(3),YMIN=1000.,YMAX=MIN(p_rholvl_aavg)
   LEVS,MANUAL=mylevs
   CON,X=longitude,Y=p_rholvl_aavg,FIELD=REFORM(phase_composite_scaleamp_anom_fromall(i,*,*)),/NOLINES,CB_TITLE=heating_title+' diabatic heating (K day!U-1!N)',$
       TITLE=heating_title+' diabatic heating for MJO phase '+STRTRIM(STRING(i),1)+' latavg 5S-5N for '+run_name+' - anom from mean phases 1-8 - scale by MJO amp'
   AXES,XSTEP=10,YSTEP=-100,XTITLE='Longitude (degrees east)',YTITLE='Pressure (hPa)',YMINOR=-50,XMINOR=5
   PSCLOSE,/NOVIEW
   ...
   GSET,XMIN=box_aavg(1),XMAX=box_aavg(3),YMIN=1000.,YMAX=MIN(p_rholvl_aavg)
   LEVS,MANUAL=mylevs
   CON,X=longitude,Y=p_rholvl_aavg,FIELD=REFORM(phase_composite_anom_fromzero(i,*,*)),/NOLINES,CB_TITLE=heating_title+' diabatic heating (K day!U-1!N)',$
       TITLE=heating_title+' diabatic heating for MJO phase '+STRTRIM(STRING(i),1)+' latavg 5S-5N for '+run_name+' - anom from phase 0'
   AXES,XSTEP=10,YSTEP=-100,XTITLE='Longitude (degrees east)',YTITLE='Pressure (hPa)',YMINOR=-50,XMINOR=5
   PSCLOSE,/NOVIEW
   ...
   GSET,XMIN=box_aavg(1),XMAX=box_aavg(3),YMIN=1000.,YMAX=MIN(p_rholvl_aavg)
   LEVS,MANUAL=mylevs
   CON,X=longitude,Y=p_rholvl_aavg,FIELD=REFORM(phase_composite_scaleamp_anom_fromzero(i,*,*)),/NOLINES,CB_TITLE=heating_title+' diabatic heating (K day!U-1!N)',$
       TITLE=heating_title+' diabatic heating for MJO phase '+STRTRIM(STRING(i),1)+' latavg 5S-5N for '+run_name+' - anom from mean phase 0 - scale by MJO amp'
   AXES,XSTEP=10,YSTEP=-100,XTITLE='Longitude (degrees east)',YTITLE='Pressure (hPa)',YMINOR=-50,XMINOR=5
   PSCLOSE,/NOVIEW

ENDFOR

psfile='/home/ss901165/idl/hadgem3-kpp_runs/diabatic_heating/hadgem3kpp_mjo_composite_diabatic_heating_latavg_fromnc.phase0.'+run_name+'.'+heating_title+'_raw.ps'
PSOPEN,file=psfile,FONT=2,CHARSIZE=105,MARGIN=1500,SPACE2=700,XOFFSET=1000,YOFFSET=2000,TFONT=2,TCHARSIZE=90,SPACE3=400
CS,SCALE=1,NCOLS=N_ELEMENTS(mylevs_phasezero)+1
GSET,XMIN=box_aavg(1),XMAX=box_aavg(3),YMIN=1000.,YMAX=MIN(p_rholvl_aavg)
LEVS,MANUAL=mylevs_phasezero
CON,X=longitude,Y=p_rholvl_aavg,FIELD=REFORM(phase_composite(0,*,*)),/NOLINES,CB_TITLE=heating_title+' diabatic heating (K day!U-1!N)',$
