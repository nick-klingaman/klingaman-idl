; $Id: velovect.pro,v 1.22 2003/02/03 18:13:31 scottm Exp $
;
; Copyright (c) 1983-2003, Research Systems, Inc.  All rights reserved.
...
;   April, 2005, NPK: Added the "longest" argument to return the
;                     horizontal component of the longest arrow drawn.
;-
;
PRO VELOVECT,U,V,X,Y,longest,Missing = Missing, Length = length, Dots = dots, $
...
;
    ...
    longest = max(sina)
    print,max(sina),max(cosa),maxmag,length
    print,'length=',length
;
